...
{
    public class SDM_T015_VM : WorkspaceViewModel<LOG_T001_A>
    {
        #region . Declaration .
        ...
        #region . Constructor .
        public SDM_T015_VM(string doc_cat, string ts_code) : base()
        {
        ...
        public SDM_T015_VM(string doc_cat, string ts_code, string doc_no) : base()
        {
            PrintOptionDictionary = new Dictionary<string, object>();
            PrintOptionDictionary.Add("Original for Recipient", "Original for Recipient");
            PrintOptionDictionary.Add("Duplicate for Supplier/Transporter", "Duplicate for Supplier/Transporter");
        ...
        public SDM_T015_VM(string doc_cat, string ts_code, string doc_no, string ReferenceDoc) : base()
        {
            PrintOptionDictionary = new Dictionary<string, object>();
            PrintOptionDictionary.Add("Original for Recipient", "Original for Recipient");
            PrintOptionDictionary.Add("Duplicate for Supplier/Transporter", "Duplicate for Supplier/Transporter");
        ...
        private void CollectionChangedNotifyBatchGrid(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.Action == NotifyCollectionChangedAction.Add && ItemsEntity.Count > 0 && SelectedItemsEntity != null) // Schedule can only enable to add if items exists in Items Entity.
            {
                try
                {
                    ...
                    var groupedData = ItemBatchEntity.GroupBy(p => p.pack_no)
                                    .Select(g => new { pack_no = g.Key, stock_total = g.Sum(p => p.qty), count = g.Count() });
        ...
        private void ExecuteReferenceDocument(object items)
        {
            try
            {
                ...
                else
                {
                    ...
                    string Request = "ExecuteReferenceDocument" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + this.doc_cat_vm + "!@" + this.doc_cat_vm + "!@" + RequestPara.doc_no + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + this.ts_code_vm + "!@" + items;
                    //string Request = "ExecuteReferenceDocument" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + items + "!@" + RequestPara.doc_no + "!@" + AppSessionState.EmpId;
        ...
        private void LoadBackFlipData()
        {
            try
            {
                EntityChangeEnable = false;
                CursorControl.SetBusyState();
                string Request = "Load_BackFlip_Data" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + this.doc_cat_vm + "!@" + RequestPara.para1 + "!@!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + this.ts_code_vm + "!@" + AppSessionState.sg_code + "!@" + AppSessionState.sg_code + "!@" + RequestPara.PartyId + "!@!@" + RequestPara.active + "!@" + RequestPara.t_status + "!@" + Convert.ToDateTime(RequestPara.FromDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(RequestPara.ToDate).ToString("MM/dd/yyyy");
                //string Request = "Load_BackFlip_Data" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + RequestPara.location_id + "!@" + Convert.ToDateTime(RequestPara.FromDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(RequestPara.ToDate).ToString("MM/dd/yyyy") + "!@" + RequestPara.t_status + "!@" + RequestPara.active + "!@" + doc_cat_vm + "!@" + RequestPara.PartyId + "!@" + RequestPara.emp_id + "!@" + RequestPara.para1; // para1 as delivery_type
                MCTemp = repositoryM.GetDataWithReturnDomainObject<MultipleContext_LOG_T001_A>(MCTemp, Request, "LOG_T001_BL", "SDM", "LoadAll", 0, Request);
        ...
        protected override void OnFlipAction(InquiryActionResult<LOG_T001_A> result)
        {
            try
            {
                string Request = "RefreshBatchCollection" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + this.doc_cat_vm + "!@" + RequestPara.para1 + "!@!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + this.ts_code_vm + "!@" + AppSessionState.sg_code + "!@" + AppSessionState.sg_code + "!@" + RequestPara.PartyId + "!@!@" + RequestPara.active + "!@" + RequestPara.t_status + "!@" + Convert.ToDateTime(RequestPara.FromDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(RequestPara.ToDate).ToString("MM/dd/yyyy");
                //string Request = "RefreshBatchCollection" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id.ToString() + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat;
