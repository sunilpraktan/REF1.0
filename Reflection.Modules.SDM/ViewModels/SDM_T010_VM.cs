...
{
    public class SDM_T010_VM : WorkspaceViewModel<SEL_T004>
    {
        ...
        #region Constructor
        public SDM_T010_VM(string ts_code) : base()
        {
        ...
        public SDM_T010_VM(string ts_code, string doc_no) : base()
        {
            this.ts_code_vm = ts_code;
        ...
        private void LoadInitialData()
        {
            try
            {
                string Request = "LoadInitialDataPending" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id.ToString() + "!@" + AppSessionState.client + "!@" + ' ';
