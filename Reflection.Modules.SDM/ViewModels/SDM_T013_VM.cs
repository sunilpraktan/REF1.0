...
{
    public class SDM_T013_VM : WorkspaceViewModel<LOG_T001_A>
    {
        #region . Declaration .
        bool blNew = true;
        bool firstrow = true;
        ...
        #region . Constructor .
        public SDM_T013_VM(string ts_code) : base()
        {
            ...
            ToDate = DateTime.Now;
            DelType = "OD";
            Plant = AppSessionState.OBJ_LOCATION.location_id;
            ...
            SelectedLOG_T001_A.location_Id = AppSessionState.OBJ_LOCATION.location_id;
            ...
            SelectedLOG_T001_A.userid = AppSessionState.UserID;
        ...
        public SDM_T013_VM(string ts_code, string doc_no) : base()
        {
            EntityChangeEnable = true;
            parameter = false;
            LOG_T001_A.ModelEntityUpdated += new EventHandler(Model_ItemUpdated);
        ...
        public SDM_T013_VM(string doc_no, string ts_code, string ts_name_display) : base()
        {
            EntityChangeEnable = true;
            parameter = false;
            LOG_T001_A.ModelEntityUpdated += new EventHandler(Model_ItemUpdated);
        ...
        private void OpenDocumentViewer(object InputValue)
        {
            ...
            try
            {
                ...
                string Request = "GetAllFiles" + "!@" + AppSessionState.client + "!@" + (EntityObjectParameter.comp_code ?? AppSessionState.OBJ_COMPANY.comp_code) + "!@" + (EntityObjectParameter.location_Id ?? AppSessionState.OBJ_LOCATION.location_id) + "!@" + (EntityObjectParameter.doc_cat ?? "") + "!@" + (EntityObjectParameter.doc_cat ?? "") + "!@" + EntityObjectParameter.delivery_no + "!@" + EntityObjectParameter.id.ToString();
        ...
        {
            SelectedLOG_T001_A.comp_code = AppSessionState.OBJ_COMPANY.comp_code;
            SelectedLOG_T001_A.ts_code = this.ts_code_vm;
            SelectedLOG_T001_A.userid = AppSessionState.UserID;
            SelectedLOG_T001_A.session_id = AppSessionState.session_id;
            SelectedLOG_T001_A.client = AppSessionState.client;

            SelectedLOG_T001_A.add_by = AppSessionState.UserID;
            SelectedLOG_T001_A.editby = AppSessionState.UserID;
            SelectedLOG_T001_A.add_date = System.DateTime.Now;
            SelectedLOG_T001_A.edit_date = System.DateTime.Now;
        ...
        private void LoadInitialData()
        {
            try
            {
                // string company = AppSessionState.OBJ_COMPANY.comp_code.ToString() + "@" + AppSessionState.OBJ_LOCATION.location_id.ToString();

                string Request = "LoadInitialData" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + SelectedLOG_T001_A.doc_type + "!@" + SelectedLOG_T001_A.doc_cat
              ...
              items =>
              {
                ...
                StoreLocList = (from o in (List<MM_M001>)AppSessionState.store_location where o.location_Id == AppSessionState.OBJ_LOCATION.location_id select o).ToList();
                //store_location = (from o in StoreLocList
                //                  where o.location_Id == AppSessionState.OBJ_LOCATION.location_id //&& o.default_storage_loc == Convert.ToBoolean(1)
                ...
                //{
                //    store_location = (from o in StoreLocList where o.location_Id == AppSessionState.OBJ_LOCATION.location_id select o.store_code).ToList()[0];
                //}
                ...
                var refdoc = (from o in MC.OrderList where (o.doc_cat == "SO" || o.doc_cat == "OP") select o).ToList();
        ...
        private void LoadInitialDataWithDNFromDO(string ref_doc_no)
        {
            try
            {
                ...
                string Request = "LoadInitialDataWith_DN_From_Dispatch_Order" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + SelectedLOG_T001_A.doc_type + "!@" + SelectedLOG_T001_A.doc_cat
        ...
        private void LoadRecords()
        {
            ...
            {
                string Request = "LoadRecordsofSelectedDate" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + Plant + "!@" + DelType + "!@" + Convert.ToDateTime(FromDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(ToDate).ToString("MM/dd/yyyy") + "!@" + AppSessionState.EmpId;
        ...
        private void LoadSODetails(object items)
        {
            try
            {
                ...
                {
                    // string company = AppSessionState.OBJ_COMPANY.comp_code.ToString() + "!@" + AppSessionState.OBJ_LOCATION.location_id.ToString() + "!@" + doc_type_Order + "!@" + SelectedLOG_T001_A.order_no;
                ...
                if (ItemDetails != null)
                {
                    ...
                    else if (dgSelectedIndex >= 0 && Del_Note_Dtails.Count > dgSelectedIndex && ItemDetails.Select == true) //Update Row: If Old or Blank row get added, then Edit Rule will applicable in this Loop.
                    {
                        if (Del_Note_Dtails[dgSelectedIndex].ItemCode == null && ((IndexOfExistValue == -1) || (IndexOfExistValue != -1 && AllowDuplicate == true))) // It will allowe to add unique value or Duplicate value if AllowDuplicate Status == True
                        {
                            ...
                            Del_Note_Dtails[dgSelectedIndex].comp_code = AppSessionState.OBJ_COMPANY.comp_code;
                            Del_Note_Dtails[dgSelectedIndex].location_Id = AppSessionState.OBJ_LOCATION.location_id;
                        ...
                        if (Del_Note_Dtails[dgSelectedIndex].id == 0 && ((IndexOfExistValue == -1) || (IndexOfExistValue != -1 && AllowDuplicate == true))) // It will allowe to add unique value or Duplicate value if AllowDuplicate Status == True, id=0 indicates it will add or edit for New record only.
                        {
                            ...
                            if (POPUPEntityObject.tot_qty >= Del_Note_Dtails[dgSelectedIndex].qty)
                            {
                                ...
                                else if (Batchtemp.Count == 1)
                                {
                                    ...
                                    ItemBatch_list[IndexOfrecord].comp_code = AppSessionState.OBJ_COMPANY.comp_code;
                                    ItemBatch_list[IndexOfrecord].location_Id = AppSessionState.OBJ_LOCATION.location_id;
                   ...
                   o.sku == Del_Note_Dtails[dgSelectedIndex].sku && o.line_id == Del_Note_Dtails[dgSelectedIndex].line_id
                    ...
                    else if (batchsplitSelectedIndex >= 0 && BatchDetails.Select == true && ItemBatch_list.Count > batchsplitSelectedIndex) //Update Row: If Old or Blank row get added, then Edit Rule will applicable in this Loop.
                    {
                        ...
                        if (ItemBatch_list[batchsplitSelectedIndex].ItemCode == null && ((IndexOfExistValue == -1) || (IndexOfExistValue != -1 && AllowDuplicate == true))) // It will allowe to add unique value or Duplicate value if AllowDuplicate Status == True
                        {
                            ...
                            ItemBatch_list[batchsplitSelectedIndex].comp_code = AppSessionState.OBJ_COMPANY.comp_code;
                            ItemBatch_list[batchsplitSelectedIndex].location_Id = AppSessionState.OBJ_LOCATION.location_id;
        ...
        private void PackingListReport()
        {
            try
            {
                if (post == false)
                {
                    ...
                    {
                        Request = "DN_PackingList" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + SelectedLOG_T001_A.doc_cat + "!@" + SelectedLOG_T001_A.doc_type + "!@" + SelectedLOG_T001_A.delivery_no + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + this.ts_code_vm + "!@" + SelectedLOG_T001_A.ref_doc_cat + "!@" + AppSessionState.sg_code;
                        //Request = "DN_PackingList" + "!@" + SelectedLOG_T001_A.ref_doc_cat + "!@" + SelectedLOG_T001_A.delivery_no;
        ...
        private void LoadHistory()
        {
            ...
            {
                CursorControl.SetBusyState();
                string Request = "LoadHistory" + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.EmpId + "!@" + Convert.ToDateTime(SelectedLOG_T001_A.Fltr_FrmDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(SelectedLOG_T001_A.Fltr_ToDate).ToString("MM/dd/yyyy") + "!@" + SelectedLOG_T001_A.Fltr_t_status + "!@" + SelectedLOG_T001_A.Fltr_active + "!@" + SelectedLOG_T001_A.Fltr_doc_type + "!@" + SelectedLOG_T001_A.Fltr_PartyId + "!@" + AppSessionState.client;
                MCTemp = repositoryM.GetDataWithReturnDomainObject<MultipleContext_LOG_T001_A>(MCTemp, "LOG_T001_A_Data", "DeliveryNote", "SCM", "LoadAll", 0, Request);
                ...
                var msg = new NotificationMessage("SDM_T013_VM");
            ...
            try
            {
                ...
                if (POPUPEntityObject != null)
                {
                    if (POPUPEntityObject.t_status != "009")
                    {
                        ...
                        DocumentList = "";
                        if (SelectedLOG_T001_A.ref_doc_cat == "SO" || SelectedLOG_T001_A.ref_doc_cat == "OP")
                        {
                            refdoctempa = (from o in MC.OrderList where (o.doc_cat == "SO" || o.doc_cat == "OP") select o).ToList();
                        ...
                        else if (SelectedLOG_T001_A.ref_doc_cat == "DO")
                        {
                            ...
                            // Clear Other reference
                            var refdoctempSO = (from o in MC.OrderList where (o.doc_cat == "SO" || o.doc_cat == "OP") select o);
                            if (refdoctempSO != null)
                            {
                                try
                                {
                            ...
                            ReferenceDocSOCollection = CollectionViewSource.GetDefaultView((from o in MC.OrderList where (o.doc_cat == "SO" || o.doc_cat == "OP") select o).ToList());
                            ReferenceDocSOCollection.Filter = new Predicate<object>(Filter_ReferenceDoc);
        ...
        protected override void OnFlipAction(InquiryActionResult<LOG_T001_A> result)
        {
            try
            {
                string Request = "RefreshBatchCollection" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id.ToString() + "!@" + SelectedLOG_T001_A.doc_type + "!@" + SelectedLOG_T001_A.doc_cat;
