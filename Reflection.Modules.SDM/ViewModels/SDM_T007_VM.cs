...
{
    public class SDM_T007_VM : WorkspaceViewModel<SEL_T004>
    {
        #region Declaration
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(SDM_T007_VM));
        ...
        #region Constructor
        public SDM_T007_VM(string ts_code) : base()
        {
        ...
        public SDM_T007_VM(string ts_code, string doc_no) : base()
        {
            this.ts_code_vm = ts_code;
        ...
        public SDM_T007_VM(string doc_no, string ts_code, string ts_name_display) : base()
        {
            this.ts_code_vm = ts_code;
            this.doc_no_vm = doc_no;
            MC = new MultipleContext_SEL_T004();
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                MasterEntity.doc_cat = "DO";
                MasterEntity.doc_type = "DO";
                string Request = "LoadInitialData" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat + "!@" + AppSessionState.so_code + "!@" + AppSessionState.sg_code + "!@" + AppSessionState.EmpId + "!@" + AppSessionState.client; ;
                MC = repository_MC.GetDataWithReturnDomainObject<MultipleContext_SEL_T004>(MC, Request, "SEL_T004_BL", "SDM", "LoadAll", 0, Request);
            ...
            try
            {
                ...
                if (POPUPEntityObject != null)
                {
                    if (POPUPEntityObject.t_status != "09")
                    {
                        ...
                        {
                            refdoctempa = (from o in MC.Dispatch_Order_Reference where (o.doc_cat == "SO" || o.doc_cat == "OP") select o).ToList();
            ...
            try
            {
                ...
                if (ParameterObject.GetType() == typeof(string) && ParameterObject != null) // This Block of code read parameter . First for string and Entity Object in else part.
                {
                    ...
                    if (ParametersStringValue.Length > 0)
                    {
                        ...
                        {
                            Request = "LoadDocumentWithReferenceDocumentNumber" + "!@" + DocumentList + "!@" + party_id + "!@" + party_id + "!@" + AppSessionState.client + "!@" + MasterEntity.comp_code + "!@" + MasterEntity.ts_code;
                            MCTemp = repository_MCTemp.GetDataWithReturnDomainObject<MultipleContext_SEL_T004>(MCTemp, Request, "SEL_T004_BL", "SDM", "", 0, Request);
        ...
        private void LoadHistory()
        {
            try
            {
                ...
                MCTemp = repository_MC.GetDataWithReturnDomainObject<MultipleContext_SEL_T004>(MCTemp, Request, "SEL_T004_BL", "SDM", "LoadAll", 0, Request);
        ...
        private bool validation()
        {
            try
            {
                if (Dispatch_Order_Reference != null)
                {
        ...
        protected override void OnSaveAction(InquiryActionResult<SEL_T004> result)
        {
            try
            {
                if (validation() == true)
                {
                    ...
                    if (isNewRecord == true)
                    {
                        MasterEntity = repository.SaveWithReturnDomainObject<SEL_T004>(MasterEntity, "SEL_T004_BL", "SDM");
                    ...
                    {
                        MasterEntity = repository.UpdateWithReturnDomainObject<SEL_T004>(MasterEntity, "SEL_T004_BL", "SDM");
                        SetBusinessEntitiesAfterLoad("Save", "");
                    }
        ...
        protected override void OnRemoveAction(InquiryActionResult<SEL_T004> result)
        {
            try
            {
                ...
                if (showMessageService.ShowMessage() == DialogResult.Ok)
                {
                    ...
                    string response = repository.Delete(MasterEntity.doc_no, "SEL_T004_BL", "SDM");
        ...
        protected override void OnPrintAction(InquiryActionResult<SEL_T004> result)
        {
            try
            {
                ...
                else
                {
                    //SEL_T004Flip ParameterEntityObject = null;
                    //ParameterEntityObject = ((IEnumerable)ParameterObject).Cast<SEL_T004Flip>().ToList()[0];
                    string Request = "LoadDocumentFromBackFlip" + "!@" + MasterEntity.doc_no + "!@" + MasterEntity.ref_doc_cat + "!@" + AppSessionState.client + "!@" + MasterEntity.comp_code;
