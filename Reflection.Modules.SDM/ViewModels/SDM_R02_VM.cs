...
using Reflection.BusinessEntity.SDM;
using Reflection.BusinessEntity.ADM;

namespace Reflection.Modules.SDM.ViewModels
{
    public class SDM_R02_VM : WorkspaceViewModel<STD_LIST_BE>
    {
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(SDM_R02_VM));
        ...
        #endregion
        public SDM_R02_VM(string ts_code) : base()
        {
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<STD_MIS_MC_BE>(MC, Request, "SDM_R02", "SDM", " ", 0, "");
            ...
            try
            {
                ...
                else
                {
                    if (REQ_PARA_OBJ != null)
                    {
                        ...
                        //string filePath = @"D:\Reflection ERP 2022\ReflectionWebServices\ReflectionServiceHost\Reports\REPORTS_STD\MIS\SDM_M046.rdlc";
