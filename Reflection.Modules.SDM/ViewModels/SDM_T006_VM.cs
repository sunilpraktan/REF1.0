...
{
    public class SDM_T006_VM : WorkspaceViewModel<SEL_T002>
    {
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(SDM_T006_VM));
        ...
        #endregion
        #region Constructor
        public SDM_T006_VM(string doc_cat, string ts_code) : base()
        {
        ...
        public SDM_T006_VM(string doc_cat, string ts_code, string doc_no) : base()
        {
            CursorControl.SetBusyState();
            this.doc_cat_vm = doc_cat;
            this.ts_code_vm = ts_code;
                    ...
                    if (POPUPEntityObject.Count > 0)
                    {
                        ...
                        foreach (var itemObj in POPUPEntityObject)
                        {
                            ...
                            ItemDataGridCollection.Add(new SEL_T002_A()
                            {
                                ...
                                add_code_del = itemObj.add_code_del,
            ...
            try
            {
                ...
                else if (ParameterObject != null)
                {
                    if (((IEnumerable)ParameterObject).Cast<SEL_T002_BackFlip>().ToList().Count > 0)
                    {
                        ...
                        blNew = false;
                        string RequestParameterData = "LoadDocumentWithReferenceDocumentNumber" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + this.doc_cat_vm + "!@" + POPUPEntityObject.sch_no;
                        MCTemp = repository_MC.GetDataWithReturnDomainObject<MultipleContext_SEL_T002>(MCTemp, RequestParameterData, "SEL_T002_BL", "SDM", "", 0, "");
                        ...
                        MC.DeliveryAddress = MCTemp.DeliveryAddress;
        ...
        private void ExecuteReferenceDocuments()
        {
            try
            {
                ...
                if ((from o in ReferenceDocFilteredList where o.Select == true select o).ToList().Count > 0) // foreach for only selected rows.
                {
                    ...
                    foreach (var item in (from o in ReferenceDocFilteredList where o.Select == true select o).ToList())
                    {
                        if (item.Select == true)
                        {
                            ItemDataGridCollection.Add(new SEL_T002_A()
                            {
                                ...
                                add_code_del = item.add_code_del,
                    ...
                    string Request = "LOAD_PARTY_INFO" + "!@" + AppSessionState.client.ToString() + "!@" + AppSessionState.OBJ_COMPANY.comp_code.ToString() + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + doc_cat_vm + "!@" + doc_cat_vm + "!@" + MasterEntity.PartyId;
                    MCTemp = repository_MC.GetDataWithReturnDomainObject<MultipleContext_SEL_T002>(MCTemp, Request, "SEL_T002_BL", "SDM", " ", 0, "");
                    ...
                    MasterEntity.add_code_del =ItemDataGridCollection[0].add_code_del;
                    MasterEntity.del_add = (from o in MCTemp.DeliveryAddress where o.SrNo == MasterEntity.del_address select o).ToList()[0].del_add;


                    if (MC.contactInfoMaster.Count == 1)
                    {
                        MasterEntity.ContInfoId = MC.contactInfoMaster[0].ContInfoId;
                        MasterEntity.cp_code = MC.contactInfoMaster[0].cp_code;
        ...
        private void InsertShipToAddress(object InputValue)
        {
            ...
            try
            {
                ...
                if (POPUPEntityObject != null)
                {
                    ...
                    ItemDataGridCollection[ItemDataGridSelectedIndex].add_code_del = POPUPEntityObject.add_code;
        ...
        private void LoadInitialData()
        {
            try
            {
                string Request = "LoadInitialData" + "!@" + AppSessionState.client.ToString() + "!@" + AppSessionState.OBJ_COMPANY.comp_code.ToString() + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + doc_cat_vm + "!@" + doc_cat_vm + "!@" + AppSessionState.EmpId;
                MC = repository_MC.GetDataWithReturnDomainObject<MultipleContext_SEL_T002>(MC, Request, "SEL_T002_BL", "SDM", " ", 0, "");
        ...
        private void RemoveRefDoc()
        {
            try
            {
                if (MasterEntity.ref_doc_no != null)
                {
                    ...
                    ReferenceDocCollection = CollectionViewSource.GetDefaultView((from o in MC.Reference_Docs where (o.doc_cat == "SO" || o.doc_cat == "OP") select o).ToList());
                    ReferenceDocCollection.Filter = new Predicate<object>(Filter_ReferenceDoc);
                }
            ...
            try
            {
                if (MasterEntity.sch_no != null && MasterEntity.sch_no != "" && ItemDataGridCollection.Count > 0)
                {
                    if (Validation() == true)
                    {
                        ...
                        ObjectSEL_T004.location_Id = AppSessionState.OBJ_LOCATION.location_id;
                        ObjectSEL_T004.comp_code = AppSessionState.OBJ_COMPANY.comp_code;
                        ObjectSEL_T004.add_by = AppSessionState.UserID;
                        ObjectSEL_T004.active = true;
                        ObjectSEL_T004.t_status = "01";
                ...
                if (ItemDataGridCollection.Count > 0)
                {
                    if (Validation() == true)
                    {
                        try
                        {
                            ...
                            if (blNew == true)
                            {
                                MasterEntity = repository.SaveWithReturnDomainObject<SEL_T002>(MasterEntity, "SEL_T002_BL", "SDM");
                            ...
                            {
                                MasterEntity = repository.UpdateWithReturnDomainObject<SEL_T002>(MasterEntity, "SEL_T002_BL", "SDM");
                                NotifyMessage("OnInsert");
            ...
            try
            {
                if (MasterEntity.sch_no != null)
                {
                    ...
                    if (showMessageService.ShowMessage() == DialogResult.Ok)
                    {
                        ...
                        string response = repository.Delete(MasterEntity.sch_no, "SEL_T002_BL", "SDM");
        ...
        protected override void OnPrintAction(InquiryActionResult<SEL_T002> result)
        {
            ...
            try
            {
                ...
                MCTemp = repository_MCTemp.GetDataWithReturnDomainObject<MultipleContext_SEL_T002>(MCTemp, Request, "SEL_T002_BL", "SDM", "", 0, "");
