...
namespace Reflection.Modules.SDM.Views
{
    ...
    /// </summary>
    public partial class SDM_T003 : WindowElement
    {
        public string ts_code_vm { get; set; }
        public string dgKey { get; set; } = null;
        public SDM_T003(string ts_code)
        {
            ts_code_vm = ts_code;
            this.DataContext = new SDM_T005_VM(ts_code, "QN", "QN");
            InitializeComponent();
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        public SDM_T003(string ts_code, string doc_no)
        {
            ts_code_vm = ts_code;
            this.DataContext = new SDM_T005_VM(ts_code, "QN", "QN", doc_no);
            InitializeComponent();
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        public SDM_T003(string ts_code, STD_LIST_BE STD_OBJECT)
        {
