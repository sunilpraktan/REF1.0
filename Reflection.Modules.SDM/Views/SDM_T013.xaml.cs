...
namespace Reflection.Modules.SDM.Views
{
    ...
    /// </summary>
    public partial class SDM_T013 : WindowElement
    {
        public string ts_code_vm { get; set; }
        private bool isManualEditCommit;
        private string ts_code_local;
        public SDM_T013(string ts_code)
        {
            this.ts_code_local = ts_code;
            ts_code_vm = ts_code;
            InitializeComponent();
            this.DataContext = new SDM_T013_VM(ts_code);
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        public SDM_T013(string ts_code, string doc_no)
        {
            this.ts_code_local = ts_code;
            InitializeComponent();
            InitializeComponent();
            this.DataContext = new SDM_T013_VM(ts_code, doc_no);
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        public SDM_T013(string doc_no, string ts_code, string ts_name_display)
        {
            this.ts_code_local = ts_code;
            InitializeComponent();
            AppSessionState.ViewTitle = ts_name_display;
            InitializeComponent();
            this.DataContext = new SDM_T013_VM(doc_no, ts_code, ts_name_display);
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
