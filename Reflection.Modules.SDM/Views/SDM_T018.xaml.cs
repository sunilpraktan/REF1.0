...
namespace Reflection.Modules.SDM.Views
{
    ...
    /// </summary>
    public partial class SDM_T018 : WindowElement
    {
        public string ts_code_vm { get; set; }
        public string dgKey { get; set; } = null;
        public SDM_T018(string ts_code)
        {
        ...
        public SDM_T018(string ts_code, string doc_no)
        {
            this.ts_code_vm = ts_code;
            InitializeComponent();
        ...
        public SDM_T018(string ts_code, STD_LIST_BE STD_OBJECT)
        {
            this.ts_code_vm = ts_code;
            InitializeComponent();
