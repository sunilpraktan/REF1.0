...
namespace Reflection.Modules.SDM.Views
{
    ...
    /// </summary>
    public partial class SDM_T004 : WindowElement
    {
        public string ts_code_vm { get; set; }
        public string dgKey { get; set; } = null;
        public SDM_T004(string ts_code)
        {
            this.ts_code_vm = ts_code;
            InitializeComponent();
            this.DataContext = new SDM_T005_VM(ts_code, "CO", "CO");
        ...
        public SDM_T004(string ts_code, string doc_no)
        {
            this.ts_code_vm = ts_code;
            InitializeComponent();
            this.DataContext = new SDM_T005_VM(ts_code, "CO", "CO", doc_no);
            tbcMaster.SelectionChanged += TabControl_SelectionChanged;
            tbcDetail.SelectionChanged += TabControl_SelectionChanged;
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        public SDM_T004(string ts_code, STD_LIST_BE STD_OBJECT)
        {
            this.ts_code_vm = ts_code;
            InitializeComponent();
