...
{
    class FICO_M0034_VM : WorkspaceViewModel<ACC_M003_T>
    {
        static int i;
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(FICO_M0034_VM));
                ...
                if (POPUPEntityObject != null) // Only enter in the code block if ENtity Not null.
                {
                    ...
                    else if (dgSelectedIndex >= 0 && DetailEntity.Count > dgSelectedIndex) //Update Row: If Old or Blank row get added, then Edit Rule will applicable in this Loop.
                    {
                        if (DetailEntity[dgSelectedIndex].id == 0) // It will allowe to add unique value or Duplicate value if AllowDuplicate Status == True
                        {
                            DetailEntity[dgSelectedIndex].gl_code_d = POPUPEntityObject.gl_code;
                            DetailEntity[dgSelectedIndex].gl_desc_d = POPUPEntityObject.gl_name;
                            DetailEntity[dgSelectedIndex].comp_code = AppSessionState.comp_code;
        ...
        private void LoadInitialData(string TempTrnsKeyCode, string strCOAKey)
        {
            try
            {
                string Request = "LoadPostingDetreminationData" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + TempTrnsKeyCode + "!@" + strCOAKey + "!@" + AppSessionState.client;
        ...
        private void LoadDataAfterDefiningRules(string TempTrnsKeyCode, string strCOAKey)
        {
            try
            {
                string Request = "LoadDataAfterDefiningRules" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + TempTrnsKeyCode + "!@" + strCOAKey + "!@" + AppSessionState.client;
                ...
                //var msg = new NotificationMessage("FICO_M0034_VM");
        ...
        private void View_DefineRulesforKey(object InputValue)
        {
            try
            {
                    ...
                    && (MasterEntity.coa_key != null && MasterEntity.coa_key != ""))
                {
                    ...
                    AppSessionState.TransValueType = "FROM_ACC_M003_T_VM";
