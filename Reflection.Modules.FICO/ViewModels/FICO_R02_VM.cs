...
{
    public class FICO_R02_VM : WorkspaceViewModel<STD_LIST_BE>
    {
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(FICO_R02_VM));
        ...
        private AutoSuggestTextViewModel<dynamic> _AS_PARTY_TYPE { get; set; }
        public AutoSuggestTextViewModel<dynamic> AS_PARTY_TYPE
        {
            get { return _AS_PARTY_TYPE; }
            set
            {
                if (_AS_PARTY_TYPE != value)
                {
                    _AS_PARTY_TYPE = value; RaisePropertyChanged("AS_PARTY_TYPE");
                }
            }
        }
        ...
        #endregion
        public FICO_R02_VM(string ts_code) : base()
        {
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<STD_MIS_MC_BE>(MC, Request, "FICO_R02", "FICO", " ", 0, "");
                ...
                AS_PARTY_TYPE = new AutoSuggestTextViewModel<dynamic>(MC.PARTY_TYPE_LIST, TheFilter, SuggestedValue, "group_code", true);
                AS_PARTY_TYPE.AutoSuggestVM.IsEmptyValueAllowed = true; AS_PARTY_TYPE.AutoSuggestVM.IsFreeTextAllowed = false;
            ...
            try
            {
                ...
                else
                {
                    if (REQ_PARA_OBJ != null)
                    {
                        ...
                        MC_TEMP = repository_MC.GetDataWithReturnDomainObject<STD_MC_BE>(MC_TEMP, RequestParameter, "FICO_R02", "FICO", " ", 0, "");
