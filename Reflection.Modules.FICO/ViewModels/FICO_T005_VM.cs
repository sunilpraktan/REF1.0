...
{
    public class FICO_T005_VM : WorkspaceViewModel<SEL_T003>
    {
        #region AutoSuggest TextBox Region
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(FICO_T005_VM));
        ...
        #region Constructor 
        public FICO_T005_VM(string doc_cat, string ts_code) : base()
        {
        ...
        public FICO_T005_VM(string doc_cat, string ts_code, string doc_no) : base()
        {
            CursorControl.SetBusyState();
            this.ts_code_vm = ts_code;
            this.doc_cat_vm = doc_cat;
        ...
        private void LoadInitialData()
        {
            ...
            {
                isNewRecord = true;
                string Request = "LOAD_INI" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + this.doc_cat_vm + "!@" + this.doc_cat_vm + "!@!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + this.ts_code_vm + "!@" + AppSessionState.so_code + "!@" + AppSessionState.sg_code;
                //string Request = "LOAD_INI" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat + "!@" + "PI,CI,SI" + "!@" + AppSessionState.so_code + "!@" + AppSessionState.sg_code + "!@" + AppSessionState.EmpId + "!@" + AppSessionState.client + "!@" + AppSessionState.UserID + "!@" + this.ts_code_vm;
                ...
                //var refdoctype1 =  = (from o in MC.DOC_TYPE_LIST where o.doc_type == "CI" select o).ToList();
                //SuggestedValue = new ValueConverter(x => x == null ? "" : ((STD_DOC_TYPE)x).doc_type_user);
                //TheFilter = (o, prefix) => ((STD_DOC_TYPE)o).doc_type_user.ToString().ToLower().Contains(prefix.ToLower())  ;
                ...
                ASDeclaration = new AutoSuggestTextViewModel<dynamic>(MC.GSTDeclaration, TheFilter, SuggestedValue, "report_declr", true);
                ...
                var refdoctemp = (from o in MC.DOC_TYPE_LIST where o.doc_type == "CI" select o).ToList();
                ...
                StringListDocumentTypes = MC.DOC_TYPE_LIST.Select(x => x.doc_type_user).ToList();
        ...
        private void LoadHistory()
        {
            try
            {
                ...
                MCTemp = repository_MC.GetDataWithReturnDomainObject<MultipleContext_SEL_T003>(MCTemp, Request, "SEL_T003_BL", "FICO", "LOAD_BACKFLIP", 0, "");
                ...
                if (POPUPEntityObject != null)
                {
                    ...
                    if (MCTemp.MasterEntity != null && AppSessionState.client == "1")
                    {
                        if (MCTemp.MasterEntity.Count > 0 && ItemsEntity.Count >= 2)
                        {
                            ...
                            Computation(true, 1, AutoRoundupEnable);
                        }
                    }
        ...
        private void InsertCustCatlogNo(object InputValue)
        {
            ...
            if (POPUPEntityObject != null)
            {
                ...
                RequestParameterData = "LoadFromCatlogNo" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + MasterEntity.cust_cat_no + "!@" + AppSessionState.client + "!@" + MasterEntity.location_Id;
                ...
                if (POPUPEntityObject != null)
                {
                    ...
                    else if (isNewRecord == true && ItemsEntity.Count > 0)
                    {
                        ...
                        if (showMessageService.ShowMessage() == DialogResult.Ok)
                        {
                            ...
                            //RequestParameterData = "LoadFromSoldToPartyDetails" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + MasterEntity.PartyId + "!@" + AppSessionState.client;
                            MCTemp = repository_MCTemp.GetDataWithReturnDomainObject<MultipleContext_SEL_T003>(MCTemp, RequestParameterData, "SEL_T003_BL", "FICO", "", 0, "");
                    ...
                    else
                    {
                        ...
                        RequestParameterData = "LoadFromSoldToPartyDetails" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + this.doc_cat_vm + "!@" + MasterEntity.doc_type + "!@!@!@!@!@!@!@" + MasterEntity.PartyId;
                        //RequestParameterData = "LoadFromSoldToPartyDetails" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + MasterEntity.PartyId +"!@" + AppSessionState.client;
                        MCTemp = repository_MCTemp.GetDataWithReturnDomainObject<MultipleContext_SEL_T003>(MCTemp, RequestParameterData, "SEL_T003_BL", "FICO", "", 0, "");
        ...
        private void PrintPackingList()
        {
            try
            {
                ...
                string Request = "DN_PackingList" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + MasterEntity.ref_doc_cat + "!@" + MasterEntity.ref_doc_no + "!@" + MasterEntity.bill_doc + "!@" + MasterEntity.proforma_inv_no;
        ...
        private void PrintAirwayBill()
        {
            ...
            {
                CursorControl.SetBusyState();
                string Request = "SI_Report" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + "AW" + "!@" + "AW" + "!@" + MasterEntity.bill_doc;
        ...
        protected override void OnFevoriteAction(InquiryActionResult<SEL_T003> result)
        {
            try
            {
                if (MasterEntity.bill_doc != null && MasterEntity.bill_doc != "")
                {
                    if (MasterEntity.t_status != "17")
                    {
                        string Request = "ValidateInvoice" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + this.doc_cat_vm + "!@" + doc_cat_vm + "!@" + MasterEntity.bill_doc + "!@" + AppSessionState.UserID;
                        MCTemp = repository_MC.GetDataWithReturnDomainObject<MultipleContext_SEL_T003>(MCTemp, Request, "SEL_T003_BL", "FICO", "LoadAll", 0, "");

                        if (MCTemp.MasterEntity.Count > 0)
                        {
                            if (MCTemp.MasterEntity[0].t_status == "17")
                            {
                    ...
                    else if (MasterEntity.t_status == "17")
                    {
                        IShowMessageViewService sms = this.GetViewService<IShowMessageViewService>(); sms.ButtonSetup = DialogButton.Ok; sms.Caption = "Message"; sms.Text = String.Format("Invoice Validate Succesfully...", this.Title); sms.ShowMessage();
                    }
                }
        ...
        protected override void OnPrintAction(InquiryActionResult<SEL_T003> result)
        {
            ...
            //try
            //{
            //    string Request = "SI_Report" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + MasterEntity.doc_cat + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.bill_doc;
