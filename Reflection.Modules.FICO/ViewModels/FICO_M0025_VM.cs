...
{
    public class FICO_M0025_VM : WorkspaceViewModel<ADM_M041>
    {
        ...
        #region Constructor
        public FICO_M0025_VM(string ts_code) : base()
        {
            ...
            if (POPUPEntityObject != null)
            {
                ...
                else if (dgSelectedIndex >= 0 && ItemsEntity.Count > dgSelectedIndex)
                {
                    if (ItemsEntity[dgSelectedIndex].id == 0 && ((IndexOfExistValue == -1) || (IndexOfExistValue != -1 && AllowDuplicate == true)))
                    {
                        ...
                        ItemsEntity[dgSelectedIndex].location_Id = AppSessionState.OBJ_LOCATION.location_id;
                        ItemsEntity[dgSelectedIndex].comp_code = AppSessionState.OBJ_COMPANY.comp_code;
        ...
        private void LoadInitialData()
        {
            try
            {
                string Request = "LoadInitialData" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id.ToString();
