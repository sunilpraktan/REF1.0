...
namespace Reflection.Modules.FICO.Views
{
    ...
    /// </summary>
    public partial class FICO_T005 : WindowElement
    {
        public string ts_code_vm { get; set; }
        private bool isManualEditCommit;
        public FICO_T005(string ts_code)
        {
            ts_code_vm = ts_code;
            
            this.DataContext = new FICO_T005_VM("CI", ts_code);
            InitializeComponent();
        ...
        public FICO_T005(string ts_code, string doc_n)
        {
            ts_code_vm = ts_code;
            InitializeComponent();
            this.DataContext = new FICO_T005_VM("CI", ts_code, doc_n);
            tbcMaster.SelectionChanged += TabControl_SelectionChanged;
            tbcDetail.SelectionChanged += TabControl_SelectionChanged;
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
