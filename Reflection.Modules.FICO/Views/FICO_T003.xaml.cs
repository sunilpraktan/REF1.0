...
namespace Reflection.Modules.FICO.Views
{
    ...
    /// </summary>
    public partial class FICO_T003 : WindowElement
    {
        public string ts_code_vm { get; set; }
        public FICO_T003(string ts_code)
        {
            
            ts_code_vm = ts_code;
            this.DataContext = new FICO_T003_VM("PQ",ts_code);
            InitializeComponent();
        ...
        public FICO_T003(string ts_code, string doc_no)
        {
            InitializeComponent();
            this.DataContext = new FICO_T003_VM("PQ", ts_code, doc_no);
            tbcMaster.SelectionChanged += TabControl_SelectionChanged;
            tbcDetail.SelectionChanged += TabControl_SelectionChanged;
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
