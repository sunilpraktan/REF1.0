...
namespace Reflection.Modules.FICO.Views
{
    ...
    /// </summary>
    public partial class FICO_T007 : WindowElement
    {
        public string ts_code_vm { get; set; }
        private bool isManualEditCommit;
        public FICO_T007(string ts_code)
        {
            this.ts_code_vm = ts_code;
            
            this.DataContext = new FICO_T006_VM("PM", ts_code); //FICO_T006_VM is VM for this screen.
            InitializeComponent();
        ...
        public FICO_T007(string ts_code, string doc_no)
        {
            this.ts_code_vm = ts_code;
            InitializeComponent();
            this.DataContext = new FICO_T006_VM("PM", ts_code, doc_no);//FICO_T006_VM is VM for this screen.
            tbcMaster.SelectionChanged += TabControl_SelectionChanged;
            //tbcDocDetails.SelectionChanged += TabControl_SelectionChanged;
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived2);
