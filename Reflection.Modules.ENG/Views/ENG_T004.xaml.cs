...
{
    /// <summary>
    /// Interaction logic for ENG_T004.xaml
    /// </summary>
    public partial class ENG_T004 : WindowElement
    {
        public string ts_code_vm { get; set; }
        private bool isManualEditCommit;
        public ENG_T004(string ts_code)
        {
            InitializeComponent();
            ts_code_vm = ts_code;
        ...
        public ENG_T004(string ts_code, string doc_no)
        {
            InitializeComponent();
            ts_code_vm = ts_code;
