...
namespace Reflection.Presentation.Controls.AutoSuggestTextBox.GUI
{
    ...
    public class AutoSuggestViewModel : Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel
    {
        ...
        #region Suggestion
        public static readonly DependencyProperty SuggestionProperty = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterProperty<object, AutoSuggestViewModel>("Suggestion", null, (d, v) => ((AutoSuggestViewModel)d).AddSuggestionToSuggestions(v.NewValue), (d, v) => ((AutoSuggestViewModel)d).OnPropertyChanging(SuggestionProperty, v));
        public object Suggestion { get { return GetValue(SuggestionProperty); } set { SetValue(SuggestionProperty, value); } }
        #endregion
        #region Suggestions
        public static readonly DependencyProperty SuggestionsProperty = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterProperty<SelectedSuggestionsObservableCollection, AutoSuggestViewModel>("Suggestions", null);
        ...
        {
            //if (suggestion != null)  Removed by Sunil
            //{
            //    Suggestions.Clear();
        ...
        public static readonly DependencyProperty SuggestionPreviewProperty = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterProperty<object, AutoSuggestViewModel>("SuggestionPreview", null, null, (d, v) => ((AutoSuggestViewModel)d).OnPropertyChanging(SuggestionPreviewProperty, v));
        ...
        private static readonly DependencyPropertyKey SuggestionPreviewsPropertyKey = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterReadOnlyProperty<IEnumerable, AutoSuggestViewModel>("SuggestionPreviews", null, null, (d, v) => ((AutoSuggestViewModel)d).OnPropertyChanging(SuggestionPreviewsProperty, v));
        ...
        #region Filter
        public static readonly DependencyProperty SelectorProperty = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterProperty<ISelector, AutoSuggestViewModel>("Selector", null, (d, a) => ((__type)d).ApplyFilter(""), (d, v) => ((AutoSuggestViewModel)d).OnPropertyChanging(SelectorProperty, v));
        public ISelector Selector { get { return (ISelector)GetValue(SelectorProperty); } set { SetValue(SelectorProperty, value); } }
        #endregion

        #region CancelCommand
        private static readonly DependencyPropertyKey CancelCommandPropertyKey = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterReadOnlyProperty<Command, AutoSuggestViewModel>("CancelCommand");
        ...
        #endregion
        #region ClearCommand
        private static readonly DependencyPropertyKey ClearCommandPropertyKey = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterReadOnlyProperty<Command, AutoSuggestViewModel>("ClearCommand");
        ...
        #region Delay
        public static readonly DependencyProperty DelayProperty = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterProperty<TimeSpan, AutoSuggestViewModel>("Delay", new TimeSpan(0), DelayValueChanged, null);
        ...
        public static readonly DependencyProperty FreeTextToSuggestionConverterProperty = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterProperty<TryConvertFreeTextToSuggestion, AutoSuggestViewModel>("FreeTextToSuggestionConverter", null, null, (d, v) => ((AutoSuggestViewModel)d).OnPropertyChanging(FreeTextToSuggestionConverterProperty, v));
        ...
        public static readonly DependencyProperty IsFreeTextAllowedProperty = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterProperty<bool, AutoSuggestViewModel>("IsFreeTextAllowed");
        ...
        public static readonly DependencyProperty IsEmptyValueAllowedProperty = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterProperty<bool, AutoSuggestViewModel>("IsEmptyValueAllowed", false, null, (d, v) => ((AutoSuggestViewModel)d).OnPropertyChanging(IsEmptyValueAllowedProperty, v));
        ...
        #region StyleModel
        public static readonly DependencyProperty StyleModelProperty = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterProperty<object, AutoSuggestViewModel>("StyleModel", null);
        ...
        private static readonly DependencyPropertyKey ConfirmCommandPropertyKey = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterReadOnlyProperty<Command, AutoSuggestViewModel>("ConfirmCommand");
        ...
        #region Separators
        public static readonly DependencyProperty SeparatorsProperty = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterProperty<IList<string>, __type>("Separators");
        ...
        private static readonly DependencyPropertyKey CommandsPropertyKey = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterReadOnlyProperty<ObservableCollection<CommandBase>, AutoSuggestViewModel>("Commands");
        ...
        public class PropertyPathSuggestionToStringConverter : DependencyObject, IValueConverter
        {
            ...
            #region Value
            public static readonly DependencyProperty ValueProperty = Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.RegisterProperty<object, PropertyPathSuggestionToStringConverter>("Value");
