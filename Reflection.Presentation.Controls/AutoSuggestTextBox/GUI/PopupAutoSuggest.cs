...
namespace Reflection.Presentation.Controls.AutoSuggestTextBox.GUI
{
	...
	/// </summary>
	public class PopupAutoSuggest : System.Windows.Controls.Primitives.Popup
    {
        static PopupAutoSuggest()
        {
            Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.OverrideProperty<PopupAutoSuggest>(AllowsTransparencyProperty, true);
            Reflection.Presentation.Controls.AutoSuggestTextBox.Core.ViewModel.OverrideProperty<PopupAutoSuggest>(PopupAnimationProperty, PopupAnimation.Fade);
        }
        ...
        public Window Window { get { return _window ?? (_window = this.GetWindow()); } }
