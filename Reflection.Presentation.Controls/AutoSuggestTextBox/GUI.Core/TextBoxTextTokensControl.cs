...
namespace Reflection.Presentation.Controls.AutoSuggestTextBox.GUI.Core
{
    public class TextBoxTextTokensControl : ITextTokensControl
    {
        ...
        {
            return _textBox.IsKeyboardFocused;
        }
        ...
        {
            add { _textBox.PreviewLostKeyboardFocus += value; }
            remove { _textBox.PreviewLostKeyboardFocus -= value; }
        }
