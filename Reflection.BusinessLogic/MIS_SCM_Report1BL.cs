...
{
    public class MIS_SCM_Report1BL : ReflectionBusinessLogic
    {
        MultipleContext_MIS_SCM_Report1 MC = new MultipleContext_MIS_SCM_Report1();
        private static string ConnectionString;
        public MIS_SCM_Report1BL(string BusinessEntity)
        {
            ConnectionString = base.ReflectionConnectionString;
        }
        public MIS_SCM_Report1BL()
        {
            ConnectionString = base.ReflectionConnectionString;
        }
        ...
        public string GetData(string RequestValue, string QueryOption, int intValue, string strValue)
        {
            ...
            try
            {
                ...
                {
                    var reader = conn.QueryMultiple("MIS_SCM_Report", new { @Request = RequestValue }, commandType: CommandType.StoredProcedure);
