...
{
    public class PMM_R02_BL : ReflectionBusinessLogic
    {
        public PMM_R02_BL()
        { }
        public string GetData(string Request, string QueryOption, int intValue, string strValue)
        {
            ...
            try
            {
                ...
                if (RequestOption == "LOAD_INI" || RequestOption == "REPORT")
                {
                    ...
                    {
                        var reader = conn.QueryMultiple("PMM_R02", new { @request = Request }, commandTimeout: 0, commandType: CommandType.StoredProcedure);
                        ...
                        if (RequestOption == "LOAD_INI")
                        {
                            ...
                            MC.REASON_LIST = reader.Read<STD_LIST_BE>().ToList();
