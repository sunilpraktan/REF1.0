...
{
    public class PMM_M0002_BL : ReflectionBusinessLogic
    {
        ...
        public string GetData(string RequestValue, string QueryOption, int intValue, string strValue)
        {
            ...
            try
            {
                ...
                {
                    var reader = conn.QueryMultiple("PMM_M0002_GET", new { @Request = RequestValue }, commandType: CommandType.StoredProcedure);
