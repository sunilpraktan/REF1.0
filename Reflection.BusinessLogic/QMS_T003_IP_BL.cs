...
//{
//    public class QMS_T003_IP_BL : ReflectionBusinessLogic
//    {
//        private static string connectionString;
//        QMS_T003 MasterEntity = new QMS_T003();
//        MultipleContext_QMS_T003 MC = new MultipleContext_QMS_T003();

//        public QMS_T003_IP_BL(string BusinessEntity)
//        {
//            connectionString = base.ReflectionConnectionString;
//        }
//        public QMS_T003_IP_BL()
//        {
//            connectionString = base.ReflectionConnectionString;
//        }
...
//                using (IDbConnection conn = new SqlConnection(connectionString))
//                {
//                    var reader = conn.QueryMultiple("QMS_T003_A_Insert", new { @Request = Request }, commandTimeout: 0, commandType: CommandType.StoredProcedure);
...
//                using (IDbConnection conn = new SqlConnection(connectionString))
//                {
//                    var reader = conn.QueryMultiple("QMS_T003_IP_Update", new { @Request = Request }, commandType: CommandType.StoredProcedure);
