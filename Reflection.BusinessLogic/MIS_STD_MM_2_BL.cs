...
{
    public class MIS_STD_MM_2_BL : ReflectionBusinessLogic
    {
        private static string connectionString;
        public MIS_STD_MM_2_BL(string BusinessEntity)
        {
            connectionString = base.ReflectionConnectionString;
        }
        public MIS_STD_MM_2_BL()
        {
            connectionString = base.ReflectionConnectionString;
        }
        ...
        public string GetData(string strType, string QueryOption, int intValue, string strValue)
        {
            ...
            try
            {
                ...
                if (RequestOption == "LoadInitialData" || RequestOption == "Report")
                {
                    ...
                    {
                        var reader = conn.QueryMultiple("MIS_STD_MM_2", new { @request = strType }, commandTimeout: 0, commandType: CommandType.StoredProcedure);
