...
{
    public class SEL_T002_STD_BL : ReflectionBusinessLogic
    {
        ...
        public SEL_T002_STD_BL(string BusinessEntity)
        {
            connectionString = base.ReflectionConnectionString;
        }
        public SEL_T002_STD_BL()
        {
            connectionString = base.ReflectionConnectionString;
        }
        public string Insert(string Request)
        {
            ...
            try
            {
                ...
                {
                    var reader = conn.QueryMultiple("SEL_T002_STD_Insert", new { @Request = Request }, commandType: CommandType.StoredProcedure);
        ...
        public string Update(string Request)
        {
            ...
            try
            {
                using (IDbConnection conn = new SqlConnection(connectionString))
                {
                    var reader = conn.QueryMultiple("SEL_T002_STD_Update", new { @Request = Request }, commandType: CommandType.StoredProcedure);
        ...
        public string GetData(string RequestValue, string strType, int intValue, string strValue)
        {
            ...
            try
            {
                using (IDbConnection conn = new SqlConnection(connectionString))
                {
                    var reader = conn.QueryMultiple("SEL_T002_STD_LoadAll", new { @Request = RequestValue }, commandTimeout: 0, commandType: CommandType.StoredProcedure);
