...
{
    public class MIS_Finance_LedgerReport_BL : ReflectionBusinessLogic
    {
        private static string connectionString;
        public MIS_Finance_LedgerReport_BL(string BusinessEntity)
        {
            connectionString = base.ReflectionConnectionString;
        }
        public MIS_Finance_LedgerReport_BL()
        {
            connectionString = base.ReflectionConnectionString;
        }
        ...
        public string GetData(string strType, string QueryOption, int intValue, string strValue)
        {
            ...
            try
            {
                ...
                {
                    var reader = conn.QueryMultiple("MIS_Finance_LedgerReport", new { @request = strType }, commandType: CommandType.StoredProcedure);
                    ...
                    if (RequestOption == "LoadInitialData")
                    {
                        ...
                        //MC.LedgerList = reader.Read<PP_FICO_Ledger>().ToList();
