...
{
    public class MIS_CRMSalesReport3_BL : ReflectionBusinessLogic
    {
        private static string connectionString;      
        public MIS_CRMSalesReport3_BL(string BusinessEntity)
        {
            connectionString = base.ReflectionConnectionString;
        }
        public MIS_CRMSalesReport3_BL()
        {
            connectionString = base.ReflectionConnectionString;
        }
                 ...
                 if (RequestOption == "LoadInitialData" || RequestOption == "Report")
                    {
                        ...
                        {
                            var reader = conn.QueryMultiple("MIS_CRM_SalesPeriodic3", new { @request = strType }, commandTimeout: 600, commandType: CommandType.StoredProcedure);
