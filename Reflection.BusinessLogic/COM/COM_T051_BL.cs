...
{
    public class COM_T051_BL : ReflectionBusinessLogic
    {
        ...
        public string ExecuteNotification(string Request) 
        {
        ...
        public string ExecuteWhatsAppNotification(string Request)
        {
