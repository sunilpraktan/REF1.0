...
{
    public class MM_T001_MI_BL : ReflectionBusinessLogic
    {
        ...
        public MM_T001_MI_BL(string BusinessEntity)
        {
            connectionString = base.ReflectionConnectionString;
        }
        public MM_T001_MI_BL()
        {
            connectionString = base.ReflectionConnectionString;
        }
        ...
        public string Insert(string Request)
        {
            try
            {
                ...
                {
                    var reader = conn.QueryMultiple("MM_T001_MI_Insert", new { @Request = Request }, commandTimeout: 0, commandType: CommandType.StoredProcedure);
        ...
        public string Update(string Request)
        {
            try
            {
                using (IDbConnection conn = new SqlConnection(connectionString))
                {
                    var reader = conn.QueryMultiple("MM_T001_MI_Update", new { @Request = Request }, commandTimeout: 0, commandType: CommandType.StoredProcedure);
        ...
        public string GetData(string RequestValue, string QueryOption, int intValue, string strValue)
        {
            ...
            try
            {
                using (IDbConnection conn = new SqlConnection(connectionString))
                {
                    var reader = conn.QueryMultiple("MM_T001_MI_LoadAll", new { @Request = RequestValue }, commandTimeout: 0, commandType: CommandType.StoredProcedure);
