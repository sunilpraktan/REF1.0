...
namespace Reflection.BusinessEntity
{
    public class STD_MC_BE
    {
        ...
        public List<STD_LIST_BE> GRID_COLLECTION { get; set; }
        ...
        public List<STD_LIST_BE> WC_LIST { get; set; }
        ...
        public List<Classification> CLASS_LIST { get; set; }
        public List<STD_LIST_BE> VC_CLASS_LIST { get; set; }
        public List<Classification> CHAR_LIST { get; set; }
        public List<STD_LIST_BE> CHARACTRISTICS_LIST { get; set; }
        public List<Classification> CHAR_VALUE_LIST { get; set; }
        public List<STD_LIST_BE> CHAR_GROUP_LIST { get; set; }
        public List<ADM_M0126> VC_LIST { get; set; }
        public ObservableCollection<ADM_M0127> VC_VALUE_LIST { get; set; }
        ...
        public List<STD_LIST_BE> PARA_TYPE_LIST { get; set; }
        public List<STD_LIST_BE> LINE_CAT_LIST { get; set; } // Line Category
        public List<STD_LIST_BE> METHOD_LIST { get; set; }
        public List<STD_LIST_BE> PROCEDURE_LIST { get; set; }
        public List<STD_LIST_BE> QUALIFICATION_LIST { get; set; }
        public List<STD_LIST_BE> USAGE_LIST { get; set; }
        ...
        public ObservableCollection<GEN_T021> GEN_CHAR_VALUE_LIST { get; set; } // This is for Template for new transaction. that is why type is ObservableCollection.
    ...
    {
        public ObservableCollection<SYS_AUTH> USER_LIST { get; set; } // Standard List of Users
        ...
        public ObservableCollection<SYS_AUTH> ROLE_USER_LIST { get; set; } // Assignemnt of User to Role 
        public ObservableCollection<SYS_AUTH> ROLE_TSCODE_LIST { get; set; } // Assignemnt of TS Code to User Role List
        public List<SYS_AUTH> STD_AUTH_LIST { get; set; } // Standard Authorisation list like Create, Modify, Delete, View, Print etc...
        public ObservableCollection<SYS_AUTH> TSCODE_AUTH_LIST { get; set; } // Assignment of Authorisdation to User Role and TS Code.
    ...
    public class MC_SDM_BE : STD_MC_BE
    {
        ...
        public ObservableCollection<SEL_T001_PART> PartnerEntity { get; set; }
        public List<STD_LIST_BE> PF_CODE_LIST { get; set; }
        public ObservableCollection<ACC_T021> BillingPlanEntity { get; set; }
    ...
    public class MC_FICO_BE : STD_MC_BE
    {
        ...
        public ObservableCollection<FICO_M0033> CURR_OC_LIST { get; set; }
    ...
    public class MC_GEN_BE : STD_MC_BE
    {
        ...
        public ObservableCollection<STD_BE_A> STD_ENTITY_COL { get; set; }
        public List<STD_BE_A> STD_MASTER_LIST { get; set; }
        public ObservableCollection<STD_BE_A> MasterEntity { get; set; }
        public ObservableCollection<STD_BE_A> ItemsEntity { get; set; }
    ...
    public class MC_PMS_BE : STD_MC_BE
    {
        ...
        public ObservableCollection<EPR_T001_C> DEPENDENCY_LIST { get; set; }
    ...
    {
        public List<PMM_M0001> EQUIPMENT_MASTER_LIST { get; set; }
        public List<PMM_M0021> FLEET_LIST { get; set; }
    ...
    public class MC_ENG_BE : STD_MC_BE
    {
        ...
        public ObservableCollection<ENG_T001_A> ItemsEntity { get; set; }
        public ObservableCollection<ENG_T001_C> BOMAssignmentEntity { get; set; }
        public List<ENG_T005> MasterEntityTask { get; set; }
        public ObservableCollection<ENG_T005_R> ComponantEntity { get; set; }
        public ObservableCollection<ENG_T005_A> OperationEntity { get; set; }
        public ObservableCollection<ENG_T005_B> CharEntity { get; set; }
        public ObservableCollection<ENG_T005_C> SelectedSetEntity { get; set; }
        public ObservableCollection<ENG_T005_M> AssignmentEntity { get; set; }
        public List<PMM_T005> MEASUREMENT_LIST { get; set; }
        public List<ENG_M0005> MEASUREMENT_POINT_LIST { get; set; }
        public List<ENG_T005_B> VCHAR_LIST { get; set; }
        public ObservableCollection<ENG_T001_C> BOMItemAssignmentEntity { get; set; }
    }
