...
namespace Reflection.BusinessEntity
{
    public class STD_LIST_BE : ObjectBase
    {
        ...
        public string req_code { get; set; } // Request Code
        ...
        public string request_type { get; set; } // Request Code
    ...
    public class STD_PARTY
    {
        ...
        public override string ToString()
        {
            return string.Format("{0}", party_code);
        }
    }
    ...
    public class STD_DOC_TYPE
    {
        ...
        public bool? ind_source { get; set; }
    }
    ...
    public class UOMS
    {
        ...
        public override string ToString()
        {
            return string.Format("{0}", unit_code);
        }
    }
