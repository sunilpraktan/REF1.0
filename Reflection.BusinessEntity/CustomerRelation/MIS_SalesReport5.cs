...
{
    public class MIS_SalesReport5 : ObjectBase
    {
    ...
    //Added by Priya
    public class MultipleContext_MIS_CRM_Sales5
    {
        ...
        public List<MIS_CRM_SalesEntity5> SalesReportList { get; set; }
