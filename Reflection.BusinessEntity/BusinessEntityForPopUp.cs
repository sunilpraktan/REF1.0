...
namespace Reflection.BusinessEntity
{
    ...
    public class ACC_M004_B_P //Our Bank Account Master
    {
    ...
    public class GEN_T009_P //Waybill no
    {
    ...
    public class QMS_M032_P //Popup For CatLog Type Master
    {
    ...
    public class QMS_M009Flip : ObjectBase
    {
    ...
    public class QMS_T002Flip : ObjectBase
    {
        public string doc_no { get; set; }
        public string barcode { get; set; }
        public string ref_doc_no { get; set; }
    ...
    public class ZADM_M010_P : ObjectBase
    {
    ...
    public class PUR_T002_A_P : ObjectBase// Popup For PO LOAD
    {
        public string po_no { get; set; }
        public DateTime? po_date { get; set; }
        public string doc_cat { get; set; }
    ...
    public class MM_S003_P : ObjectBase//Batch 
    {
        public string batch_no { get; set; }
        public string ItemCode { get; set; }
        public string unit_code { get; set; }
    ...
    public class ZADM_M008_P //Total Length Master
    {
    ...
    public class ZADM_M004_P //Wire Type Master
    {
    ...
    public class ZADM_M003_P : ObjectBase //Wire Size Master
    {
        public int wire_size_id { get; set; }
    ...
    public class MM_T003_P : ObjectBase
    {
        private bool _Select;
        public bool Select
        {
    ...
    public class ECRM_T003_B_P//Wrting TestDetails
    {
        public int id { get; set; }
    ...
    public class ADM_M030_P : ObjectBase
    {
        public string value_code { get; set; }
        public string para_code { get; set; }
    ...
    public class SYS_M005_P// Delivery Type
    {
        ...
        public bool Select { get; set; }//scaler
    }
    ...
    public class ADM_M001_D_P//---Sales Division
    {
        ...
        public static implicit operator ADM_M001_D_P(ADM_M001_A_P v)
        {
    ...
    public class SYS_M011_P//doc Type
    {
        public string doc_type { get; set; }
        public string doc_type_user { get; set; }
        public string doc_desc_user { get; set; }
    ...
    public class ZADM_M013_P : ObjectBase
    {
        public int machine_id { get; set; }
        public string machinecode { get; set; }
        public string wc_code { get; set; }
    ...
    public class ADM_M022_P : ObjectBase
    {
        public int? SrNo { get; set; }
    ...
    public class ADM_M012_P
    {
        ...
        {
            return string.Format("{0}", country_code);
        }
    ...
    public class ADM_M013_P
    {
        ...
        public override string ToString()
        {
            return string.Format("{0}", state_code);
        }
    ...
    public class ADM_M024_P : ObjectBase
    {
        public string EmpId { get; set; }
        public string EmpName { get; set; }
        public string EmpLName { get; set; }
    ...
    public class ADM_M018_P : ObjectBase
    {
        public string CatName { get; set; }
        public string CatCode { get; set; }
        private bool _Select;//scaler
    ...
    public class ADM_M019_P : ObjectBase
    {
        public string SubCatName { get; set; }
        public string SubCatCode { get; set; }
        public string CatCode { get; set; }
    ...
    public class ADM_M038_B_P : ObjectBase
    {
        public int? id { get; set; }
    ...
    public class ADM_M028_P : ObjectBase
    {
        public int? id { get; set; }
    ...
    public class ADM_M053Flip : ObjectBase
    {
    ...
    public class ADM_M054Flip : ObjectBase
    {
        public string cp_code { get; set; }
        public string party_id { get; set; }
        public string gender { get; set; }
    ...
    public class Order_No_P : ObjectBase  // This Popup Class is used in Delivery Note for Combine Loading of Sales Order , Invoice and PO
    {
        private bool _Select;
        public bool Select
        {
    ...
    public class ACC_M004_P : ObjectBase
    {
        public string bank_code { get; set; }
        public string bank_name { get; set; }
    ...
    public class ADM_M041_P //License Advance & EPCG
    {
        public string lic_cod { get; set; }
    ...
    public class SEL_T003_P_RefDoc : ObjectBase //Sales Invoice Reference Documents as per Party
    {
        private bool _Select;
        public bool Select
        {
    ...
    public class SEL_T001_P1 : ObjectBase//Sales Order Details for Production planning
    {
        ...
        private Nullable<decimal> _plan_qty_for_SO;
        public Nullable<decimal> plan_qty_for_SO
        {
            get { return _plan_qty_for_SO; }
            set
            {
                if (_plan_qty_for_SO != value)
                {
                    _plan_qty_for_SO = value;

                    RaisePropertyChanged("plan_qty_for_SO");
                }
            }
        }
    ...
    public class EPR_T004_C_P : ObjectBase
    {
    ...
    public class PRO_M001_A_P : ObjectBase
    {
        public string sub_cat_code { get; set; }
    ...
    public class SEL_T001_QN : ObjectBase
    {
        public string sono { get; set; }
        public Nullable<System.DateTime> sodate { get; set; }
        public string doc_type { get; set; }
    ...
    public class ACC_M002_D_P   //Asset Class And Area Assignment PopUp
    {
    ...
    public class HRM_M011_P // Pop up for catagory
    {
        public string cat_code { get; set; }
        public string cat_name { get; set; }
    }
    ...
    public class SearchEntity : ObjectBase
    {
        ...
        private DateTime? _from_date { get; set; }
        public DateTime? from_date
        {
            ...
            set
            {
                if (_from_date != value)
                {
                    _from_date = DateTimeOffset.Parse(value.ToString(), null).DateTime;
                    RaisePropertyChanged("from_date");
                }
            }
        }
        private DateTime? _to_date { get; set; }
        public DateTime? to_date
        {
            ...
            set
            {
                if (_to_date != value)
                {
                    _to_date = DateTimeOffset.Parse(value.ToString(), null).DateTime;
        ...
        private string _CatCode { get; set; }
        ...
        private string _SubCatName { get; set; }
        ...
        private string _po_code { get; set; }
        ...
        private string _so_code { get; set; }
        public string so_code
        {
            get { return _so_code; }
            set
        ...
        private string _sg_code { get; set; }
    ...
    public partial class OrderItemData : ObjectBase
    {
        private bool _Select;
        public bool Select
        {
