...
namespace Reflection.Presentation.Services
{
    public class NumberToEnglish
    {
        ...
        #region . Amount In Word with currency .
        public string AmountInWords(decimal Num, string currency,string monitory_unit,string monitory_unit_prefix,string tail_word)
        {
            string returnValue;
            //I have created this function for converting amount in indian rupees (INR).
            //You can manipulate as you wish like decimal setting, Doller (any currency) Prefix.
    ...
    public class clsChangeNumericToWords
    {
