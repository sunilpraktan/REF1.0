...
{
    class MM_S010_FG1_VM : WorkspaceViewModel<MM_S010>
    {
        ...
        #region Constructor
        public MM_S010_FG1_VM(string ts_code) : base()
        {
        ...
        public MM_S010_FG1_VM(string ts_code,string doc_no) : base()
        {
            this.ts_code_vm = ts_code;
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<MultipleContext_MM_S010>(MC, Request, "PhysicalStock1", "SCM", "LoadAll", 0, "");
                ...
                StringListBackflip = MC.BackFlipEntity.Select(x => x.doc_no).ToList();
        ...
        private void LoadItemDetails()
        {
            try
            {
                ...
                if (Validation1() == true)
                {
                    ...
                    MCTemp = repository_MCTemp.GetDataWithReturnDomainObject<MultipleContext_MM_S010>(MCTemp, RequestParameter, "PhysicalStock1", "SCM", "LoadAll", 0, "");
        ...
        private void InsertCategory(object InputValue)
        {
            try
            {
                ...
                if (POPUPEntityObject != null) //Application:New Record Only.Condition: Only enter in the code block if EntityObject is Not null and not assigning same value again if event fire twice.
                {
                    ...
                    MasterEntity.SubCatCode = "";
                    MasterEntity.ItemTypeCd = "";
                    MasterEntity.SubItemTpCd = "";
                    if (POPUPEntityObject.CatCode != "" || POPUPEntityObject.CatCode != null)
                    {
                        ...
                        var abc1 = from data in MC.SubCategoryList
                                   where data.SubCatCode == MasterEntity.SubCatCode
                                   select data;

                        ItemTypeCollection = CollectionViewSource.GetDefaultView(abc1.ToList());
                        ...
                        var myItem = from o in MC.SubItemTypeList
                                     where o.ItemTypeCd == MasterEntity.ItemTypeCd
                                     select o;
            ...
            try
            {
                ...
                if (POPUPEntityObject != null) //Application:New Record Only.Condition: Only enter in the code block if EntityObject is Not null and not assigning same value again if event fire twice.
                {
                    ...
                    if (POPUPEntityObject.SubCatCode != "All")
                    {
                        ...
                        var myItem1 = from o in MC.SubItemTypeList
                                      where o.ItemTypeCd == MasterEntity.ItemTypeCd
                                      select o;

                        SubItemTypeCollection = CollectionViewSource.GetDefaultView(myItem1.ToList());
                        SubItemTypeCollection.Filter = new Predicate<object>(Filter_SubItemType);
                        StringListSubItemType = MC.SubItemTypeList.Select(x => x.SubItemTpCd).ToList();
                    }
                    else
        ...
        private void InsertItemType(object InputValue)
        {
            try
            {
                ...
                if (POPUPEntityObject != null) //Application:New Record Only.Condition: Only enter in the code block if EntityObject is Not null and not assigning same value again if event fire twice.
                {
                    ...
                    if (POPUPEntityObject.ItemTypeCd != "All")
                    {
                        var myItem = (from o in MC.SubItemTypeList
        ...
        private void CollectionChanged(object DataList)
        {
            ...
            try
            {
                ...
                {
                    List<MM_S010_A> SelectedRowlist = list.Cast<MM_S010_A>().ToList();
        ...
        private void GetselectedSkuParameter(Object InputList)
        {
            ...
            try
            {
                ...
                {
                    List<MM_S010_A> selectedlist = list.Cast<MM_S010_A>().ToList();
                    ...
                    if (dgSelectedIndexItem != -1)
                    {
                        ...
                        else if (dgSelectedIndexItem >= 0 && ItemsEntity.Count > dgSelectedIndexItem) //Update Row: If Old or Blank row get added, then Edit Rule will applicable in this Loop.
                        {
                            if (ItemsEntity[dgSelectedIndexItem].id == 0 && ((IndexOfExistValue == -1) || (IndexOfExistValue != -1 && AllowDuplicate == true))) // It will allowe to add unique value or Duplicate value if AllowDuplicate Status == True
                            {
                                ...
                                ItemsEntity[dgSelectedIndexItem].unit_code = MasterEntity.unit_code;
        ...
        private void LoadDocumentByDocumentNumber(object ParameterObject)
        {
            ...
            else if (ParameterObject != null)
            {
                if (((IEnumerable)ParameterObject).Cast<MM_S010_BackFlip>().ToList().Count > 0)
                {
                    ...
                    MCTemp1 = repository_MCTemp1.GetDataWithReturnDomainObject<MultipleContext_MM_S010>(MCTemp1, RequestParameterData, "PhysicalStock1", "SCM", "", 0, "");
