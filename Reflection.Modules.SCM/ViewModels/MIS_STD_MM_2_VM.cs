...
{
    // Perodic Stock Statement Reports with Date Range and Filters.
    public class MIS_STD_MM_2_VM : WorkspaceViewModel<MM_T001>
    {
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(MIS_STD_MM_2_VM));
        ...
        #endregion
        public MIS_STD_MM_2_VM(string ts_code) : base()
        {
            ts_code_vm = ts_code;
