...
{
    public class LOG_T001_A_VM_P2P : WorkspaceViewModel<LOG_T001_A>
    {
        ...
        #region . Constructor .
        public LOG_T001_A_VM_P2P(string ts_code)
            : base()
        {
            parameter = false;
        ...
        public LOG_T001_A_VM_P2P(string ts_code,string doc_no)
            : base()
        {
            parameter = false;
            this.ts_code_vm = ts_code;
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                if((from o in StoreLocList where o.location_Id == AppSessionState.location_Id //&& o.default_storage_loc == Convert.ToBoolean(1)
        ...
        private void GetSelectedDeliveryNote(IList DeliveryNote)
        {
            try
            {
                ...
                if (GetSelectedDeliveryNoteTemp.Count > 0)
                {
                    ...
                    if (SelectedLOG_T001_A.t_status == "011" || SelectedLOG_T001_A.t_status == "011")
                    {
                        post = false;
                    }
                ...
                if (Convert.ToString(items) == SelectedLOG_T001_A.order_no)
                {
                    ...
                    else
                    {
                        ...
                        {        
                            ...
                            if (MCTemp.OrderDataList[0].supplying_plant != null)
                            {
                ...
                if (ItemDetails != null)
                {
                    ...
                    else if (dgSelectedIndex >= 0 && Del_Note_Dtails.Count > dgSelectedIndex && ItemDetails.Select == true) //Update Row: If Old or Blank row get added, then Edit Rule will applicable in this Loop.
                    {
                        if (Del_Note_Dtails[dgSelectedIndex].ItemCode == null && ((IndexOfExistValue == -1) || (IndexOfExistValue != -1 && AllowDuplicate == true))) // It will allowe to add unique value or Duplicate value if AllowDuplicate Status == True
                        {
                            ...
                            Del_Note_Dtails[dgSelectedIndex].ref_doc_item_code = ItemDetails.ItemCode;
                            Del_Note_Dtails[dgSelectedIndex].ref_doc_type = ItemDetails.ref_doc_type;
        ...
        private void RemoveRefDoc()
        {
            try
            {
                ...
                var msg = new NotificationMessage("LOG_T001_A_VM_P2P");
        ...
        protected override void OnPrintAction(InquiryActionResult<LOG_T001_A> result)
        {
            try
            {
                if (post == false)
                {
                    string Request = "DN_Report" + "!@" + SelectedLOG_T001_A.delivery_no;//+ "!@" + AppSessionState.Name;
                    MCTemp = repositoryM.GetDataWithReturnDomainObject<MultipleContext_LOG_T001_A>(MCTemp, "LOG_T001_A_Data", "DeliveryNote", "SCM", "LoadAll", 0, Request);
