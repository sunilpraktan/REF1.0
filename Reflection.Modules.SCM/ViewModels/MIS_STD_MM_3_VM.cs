...
{
    // Financial Year and Posting Period related Stock Statement Reports with Filters. No Date Range.
    public class MIS_STD_MM_3_VM : WorkspaceViewModel<MM_T001>
    {
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(MIS_STD_MM_3_VM));
        ...
        #endregion
        public MIS_STD_MM_3_VM(string ts_code) : base()
        {
            ts_code_vm = ts_code;
        ...
        private void LoadInitialData()
        {
            try
            {
                string Request = "LoadInitialData" + "!@" + AppSessionState.client.ToString() + "!@" + AppSessionState.comp_code.ToString() + "!@" + AppSessionState.location_Id + "!@" + ts_code_vm;
                MC = repository_MC.GetDataWithReturnDomainObject<STD_MIS_MC_BE>(MC, Request, "MIS_STD_MM_3", "SCM", " ", 0, "");
                ...
                AS_REPORT = new AutoSuggestTextViewModel<dynamic>(MC.REPORT_LIST, TheFilter, SuggestedValue, "view_code", true);
            ...
            try
            {
                ...
                else
                {
                    if (REQ_PARA_OBJ != null)
                    {
                        ...
                        MIS_T001_OBJ = MC.REPORT_LIST.Where(x => x.view_code == REQ_PARA_OBJ.view_code && x.ts_code == REQ_PARA_OBJ.ts_code).ToList()[0];
                        string RequestParameter = "Report" + "!@" + AppSessionState.client + "!@" + REQ_PARA_OBJ.comp_code + "!@" + REQ_PARA_OBJ.location_id + "!@" + MIS_T001_OBJ.sql_code + "!@" + REQ_PARA_OBJ.item_cat + "!@" + REQ_PARA_OBJ.item_subcat + "!@" + REQ_PARA_OBJ.item_type + "!@" + REQ_PARA_OBJ.item_subtype + "!@" + REQ_PARA_OBJ.ts_code + "!@" + REQ_PARA_OBJ.color_code + "!@" + REQ_PARA_OBJ.color_code + "!@" + REQ_PARA_OBJ.color_code + "!@" + REQ_PARA_OBJ.item_code + "!@" + REQ_PARA_OBJ.color_code + "!@" + REQ_PARA_OBJ.color_code + "!@" + REQ_PARA_OBJ.fin_year + "!@" + REQ_PARA_OBJ.posting_period + "!@" + REQ_PARA_OBJ.store_code + "!@" + REQ_PARA_OBJ.unit_code;
                        MC_TEMP = repository_MC.GetDataWithReturnDomainObject<STD_MC_BE>(MC_TEMP, RequestParameter, "MIS_STD_MM_3", "SCM", " ", 0, "");
                        ...
                        ReportManager.DisplayReport(objDataSource, objDataSourceName, MIS_T001_OBJ.obj_path + MIS_T001_OBJ.obj_file, getParametersList(), "");
                    }
                    else
                    {
                        IShowMessageViewService sms = this.GetViewService<IShowMessageViewService>();
        ...
        private Dictionary<string, string> getParametersList()
        {
            ...
            try
            {
                result.Add("from_date", Convert.ToString(REQ_PARA_OBJ.from_date ?? DateTime.Now));
                result.Add("to_date", Convert.ToString(REQ_PARA_OBJ.to_date ?? DateTime.Now));
                ...
                result.Add("para1", Convert.ToString(REQ_PARA_OBJ.para1));
            }
            catch (Exception ex)
            {
                IShowMessageViewService sms = this.GetViewService<IShowMessageViewService>();
        ...
        private void UpdateClosingStock(object obj)
        {
            ...
            {
                CursorControl.SetBusyState();
                string RequestParameter = "UpdateClosing" + "!@" + AppSessionState.client + "!@" + REQ_PARA_OBJ.comp_code + "!@" + REQ_PARA_OBJ.location_id + "!@" + REQ_PARA_OBJ.rpt_code + "!@" + REQ_PARA_OBJ.item_cat + "!@" + REQ_PARA_OBJ.item_subcat + "!@" + REQ_PARA_OBJ.item_type + "!@" + REQ_PARA_OBJ.item_subtype + "!@" + REQ_PARA_OBJ.ts_code + "!@" + REQ_PARA_OBJ.color_code + "!@" + REQ_PARA_OBJ.color_code + "!@" + REQ_PARA_OBJ.color_code + "!@" + REQ_PARA_OBJ.item_code + "!@" + REQ_PARA_OBJ.color_code + "!@" + REQ_PARA_OBJ.color_code + "!@" + REQ_PARA_OBJ.fin_year + "!@" + REQ_PARA_OBJ.posting_period + "!@" + REQ_PARA_OBJ.store_code + "!@" + REQ_PARA_OBJ.unit_code;
                MC_TEMP = repository_MC.GetDataWithReturnDomainObject<STD_MC_BE>(MC_TEMP, RequestParameter, "MIS_STD_MM_3", "SCM", " ", 0, "");
