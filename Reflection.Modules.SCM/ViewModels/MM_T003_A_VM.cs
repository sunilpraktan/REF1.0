...
{
    public class MM_T003_A_VM : WorkspaceViewModel<MM_T003>
    {
        ...
        //WebServiceRepository<MM_T003> repository = new WebServiceRepository<MM_T003>();
        ...
        //    }
        //}
        //private MM_T003 _ObjectMM_T003;
        //public MM_T003 ObjectMM_T003
        //{
        //    get
        //    {
        ...
        #region Constructor
        public MM_T003_A_VM(string ts_code) : base()
        {
        ...
        public MM_T003_A_VM(string ts_code, string doc_no) : base()
        {
            //this.ts_code_vm = ts_code;
        ...
        //        MasterEntity.doc_cat = "IO";
        //        //MasterEntity.doc_type = "IO";
        //        string Request = "LoadInitialData" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id.ToString() + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat + "!@" + AppSessionState.client;
        //        MC = repository_MC.GetDataWithReturnDomainObject<MultipleContext_MM_T003>(MC, Request, "IndentOrder", "SCM", "LoadAll", 0, "");
        ...
        //        MCTemp = repository_MCTemp.GetDataWithReturnDomainObject<MultipleContext_PUR_T002_A>(MCTemp, Request, "IndentOrder", "SCM", "LoadAll", 0, "");
        ...
        //                isNewRecord = false;
        //                MCTemp = repository_MCTemp.GetDataWithReturnDomainObject<MultipleContext_MM_T003>(MCTemp, Request, "IndentOrder", "SCM", "", 0, Request);
        ...
        //        var msg = new NotificationMessage("MM_T003_A_VM");
        //        Messenger.Default.Send<NotificationMessage>(msg);
        //    }
        //    catch (Exception ex)
        //    {
        ...
        //            item.doc_cat = "IO";
        //            item.doc_type = "IO";
        //            item.location_Id = MasterEntity.location_Id ?? AppSessionState.location_Id;
        ...
        //    try
        //    {
        //        if (MasterEntity.t_status == "011" || MasterEntity.t_status == "011")
        //        {
        //            string reader = repositoryStr.Update<string>(MasterEntity.req_no, "IndentOrderUpdateStatus", "SCM");
        ...
        //        {
        //            if (MasterEntity.t_status == "016" || MasterEntity.t_status == "001")
        //            {
        //                string Request = MasterEntity.req_no + "!@" + "Close Indent";
        //                string reader = repositoryStr.Update<string>(Request, "IndentOrderUpdateStatus", "SCM");
        //                int intreader = Convert.ToInt32(reader);
        //                if (intreader >= 0)
        //                {
        //                    IShowMessageViewService showMessageService = this.GetViewService<IShowMessageViewService>();
        ...
        protected override void OnPrintAction(InquiryActionResult<MM_T003> result)
        {
            ...
            try
            {
                ...
                //MCTemp = repository_MCTemp.GetDataWithReturnDomainObject<MultipleContext_MM_T003>(MCTemp, Request, "IndentOrder", "SCM", "LoadDocumentWithDocumentNumber", 0, "");
        ...
        protected override void OnRemoveAction(InquiryActionResult<MM_T003> result)
        {
            try
            {
                ...
                if (showMessageService.ShowMessage() == DialogResult.Ok)
                {
                    ...
                    //string response = repository.Delete(MasterEntity.req_no, "IndentOrder", "SCM");
                    //MasterEntity = new MM_T003();
                    //ItemsEntity = new ObservableCollection<MM_T003_A>();
        ...
        protected override void OnSaveAction(InquiryActionResult<MM_T003> result)
        {
            try
            {
                ...
                //    if (isNewRecord == true)
                //    {
                //        MasterEntity = repository.SaveWithReturnDomainObject<MM_T003>(MasterEntity, "IndentOrder", "SCM");
                ...
                //    {
                //        MasterEntity = repository.UpdateWithReturnDomainObject<MM_T003>(MasterEntity, "IndentOrder", "SCM");
                //        if (MasterEntity.req_no != " " || MasterEntity.req_no != null)
                //        {
                //            IShowMessageViewService showMessageService = this.GetViewService<IShowMessageViewService>();
                //            showMessageService.ButtonSetup = DialogButton.Ok;
