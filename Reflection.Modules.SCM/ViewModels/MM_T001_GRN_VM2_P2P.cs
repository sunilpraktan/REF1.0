...
{
    class MM_T001_GRN_VM2_P2P : WorkspaceViewModel<MM_T001>
    {
        #region AutoSuggest TextBox Region
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(MM_T001_GRN_VM2_P2P));
        ...
        #region . Constructor .
        public MM_T001_GRN_VM2_P2P(string ts_code)
                : base()
        {
        ...
        public MM_T001_GRN_VM2_P2P(string ts_code, string doc_no)
                : base()
        {
            this.ts_code_vm = ts_code;
            ...
            try
            {
                ...
                if (MasterEntity.source_doc_no != null || MasterEntity.source_doc_no != "")
                {
                    if (MasterEntity.source_doc_no == InputValue.ToString())
                    {
                        ...
                        string RequestParameterData = "OrderLoad" + "!@" + InputValue.ToString();
                ...
                if (e.Action == NotifyCollectionChangedAction.Add && ItemDetailsEntity.Count > 0) // Schedule can only enable to add if items exists in Items Entity.
                {
                    foreach (MM_T001_B item in e.NewItems)
                    {
                        ...
                        if (dgSelectedIndexItem <= ItemDetailsEntity.Count)
                        {
                            ...
                            item.location_Id = MasterEntity.rec_plant;
        ...
        private void CalculateSku()
        {
            try
            {
                ...
                if (ItemDetailsEntity[dgSelectedIndexItem].sku == null || ItemDetailsEntity[dgSelectedIndexItem].sku == "")
                {
                    for (int i = 0; i < SelectedParaValueCollection.Count; i++)
                    {
        ...
        protected override void OnRemoveAction(InquiryActionResult<MM_T001> result)
        {
            ...
            if (showMessageService.ShowMessage() == DialogResult.Ok)
            {
                ...
                MasterEntity.rec_plant = AppSessionState.location_Id;
                NewRecord = true;
                parameter = false; RefDocLoad = true; MoveFlag = true; TotalQty = 0;
            }
        }
        ...
        protected override void OnPrintAction(InquiryActionResult<MM_T001> result)
        {
            ...
            else
            {
                ...
                ReportManager.DisplayReport(objDataSource, objDataSourceName, "\\SCM\\GRN_P2P2.rdlc", "GRN_P2P");
