...
{
    class MIS_SCM_Report1_VM : WorkspaceViewModel<ReportParameters>
    {
        ...
        #region Constructor
        public MIS_SCM_Report1_VM(string ts_code)
            : base()
        {
            ...
            //ReportItemsDictionary.Add("R003", "Goods Receipt Note");
            //ReportItemsDictionary.Add("R004", "Single Stock Item Report");
            //ReportItemsDictionary.Add("R005", "Stock Summary Report");
            ReportItemsDictionary.Add("R006", "Consumption Report(Material Issue)");
            ReportItemsDictionary.Add("R007", "Material Receipt");
            //ReportItemsDictionary.Add("R007", "Wire Consumption Report");
            //ReportItemsDictionary.Add("R008", "Item Specification Consumption Report");
            ReportItemsDictionary.Add("R009", "Goods Receipt Note");
            //ReportItemsDictionary.Add("R010", "Store Summary Single Item Report");
            ReportItemsDictionary.Add("R011", "Dispatch Report(Delivery Note)");
            ReportItemsDictionary.Add("R012", "Consumption Report MachineWise");
            ReportItemsDictionary.Add("R013", "Consumption Report ItemWise");
            //ReportItemsDictionary.Add("R014", "Consumption Report Against Sales Order");
            ReportItemsDictionary.Add("R015", "Date Wise Machine Consumption");
            ReportItemsDictionary.Add("R016", "Date Wise Item Consumption");
            ReportItemsDictionary.Add("R017", "Goods Receipt Note Batch Wise");
            ReportItemsDictionary.Add("R018", "Consumption Report Batch Wise(Material Issue)");
        ...
        private void LoadInitialData()
        {
            ...
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<MultipleContext_MIS_SCM_Report1>(MC, Request, "MIS_SCM_Reports", "SCM", "LoadAll", 0, "");
        ...
        private void DisplayReport()
        {
            ...
            try
            {
                ...
                if (ReportParametersEntity.ReportCode != null)
                {
                    ...
                    //dsReport = repository.GetDataWithReturnDomainObject<List<MIS_SCM_ReportEntity>>(dsReport, RequestParameter, "MIS_SCM_Reports", "SCM", "", 0, "");

                    dsReport = repository.GetDataWithReturnDomainObject<List<MIS_SCM_ReportEntity>>(dsReport, RequestParameter, "MIS_SCM_Reports", "SCM", "", 0, RequestParameter);
        ...
        private string GetReportFile(string ReportCode)
        {
            ...
            //if (ReportCode == "R002")
            //{ returnReportName = "MaterialReceipt.rdlc"; }
            //else if (ReportCode == "R003")
            //{ returnReportName = "GoodsReceiptNote.rdlc"; }
            //if (ReportCode == "R004")
            //{ returnReportName = "SingleStockItem.rdlc"; }
            //else if (ReportCode == "R005")
            //{ returnReportName = ".rdlc"; }
            if (ReportCode == "R006")
            { returnReportName = "ConsumptionRpt.rdlc"; }
            //else if (ReportCode == "R007")
            //{ returnReportName = ".rdlc"; }
            else if (ReportCode == "R008")
            { returnReportName = "StockStatement.rdlc"; }
            ...
            { returnReportName = "DispatchReport.rdlc"; }
            ...
            { returnReportName = "ConsumptionReportAgainstSo.rdlc.rdlc"; }
            ...
            { returnReportName = "GoodsReceiptNoteBatch.rdlc"; }
