...
{
    class MM_T001_MR_VM2 : WorkspaceViewModel<MM_T001>
    {
...
#pragma warning disable CS0108 // Member hides inherited member; missing new keyword
        ...
        #region . Constructor .
        public MM_T001_MR_VM2(string ts_code)
            : base()
        {
            parameter = false;
        ...
        public MM_T001_MR_VM2(string ts_code,string doc_no)
            : base()
        {
            parameter = false;
            this.ts_code_vm = ts_code;
            ...
            try
            {
              ...
              (cmdPara => { if (cmdPara == null) { return; } InsertDataGridRow_StoreLocation(cmdPara, false, true, true); });
               ...
               (cmdPara => { if (cmdPara == null) { return; } InsertDataGridRow_Batch(cmdPara, false, true, true); });
                ...
                items => { if (items == null) { return; } batchSelection(items); });


                SelectionChangedCommandLoadIssueDetails = new RelayCommand<object>(
                 items => { if (items == null) { return; } LoadIssueDetails(items); });
               ...
               items => { if (items == null) { return; } DeleteDataGridRow_ItemBatch(items); });

                CommandLoadDocumentByByDocumentNumber = new RelayCommand<object>
               (cmdPara => { if (cmdPara == null) { return; } LoadDocumentByDocumentNumber(cmdPara); });
             ...
             (cmdPara => { if (cmdPara == null) { return; } InsertDataGridRow_MachineCode(cmdPara, false, true, true); });
                ...
                batchCollection = CollectionViewSource.GetDefaultView(MC.batchList);
                batchCollection.Filter = new Predicate<object>(Filterbatch);
                stringListBatch = MC.batchList.Select(x => x.batch_no).ToList();
                DefaultValues();
                ...
                foreach (var o in GoodsIssueDetails)
                {
                    if (o.ItemCode != null && o.ItemCode != "" && o.description != null)
                    {
                        ...
                        if (o.para1 == null || o.para1 == "")
                        {
                            ...
                            showMessageService.ButtonSetup = DialogButton.Ok;
                            showMessageService.Caption = "Message";
                            showMessageService.Text = String.Format("Please Enter Make for the item {0} and Parameter {1} At Index {2}", o.ItemCode, o.sku_desc, GoodsIssueDetails.IndexOf(o));
                            showMessageService.ShowMessage();
                            return false;
                        }
                        if (o.para2 == null || o.para2 == "")
                        {
                            ...
                            showMessageService.ButtonSetup = DialogButton.Ok;
                            showMessageService.Caption = "Message";
                            showMessageService.Text = String.Format("Please Enter Type for the item {0} and Parameter {1} At Index {2}", o.ItemCode, o.sku_desc, GoodsIssueDetails.IndexOf(o));
                            showMessageService.ShowMessage();
                            return false;
                        }
                        if (o.mat_con == null || o.mat_con == "")
                        {
                            ...
                            showMessageService.ButtonSetup = DialogButton.Ok;
                            showMessageService.Caption = "Message";
                            showMessageService.Text = String.Format("Please Enter Material Condition for the item {0} and Parameter {1} At Index {2}", o.ItemCode, o.sku_desc, GoodsIssueDetails.IndexOf(o));
                            showMessageService.ShowMessage();
                            return false;
                        }
                    }
        ...
        protected override void OnRemoveAction(InquiryActionResult<MM_T001> result)
        {
            ...
            if (showMessageService.ShowMessage() == DialogResult.Ok)
            {
                ...
                dgBatchEntity.Clear();
                NewRecord = true;
                parameter = false; MoveFlag = true; TotalQty = 0;
            }
        }
