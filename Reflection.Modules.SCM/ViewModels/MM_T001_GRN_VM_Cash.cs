...
namespace Reflection.Modules.SCM.ViewModels  // Some Delete is Pending in this View Model. for e.g ref doc no load deleted from form
{
    public class MM_T001_GRN_VM_Cash : WorkspaceViewModel<MM_T001>
    {
        ...
        #region . Constructor .
        public MM_T001_GRN_VM_Cash(string ts_code)
                : base()
            {
    ...
    //        POAllocationEntity = new ObservableCollection<MM_T001_C>();
        ...
        public MM_T001_GRN_VM_Cash(string ts_code,string doc_no)
                : base()
        {
            this.ts_code_vm = ts_code;
        ...
        private void DefaultValues()
        {
            ...
            MasterEntity.mov_tp = "116";
            MasterEntity.mov_name = "Goods Receipt of Cash Purchase";
        ...
        private void LoadInitialData()
        {
            try
            {
                MasterEntity.doc_cat = "GR";
                MasterEntity.doc_type = "GR";
                string Request = "LoadInitialData" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id.ToString() + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat + "!@" + "116" + "!@" + AppSessionState.EmpId + "!@" + AppSessionState.client;
        ...
        private void LoadRecords()
        {
            ...
            else
            {
                ...
                string Request = "LoadRecordsofSelectedDate" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat + "!@" + "116" + "!@" + AppSessionState.EmpId + "!@" + Convert.ToDateTime(MasterEntity.bf_FromDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(MasterEntity.bf_ToDate).ToString("MM/dd/yyyy");
