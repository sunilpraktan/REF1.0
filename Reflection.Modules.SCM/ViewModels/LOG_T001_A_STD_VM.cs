...
{
    public class LOG_T001_A_STD_VM : WorkspaceViewModel<LOG_T001_A>
    {
        #region . Declaration .
        ...
        public RelayCommand ReportCommandBatchList { get; private set; }
        public GalaSoft.MvvmLight.Command.RelayCommand ReportCommandBatchDetails { get; private set; }
        #endregion

        #region . Constructor .
        public LOG_T001_A_STD_VM(string doc_cat, string ts_code) : base()
        {
        ...
        public LOG_T001_A_STD_VM(string doc_cat, string ts_code, string doc_no) : base()
        {
            PrintOptionDictionary = new Dictionary<string, object>();
            PrintOptionDictionary.Add("Original for Recipient", "Original for Recipient");
            PrintOptionDictionary.Add("Duplicate for Supplier/Transporter", "Duplicate for Supplier/Transporter");
        ...
        public LOG_T001_A_STD_VM(string doc_cat, string ts_code, string doc_no, string ReferenceDoc) : base()
        {
            PrintOptionDictionary = new Dictionary<string, object>();
            PrintOptionDictionary.Add("Original for Recipient", "Original for Recipient");
            PrintOptionDictionary.Add("Duplicate for Supplier/Transporter", "Duplicate for Supplier/Transporter");
        ...
        private void DefaultValues(string doc_cat_info)
        {
            try
            {
                ...
                {
                    MasterEntity.PartyId = MasterEntity.rec_plant; // we have to set this values as it is compulsory and in future we will have to add plant as party and assign plant to that party to process P2P transfer process.
        ...
        private void CommandInitialization()
        {
            ...
            ReportCommandBatchList = new RelayCommand(() => { BatchListReport(); });
            ReportCommandBatchDetails = new GalaSoft.MvvmLight.Command.RelayCommand(() => { BatchDetailsReport(); });
            #endregion
        }
        private void LoadInitialData(string doc_cat_info, string ReferenceDoc)
        {
            try
            {
                ...
                if (doc_cat_info == "DT" && ReferenceDoc == null)
                {
                    ...
                    MC = repositoryM.GetDataWithReturnDomainObject<MultipleContext_LOG_T001_A>(MC, "LOG_T001_A_Data", "DeliveryNoteSTD", "SCM", "LoadAll", 0, Request);
                }
                else if (doc_cat_info == "DN" && ReferenceDoc == null)
                {
                    string Request = "LoadInitialData" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + this.doc_cat_vm + "!@" + doc_cat_vm + "!@!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + this.ts_code_vm + "!@" + AppSessionState.so_code + "!@" + AppSessionState.sg_code;
                    //string Request = "LoadInitialData" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + MasterEntity.doc_type + "!@" + doc_cat_vm
                ...
                {
                    string Request = "LoadInitialDataWith_DN_From_Dispatch_Order" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + this.doc_cat_vm + "!@" + doc_cat_vm + "!@" + this.doc_no_vm + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + this.ts_code_vm + "!@" + AppSessionState.so_code + "!@" + AppSessionState.sg_code;
                    //string Request = "LoadInitialDataWith_DN_From_Dispatch_Order" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + MasterEntity.doc_type + "!@" + doc_cat_vm
                ...
                MC.ReserveDateList = MC.ReserveDateList;
        ...
        private void LoadDocumentFromDocumentNumber(object InputValue)
        {
            try
            {
                ...
                {
                    Request = "LoadDocumentFromDocumentNumber" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + this.doc_cat_vm + "!@" + doc_cat_vm + "!@" + Request + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + this.ts_code_vm + "!@" + AppSessionState.so_code + "!@" + AppSessionState.sg_code;
                    ...
                    MCTemp = repositoryM.GetDataWithReturnDomainObject<MultipleContext_LOG_T001_A>(MCTemp, "", "DeliveryNoteSTD", "SCM", "LoadDocumentFromDocumentNumber", 0, Request);
        ...
        private void Export_To_JSON_FILE()
        {
            try
            {
                ...
                string Request = "JSON_EXPORT_DN" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + MasterEntity.doc_cat + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.delivery_no + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + this.ts_code_vm + "!@" + AppSessionState.so_code + "!@" + AppSessionState.sg_code;
                ...
                if (TabIndexValue == 1 && EntityChangeEnable == true)
                {
                    if (SelectedItemsEntity != null)
                    {
                        ...
                        if (ServerTripRequired == true  && !string.IsNullOrWhiteSpace(SelectedItemsEntity.store_code) && !string.IsNullOrWhiteSpace(SelectedItemsEntity.ItemCode))
                        {
                            ...
                            MCTemp = repositoryM.GetDataWithReturnDomainObject<MultipleContext_LOG_T001_A>(MCTemp, "", "DeliveryNoteSTD", "SCM", "LoadHandlingUnits", 0, Request);
        ...
        private void ExecuteReferenceDocument(object items)
        {
            try
            {
                EntityChangeEnable = true;
                ...
                {
                    // string company = AppSessionState.comp_code.ToString() + "!@" + AppSessionState.location_Id.ToString() + "!@" + doc_type_Order + "!@" + MasterEntity.order_no;
                    string Request = "ExecuteReferenceDocument" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + this.doc_cat_vm + "!@" + this.doc_cat_vm + "!@" + RequestPara.doc_no + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + this.ts_code_vm + "!@" + items;
                    //string Request = "ExecuteReferenceDocument" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + items + "!@" + RequestPara.doc_no + "!@" + AppSessionState.EmpId;

                    MCTemp = repositoryM.GetDataWithReturnDomainObject<MultipleContext_LOG_T001_A>(MCTemp, "LOG_T001_A_Data", "DeliveryNoteSTD", "SCM", "ExecuteReferenceDocument", 0, Request);
        ...
        private void PackingListReport()
        {
            ...
            try
            {
                if (post == false)
                {
                    string Request = "DN_PackingList" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + this.doc_cat_vm + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.delivery_no + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@!@!@" + MasterEntity.ref_doc_cat;
        ...
        private void BatchListReport()
        {
            try
            {
                ...
                if (post == false)
                {
                    string Request = "DN_BatchList" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + this.doc_cat_vm + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.delivery_no + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@!@!@" + MasterEntity.ref_doc_cat;
                    //string Request = "DN_PackingList" + "!@" + MasterEntity.ref_doc_cat + "!@" + MasterEntity.delivery_no;
                    MCTemp = repositoryM.GetDataWithReturnDomainObject<MultipleContext_LOG_T001_A>(MCTemp, "LOG_T001_A_Data", "DeliveryNoteSTD", "SCM", "LoadAll", 0, Request);
                    ...
                    objDataSource[2] = MCTemp.Batch_List;

                    objDataSourceName[0] = "dsCompany";
                    objDataSourceName[1] = "dsLocation";
                    objDataSourceName[2] = "dsMIS_1";


                    ReportManager ReportManager = new ReportManager();
                    ReportManager.DisplayReport(objDataSource, objDataSourceName, "\\REPORTS_STD\\TXN\\DN_D003.rdlc", "PackingList");
                }
                else
                {
                    IShowMessageViewService showMessageService = this.GetViewService<IShowMessageViewService>();
        ...
        private void BatchDetailsReport()
        {
            try
            {
                CursorControl.SetBusyState();
                ...
                if (post == false)
                {
                    Request = "LoadDocumentFromDocumentNumber" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + this.doc_cat_vm + "!@" + doc_cat_vm + "!@" + MasterEntity.delivery_no + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + this.ts_code_vm + "!@" + AppSessionState.so_code + "!@" + AppSessionState.sg_code;
                    string ReportName = "DeliveryNoteBatchDetails.rdlc";
                    MCTemp = repositoryM.GetDataWithReturnDomainObject<MultipleContext_LOG_T001_A>(MCTemp, "", "DeliveryNoteSTD", "SCM", "LoadDocumentFromDocumentNumber", 0, Request);
                    ...
                    objDataSource[2] = MCTemp.Delivery_Note;
                    objDataSource[3] = MCTemp.DelNoteItemDetails;
                    objDataSource[4] = MCTemp.ItemBatchDetails;


                    objDataSourceName[0] = "dsCompany";
                    objDataSourceName[1] = "dsLocation";
                    objDataSourceName[2] = "dsLOG_Master";
                    objDataSourceName[3] = "dsItemList";
                    objDataSourceName[4] = "dsBatchList";


                    ReportManager ReportManager = new ReportManager();
                    ReportManager.DisplayReport(objDataSource, objDataSourceName, "\\Label\\" + ReportName, "Batch Details");
                }
                else
                {
                    IShowMessageViewService showMessageService = this.GetViewService<IShowMessageViewService>();
        ...
        private void LoadBackFlipData()
        {
            try
            {
                EntityChangeEnable = false;
                CursorControl.SetBusyState();
                string Request = "Load_BackFlip_Data" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + this.doc_cat_vm + "!@" + RequestPara.para1 + "!@!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + this.ts_code_vm + "!@" + AppSessionState.sg_code + "!@" + AppSessionState.sg_code + "!@" + RequestPara.PartyId + "!@!@" + RequestPara.active + "!@" + RequestPara.t_status + "!@" + Convert.ToDateTime(RequestPara.FromDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(RequestPara.ToDate).ToString("MM/dd/yyyy");
                //string Request = "Load_BackFlip_Data" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + RequestPara.location_id + "!@" + Convert.ToDateTime(RequestPara.FromDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(RequestPara.ToDate).ToString("MM/dd/yyyy") + "!@" + RequestPara.t_status + "!@" + RequestPara.active + "!@" + doc_cat_vm + "!@" + RequestPara.PartyId + "!@" + RequestPara.emp_id + "!@" + RequestPara.para1; // para1 as delivery_type
                MCTemp = repositoryM.GetDataWithReturnDomainObject<MultipleContext_LOG_T001_A>(MCTemp, "LOG_T001_A_Data", "DeliveryNoteSTD", "SCM", "LoadAll", 0, Request);
            ...
            try
            {
                ...
                if (POPUPEntityObject != null)
                {
                    if (POPUPEntityObject.t_status != "009")
                    {
                        ...
                        if (MasterEntity.ref_doc_cat == "TO")
                        {
                            ...
                            foreach (var item in refdocTOM)
                            {
                                if (item.Select == true)
                                {
                                    RequestPara.doc_no = RequestPara.doc_no + "," + item.order_no;
                                }
                            }
        ...
        private void ReferenceSelection(object InputValue) // NOTE: make this function common for all reference button by sending parameter for difference collection and remove "AddSelectedRef". 
        {
            try
            {
                ...
                if (POPUPEntityObject != null)
                {
                    ...
                    {
                        List<OrderItemData> refdocTOR = (from o in MC.OrderItems where o.doc_cat == "TO" && o.Select == true select o).ToList();
                        if (refdocTOR.Count == 0)
                        {
                            List<OrderItemData> refdocTOL = (from o in MC.OrderItems where o.doc_cat == "TO" select o).ToList();
                            ReferenceDoc_TO_Item_Collection = CollectionViewSource.GetDefaultView(refdocTOL);
                            ReferenceDoc_TO_Item_Collection.Filter = new Predicate<object>(Filter_ReferenceItem);
                        }
                    }
                    List<OrderItemData> refdocTOM = (from o in MC.OrderItems where o.doc_cat == "TO" && o.Select == true select o).ToList();
                    foreach (var item in refdocTOM)
                    {
                        if (item.Select == true)
                        {
                            RequestPara.doc_no = RequestPara.doc_no + "," + item.sch_item_row_id.ToString();
                        }
                    }
                    RequestPara.doc_no = RequestPara.doc_no.ToString().TrimStart(new char[] { ',' });
                }
        ...
        private bool Validation()
        {
            ...
            if (RequestPara.doc_no != null && RequestPara.doc_no == "" && MasterEntity.doc_cat != "DT" && (MasterEntity.del_address == null || MasterEntity.del_address == 0))
            {
                IShowMessageViewService showMessageService = this.GetViewService<IShowMessageViewService>();
                showMessageService.ButtonSetup = DialogButton.Ok;
                showMessageService.Caption = "Validation";
            ...
            foreach (var o in ItemsEntity)
            {
                ...
                if (o.id == 0 && o.active == true)
                {
                    ...
                    try
                    {
                        SL_OBJ = MC.RESERVATION_LIST.Where(x => x.item_code.Equals(o.ItemCode, StringComparison.OrdinalIgnoreCase) == true && x.order_no.Equals(o.order_no, StringComparison.OrdinalIgnoreCase) == false).ToList()[0];
                    }
                    catch (Exception ex) { }
        ...
        protected override void OnSaveAction(InquiryActionResult<LOG_T001_A> result)
        {
            try
            {
                ...
                if (Validation() == true)// && (MasterEntity.t_status != "011" && MasterEntity.t_status != "011" && MasterEntity.t_status != "003"))
                {
                    ObjectSerializationService objSer = new ObjectSerializationService();
                    ...
                    if (blNew == true)
                    {
                        MasterEntity = repository.SaveWithReturnDomainObject<LOG_T001_A>(MasterEntity, "DeliveryNoteSTD", "SCM");
                    ...
                    {
                        MasterEntity = repository.UpdateWithReturnDomainObject<LOG_T001_A>(MasterEntity, "DeliveryNoteSTD", "SCM");
                    }
        ...
        private void RemoveRefDoc()
        {
            try
            {
                if (MasterEntity.order_no != null)
                {
                    ...
                    {
                        MC.OrderList.RemoveAll(X => RequestPara.doc_no.Contains(X.order_no));
                    }
                    ...
                    refdoctempa = (from o in MC.OrderList where (o.doc_cat == "SO" || o.doc_cat == "SR") select o).ToList();
        ...
        protected override void OnFlipAction(InquiryActionResult<LOG_T001_A> result)
        {
            ...
            {
                CursorControl.SetBusyState();
                string Request = "RefreshBatchCollection" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + this.doc_cat_vm + "!@" + RequestPara.para1 + "!@!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + this.ts_code_vm + "!@" + AppSessionState.sg_code + "!@" + AppSessionState.sg_code + "!@" + RequestPara.PartyId + "!@!@" + RequestPara.active + "!@" + RequestPara.t_status + "!@" + Convert.ToDateTime(RequestPara.FromDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(RequestPara.ToDate).ToString("MM/dd/yyyy");
                //string Request = "RefreshBatchCollection" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id.ToString() + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat;

                MCRefresh = repositoryM.GetDataWithReturnDomainObject<MultipleContext_LOG_T001_A>(MC, "LOG_T001_A_Data", "DeliveryNoteSTD", "SCM", "LoadAll", 0, Request);
        ...
        protected override void OnPrintAction(InquiryActionResult<LOG_T001_A> result)
        {
            try
            {
                ...
                {
                    string ReportName = "";
                    string Request = "DN_Report" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + this.doc_cat_vm + "!@" + this.doc_cat_vm + "!@" + MasterEntity.delivery_no;
