...
{
    public class MM_T001_GRN_Service_VM : WorkspaceViewModel<MM_T001>
    {
        ...
        private List<COM_T003> _AttachmentList;
        public List<COM_T003> AttachmentList
        {
        ...
        private void CollectionChangedNotifyForItem(object sender, NotifyCollectionChangedEventArgs e)
        {
            try
            {
                ...
                if (e.OldItems != null && e.OldItems.Count != 0)
                    foreach (MM_T001_A item in e.OldItems)
                        item.PropertyChanged -= this.EntityViewModelPropertyChanged;
                ...
                if (e.Action == NotifyCollectionChangedAction.Add && ItemDetailsEntity.Count > 0) // Schedule can only enable to add if items exists in Items Entity.
                {
                    foreach (MM_T001_A item in e.NewItems)
                    {
                        ...
                        if (MasterEntity.source_doc_type == "SO")
                        {
                            item.sono = MasterEntity.source_doc_no;
                            MasterEntity.sono = MasterEntity.source_doc_no;
                        }
                        item.line_id = ItemDetailsEntity.Count;
        ...
        #region . Constructor .
        public MM_T001_GRN_Service_VM(string ts_code) : base()
        {
        ...
        public MM_T001_GRN_Service_VM(string ts_code,string doc_no) : base()
        {
        ...
        private void DefaultValues()
        {
            ...
            MasterEntity.mov_tp = "129";
            MasterEntity.mov_name = "Goods Reciept for Service Products";
            MasterEntity.source_doc_cat = "SO";
            MasterEntity.source_doc_type = "SO";
        ...
        private void LoadInitialData()
        {
            try
            {
                MasterEntity.doc_cat = "GR";
                MasterEntity.doc_type = "GR";
                string Request = "LoadInitialData" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat + "!@" + "129" + "!@" + AppSessionState.EmpId + "!@" + AppSessionState.client;
                ...
                if (MasterEntity.source_doc_no != null || MasterEntity.source_doc_no != "")
                {
                    if (MasterEntity.source_doc_no == InputValue.ToString())
                    {
                        ...
                        if (MCTemp.GRNMasterList.Count > 0)
                        {
                            ...
                            //            MasterEntity.tranp_mode = transmodetemp;
                            ...
                            //        }
                            //    }
                            if ((MasterEntity.PartyId == null || MasterEntity.PartyId == "") && (MasterEntity.doc_no == null || MasterEntity.doc_no == ""))
                            {
                                if (MCTemp.GRNMasterList.Count > 0)
                                {
                                    MasterEntity = MCTemp.GRNMasterList[0];
            ...
            try
            {
                ...
                if (ParameterObject != null)
                {
                    if (((IEnumerable)ParameterObject).Cast<MM_T001_FLIP>().ToList().Count > 0)
                    {
                        ...
                        AttachmentList = MC.Attachment;

                        if (MCTemp.Attachment != null)
                        {
                            AttachmentList = MCTemp.Attachment;
                        }
                        else
                        {
        ...
        private void LoadRecords()
        {
            ...
            else
            {
                ...
                string Request = "LoadRecordsofSelectedDate" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat + "!@" + "129" + "!@" + AppSessionState.EmpId + "!@" + Convert.ToDateTime(MasterEntity.bf_FromDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(MasterEntity.bf_ToDate).ToString("MM/dd/yyyy");
        ...
        private void GetSkuDescription()
        {
            try
            {
                if (ItemDetailsEntity[dgSelectedIndexItem].StockUnt == true && (ItemDetailsEntity[dgSelectedIndexItem].sku_desc == null || ItemDetailsEntity[dgSelectedIndexItem].sku_desc == ""))
                {
                    for (int i = 0; i < SelectedParaValueCollection.Count; i++)
                    {
                ...
                foreach (var o in ItemDetailsEntity)
                {
                    ...
                    {    // Item Duplication Validation
                        ...
                        if (flag > 1)
                        {
                            ...
                            showMessageService.ButtonSetup = DialogButton.Ok;
                            showMessageService.Caption = "Message";
                            showMessageService.Text = String.Format("Cannot Save Duplicate Item {0} and Parameter {1} At Index {2}", o.ItemCode, o.description, ItemDetailsEntity.IndexOf(o));
                            showMessageService.ShowMessage();
                            return false;
                        }
                    }
                    ...
                    if (o.ItemCode != null && o.ItemCode != "")
                    {
                        if (o.qty == null || o.qty == 0)
                        {
                            ...
                            showMessageService.ButtonSetup = DialogButton.Ok;
                            showMessageService.Caption = "Message";
                            showMessageService.Text = String.Format("Quantity cannot be null or 0 for item {0} and Parameter {1} At Index {2}", o.ItemCode, o.description, ItemDetailsEntity.IndexOf(o));
                            showMessageService.ShowMessage();
                            return false;
                        }
                        ...
                        if (o.unit_code == null || o.unit_code == "")
                        {
                            ...
                            showMessageService.ButtonSetup = DialogButton.Ok;
                            showMessageService.Caption = "Message";
                            showMessageService.Text = String.Format("Please Enter Valid Unit Code for the item {0} and Parameter {1} At Index {2}", o.ItemCode, o.description, ItemDetailsEntity.IndexOf(o));
                            showMessageService.ShowMessage();
                            return false;
                        }
                    }
        ...
        protected override void OnDocumentAction()
        {
            try
            {
                if (!string.IsNullOrEmpty(MasterEntity.doc_no))
                {
                    ...
                    Messenger.Default.Send<DocumentViewerPayload>(new DocumentViewerPayload() { DocumentNumber = MasterEntity.doc_no.ToString().Replace("/", "--"), DocumentList = MCTemp.Attachment, client = AppSessionState.client, comp_code = (MasterEntity.comp_code ?? AppSessionState.comp_code) });
                }
            }
            catch (Exception ex) { }
        }
