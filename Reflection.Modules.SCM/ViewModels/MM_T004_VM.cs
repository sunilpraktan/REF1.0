...
namespace Reflection.Modules.SCM.ViewModels
{
    ...
    public class MM_T004_VM : WorkspaceViewModel<MM_T004>
    {
            ...
            try
            {
                ...
                else if (ParameterObject != null)
                {
                    if (((IEnumerable)ParameterObject).Cast<MM_T004Flip>().ToList().Count > 0)
                    {
                        ...
                        string RequestParameterData = "LoadDocumentWithReferenceDocumentNumber" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + "GE" + "!@" + "GE" + "!@" + MasterEntity.location_Id;
                    }
                }
                MasterEntity = new MM_T004();
        ...
        protected override void OnPrintAction(InquiryActionResult<MM_T004> result)
        {
            try
            {
                if (MasterEntity.doc_no != null && MasterEntity.doc_no != " ")
                {
                    ...
                    MC = repository_MC.GetDataWithReturnDomainObject<MultipleContext_MM_T004>(MC, Request, "GateEntry", "SCM", "", 0, "LoadDocumentWithReferenceDocumentNumber");
                    ...
                    ReportManager.DisplayReport(objDataSource, objDataSourceName, "\\SCM\\Gate_Entry.rdlc", "");
