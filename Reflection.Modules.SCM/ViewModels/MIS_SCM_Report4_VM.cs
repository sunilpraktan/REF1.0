...
{
    public class MIS_SCM_Report4_VM : WorkspaceViewModel<MIS_SCM_Entity>
    {
        ...
        public RelayCommand<object> cmdStatusChange { get; private set; }
        public RelayCommand<object> CmdAddDepartment { get; private set; }
        #endregion

        #region Constructor
        public MIS_SCM_Report4_VM(string ts_code)
            : base()
        {
            ...
            ItemsDictionary.Add("R001", "GRN Plant To Plant Transfer");
            ItemsDictionary.Add("R002", "Goods receipt Note");
            ItemsDictionary.Add("R003", "GRN Plant To Plant Cash Purchase");
            ItemsDictionary.Add("R004", "Inward Outward Entry");
            ...
            cmdStatusChange = new RelayCommand<object>(items => { if (items == null) { return; } InsertStatus(items); });
        ...
        private void LoadInitialData()
        {
            ...
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<MultipleContextMISReports4>(MC, Request, "MIS_SCM_Report4", "SCM", "LoadAll", 0, "");
        ...
        private void DisplayReport()
        {
            ...
            try
            {
                ...
                if (ReportParameters.ReportCode != null)
                {
                    ...
                    string RequestParameter = "Report" + "!@" + ReportParameters.ReportCode + "!@" + ReportParameters.ItemCode + "!@" + ReportParameters.PartyId + "!@" + ReportParameters.location_Id + "!@" + AppSessionState.comp_code + "!@" + Convert.ToDateTime(ReportParameters.FromDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(ReportParameters.ToDate).ToString("MM/dd/yyyy") + "!@" + ReportParameters.doc_no + "!@" + ReportParameters.doc_cat + "!@" + ReportParameters.EmpId + "!@" + ReportParameters.delivery_type + "!@" + ReportParameters.unit_code + "!@" + ReportParameters.t_status + "!@" + ReportParameters.rec_plant + "!@" + ReportParameters.dept_code;
                    dsReport = repository.GetDataWithReturnDomainObject<List<MIS_SCM_Rpt>>(dsReport, RequestParameter, "MIS_SCM_Report4", "SCM", "", 0, RequestParameter);
        ...
        private string GetReportFile(string ReportCode)
        {
            ...
            if (ReportCode == "R001")
            {
                returnReportName = "GRNP2P.rdlc";
            }
            else if (ReportCode == "R002")
            {
                returnReportName = "P2PCashPurchase.rdlc";
            }
            ...
            {
                returnReportName = "InwardOutward.rdlc";
            }
        ...
        private void InsertStatus(object InputValue)
        {
            ...
            //ReportParameters.t = stringStatusNm.ToString().TrimStart(new char[] { ',' });
