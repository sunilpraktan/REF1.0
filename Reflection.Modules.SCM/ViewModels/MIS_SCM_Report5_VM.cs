...
{
    public class MIS_SCM_Report5_VM : WorkspaceViewModel<MIS_SCM_Entity>
    {
        ...
        #region Constructor
        public MIS_SCM_Report5_VM(string ts_code)
            : base()
        {
            ...
            ItemsDictionary.Add("R001", "Opening Stock");
            ItemsDictionary.Add("R002", "Current Stock");
        ...
        private void LoadInitialData()
        {
            ...
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<MultipleContextMISReports4>(MC, Request, "MIS_SCM_Report5", "SCM", "LoadAll", 0, "");
        ...
        private void DisplayReport()
        {
            ...
            try
            {
                ...
                if (ReportParameters.ReportCode != null)
                {
                    ...
                    dsReport = repository.GetDataWithReturnDomainObject<List<MIS_SCM_Rpt>>(dsReport, RequestParameter, "MIS_SCM_Report5", "SCM", "", 0, RequestParameter);
        ...
        private string GetReportFile(string ReportCode)
        {
            ...
            if (ReportCode == "R001")
            {
                returnReportName = "OpeningStock.rdlc";
            }
