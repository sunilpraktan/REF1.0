...
namespace Reflection.Modules.PRO.Views
{
    ...
    /// </summary>
    public partial class PRO_T003 : WindowElement
    {
        public string dgKey { get; set; } = null;
        public PRO_T003(string ts_code)
        {
            InitializeComponent();
            this.DataContext = new PRO_T005_VM("QP", ts_code);
        }
        public PRO_T003(string ts_code, string doc_no)
        {
            InitializeComponent();
            this.DataContext = new PRO_T005_VM("QP", ts_code, doc_no);
        }
        public PRO_T003(string ts_code, STD_LIST_BE REF_OBJECT)
        {
