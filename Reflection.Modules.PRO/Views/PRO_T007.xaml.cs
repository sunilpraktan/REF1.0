...
namespace Reflection.Modules.PRO.Views
{
    ...
    /// </summary>
    public partial class PRO_T007 : WindowElement
    {
        public string ts_code_vm { get; set; }
        public string dgKey { get; set; } = null;
        public PRO_T007(string ts_code)
        {
            InitializeComponent();
            ts_code_vm = ts_code;
            this.DataContext = new PRO_T007_VM("TO", ts_code);
        ...
        public PRO_T007(string ts_code, string doc_no)
        {
            InitializeComponent();
            ts_code_vm = ts_code;
            this.DataContext = new PRO_T007_VM("TO", ts_code, doc_no);
            tbcMaster.SelectionChanged += TabControl_SelectionChanged;
            tbcDetail.SelectionChanged += TabControl_SelectionChanged;
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        ...
        {
            if (msg.Notification == "PRO_T007_VM")
            {
        ...
        private void TabControl_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                var msg = new NotificationMessage("PRO_T007_VM");
