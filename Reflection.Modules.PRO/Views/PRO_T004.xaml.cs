...
namespace Reflection.Modules.PRO.Views
{
    ...
    /// </summary>
    public partial class PRO_T004 : WindowElement
    {
        public string ts_code_vm { get; set; }
        public string dgKey { get; set; } = null;
        public PRO_T004(string ts_code)
        {
            InitializeComponent();
            ts_code_vm = ts_code;
            this.DataContext = new PRO_T005_VM("NP", ts_code);
        ...
        public PRO_T004(string ts_code, string doc_no)
        {
            this.ts_code_vm = ts_code;
            InitializeComponent();
            this.DataContext = new PRO_T005_VM("NP", ts_code, doc_no);
            tbcMaster.SelectionChanged += TabControl_SelectionChanged;
            tbcDetail.SelectionChanged += TabControl_SelectionChanged;
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        public PRO_T004(string ts_code, STD_LIST_BE REF_OBJECT)
        {
            this.ts_code_vm = ts_code;
            InitializeComponent();
