...
namespace Reflection.Modules.PRO.Views
{
    ...
    /// </summary>
    public partial class PRO_T021 : WindowElement
    {
        ...
        public PRO_T021(string ts_code)
        {
            ts_code_vm = ts_code;
        ...
        public PRO_T021(string ts_code,string doc_no)
        {
            ts_code_vm = ts_code;
        ...
        public PRO_T021(string ts_code, STD_LIST_BE REF_OBJECT)
        {
            ts_code_vm = ts_code;
