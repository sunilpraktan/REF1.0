...
{
    /// <summary>
    /// Interaction logic for PRO_M0007.xaml
    /// </summary>
    public partial class PRO_M0007 : WindowElement
    {
        public string ts_code_vm { get; set; }
        public string dgKey { get; set; } = null;
        public PRO_M0007(string ts_code)
        {
            ts_code_vm = ts_code;
            this.DataContext = new PRO_M0007_VM("B2", ts_code);
            InitializeComponent();
        }
