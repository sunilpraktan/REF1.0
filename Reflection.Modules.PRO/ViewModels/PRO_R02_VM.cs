...
{
    public class PRO_R02_VM : WorkspaceViewModel<STD_LIST_BE>
    {
        ...
        private ICollectionView _DOCUMENT_LIST;
        public ICollectionView DOCUMENT_LIST
        {
            get { return _DOCUMENT_LIST; }
            set { _DOCUMENT_LIST = value; RaisePropertyChanged("DOCUMENT_LIST"); }
        }

        //private IEnumerable _DOCUMENT_LIST;
        //public IEnumerable DOCUMENT_LIST
        //{
        //    get { return _DOCUMENT_LIST; }
        //    set { _DOCUMENT_LIST = value; RaisePropertyChanged("DOCUMENT_LIST"); }
        //}
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(PRO_R02_VM));
        ...
        #endregion
        public PRO_R02_VM(string ts_code) : base()
        {
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<STD_MIS_MC_BE>(MC, Request, "PRO_R02_BL", "PRO", " ", 0, "");

                //DOCUMENT_LIST = MC.REF_DOC_LIST;

                DOCUMENT_LIST = CollectionViewSource.GetDefaultView(MC.REF_DOC_LIST);
                DOCUMENT_LIST.Filter = new Predicate<object>(FLTR_REF_DOC);
        ...
        public bool FLTR_REF_DOC(object obj)
        {
            ...
            if (data != null)
            {
                ...
                {
                    return (data.party_code != null && data.party_code.ToString().ToLower().Contains(_FLTR_STR_REF_DOC.ToLower()) ||
                            data.party_name != null && data.party_name.ToString().ToLower().Contains(_FLTR_STR_REF_DOC.ToLower()) ||
                            data.doc_no != null && data.doc_no.ToString().ToLower().Contains(_FLTR_STR_REF_DOC.ToLower()) ||
                            data.doc_date != null && data.doc_date.ToString().ToLower().Contains(_FLTR_STR_REF_DOC.ToLower())
                       );
                }
                return true;
            }
            ...
            try
            {
                ...
                else
                {
                    ...
                    foreach (var item in MC.REF_DOC_LIST)
                    {
                        ...
                        {
                            REQ_PARA_OBJ.doc_no = REQ_PARA_OBJ.doc_no + "," + item.doc_no;
                        }
                    }
