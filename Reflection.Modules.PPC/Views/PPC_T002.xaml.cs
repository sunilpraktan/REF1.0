...
namespace Reflection.Modules.PPC.Views
{
    ...
    /// </summary>
    public partial class PPC_T002 : WindowElement
    {
        public string dgKey { get; set; } = null;
        public string ts_code_vm { get; set; }
        private bool isManualEditCommit;
        public PPC_T002(string ts_code)
        {
            InitializeComponent();
            ts_code_vm = ts_code;
            this.DataContext = new PPC_T002_VM(ts_code, "OR", "OR");
        ...
        public PPC_T002(string ts_code, string doc_no)
        {
            InitializeComponent();
            ts_code_vm = ts_code;
            this.DataContext = new PPC_T002_VM(ts_code, "OR", "OR", doc_no);
            tbcMaster.SelectionChanged += TabControl_SelectionChanged;
            tbcDetail.SelectionChanged += TabControl_SelectionChanged;
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
