...
namespace Reflection.Modules.PPC.Views
{
    ...
    /// </summary>
    public partial class RMS_T001 : WindowElement
    {
        public string dgKey { get; set; } = null;
        public string ts_code_vm { get; set; }
        private bool isManualEditCommit;
        public RMS_T001(string ts_code)
        {
            InitializeComponent();
            ts_code_vm = ts_code;
            this.DataContext = new PPC_T002_VM(ts_code, "NR", "PM05");
            tbcDetail.SelectionChanged += TabControl_SelectionChanged;
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        public RMS_T001(string ts_code, string doc_no)
        {
            InitializeComponent();
            ts_code_vm = ts_code;
            this.DataContext = new PPC_T002_VM(ts_code, "NR", "PM05", doc_no);
            tbcDetail.SelectionChanged += TabControl_SelectionChanged;
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        public RMS_T001(string ts_code, STD_LIST_BE STD_LIST_OBJ)
        {
            InitializeComponent();
            ts_code_vm = ts_code;
