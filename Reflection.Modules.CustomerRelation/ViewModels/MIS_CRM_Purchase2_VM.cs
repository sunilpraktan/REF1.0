...
{
    public class MIS_CRM_Purchase2_VM : WorkspaceViewModel<MIS_PurchaseReport>
    {
        ...
        private List<MIS_CRM_SalesEntity3> _dsReport2;
        public List<MIS_CRM_SalesEntity3> dsReport2
        {
            ...
            : base()
        {
            ...
            dsReport2 = new List<MIS_CRM_SalesEntity3>();
            ItemsDictionary = new Dictionary<string, string>();
            ItemsDictionary.Add("R001", "Purchase Invoice(Details)");
            ItemsDictionary.Add("R002", "Purchase Invoice(Summary)");
            ItemsDictionary.Add("R003", "GST Report (Purchase Invoice)");
        ...
        private void LoadInitialData()
        {
            ...
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<MultipleContextMIS_CRM_Purchase>(MC, Request, "MIS_CRMPurchaseReport2", "CRM", "LoadAll", 0, "");
        ...
        private void DefaultValues()
        {
            ...
            ReportParameters.ReportName = "GST Report (Purchase Invoice)";
        ...
        private void DisplayReport()
        {
            ...
            try
            {
                ...
                if (ReportParameters.ReportCode != null)
                {
                    ...
                    if (ReportParameters.ReportCode == "R003")
                    {
                        WebServiceRepository<List<MIS_CRM_SalesEntity3>> repository2 = new WebServiceRepository<List<MIS_CRM_SalesEntity3>>();
                        string RequestParameter = "Report" + "!@" + "R022" + "!@" + ReportParameters.ItemCode + "!@" + ReportParameters.PartyId + "!@" + ReportParameters.location_Id + "!@" + AppSessionState.comp_code + "!@" + Convert.ToDateTime(ReportParameters.FromDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(ReportParameters.ToDate).ToString("MM/dd/yyyy") + "!@" + ReportParameters.doc_no + "!@" + ReportParameters.doc_cat + "!@" + ReportParameters.EmpId + "!@" + ReportParameters.t_status + "!@" + "" + "!@" + "" + "!@" + "" + "!@" + ReportParameters.doc_type + "!@" + AppSessionState.client;
                        dsReport2 = repository2.GetDataWithReturnDomainObject<List<MIS_CRM_SalesEntity3>>(dsReport2, RequestParameter, "MIS_CRMSalesReport3", "CRM", "", 0, RequestParameter);
                        ReportManager.DisplayReport(dsReport2, "dsMIS_CRM_SalesEntity3", "\\CRM\\" + GetReportFile(ReportParameters.ReportCode), getParametersList());
                    }
                    else
                    {
                        string RequestParameter = "Report" + "!@" + ReportParameters.ReportCode + "!@" + ReportParameters.ItemCode + "!@" + ReportParameters.PartyId + "!@" + ReportParameters.location_Id + "!@" + ReportParameters.comp_code + "!@" + Convert.ToDateTime(ReportParameters.FromDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(ReportParameters.ToDate).ToString("MM/dd/yyyy") + "!@" + ReportParameters.po_no + "!@" + ReportParameters.EmpId + "!@" + ReportParameters.t_status + "!@" + ReportParameters.curr_code + "!@" + AppSessionState.client;
                        dsReport = repository.GetDataWithReturnDomainObject<List<MIS_CRM_PurchaseEntity>>(dsReport, RequestParameter, "MIS_CRMPurchaseReport2", "CRM", "", 0, RequestParameter);
        ...
        private string GetReportFile(string ReportCode)
        {
            ...
            if (ReportCode == "R001")
            {
                returnReportName = "PurchaseInvoiceDetails.rdlc";
            }
            if (ReportCode == "R002")
            {
                returnReportName = "PurchaseInvoiceSummary.rdlc";
            }
            if (ReportCode == "R003")
            {
