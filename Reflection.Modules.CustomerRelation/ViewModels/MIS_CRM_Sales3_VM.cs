...
namespace Reflection.Modules.CustomerRelation.ViewModels
{
    ...
    public class MIS_CRM_Sales3_VM : WorkspaceViewModel<MIS_SalesReports>
    {
       ...
       MultipleContextMISReports _MCTemp = new MultipleContextMISReports();
            ...
            : base()
        {
            ...
            ItemsDictionary.Add("R004", "Activity");
            ItemsDictionary.Add("R005", "Activity v/s Log");
            ItemsDictionary.Add("R006", "Client List");
            ItemsDictionary.Add("R009", "Visited Client List Details");
            ItemsDictionary.Add("R010", "Visited Client List Summary");
            ItemsDictionary.Add("R012", "Non Visited Client List");
            ItemsDictionary.Add("R014", "Assigned Visited Client List");
            ItemsDictionary.Add("R016", "Assigned Visited/Novisited Client List Summary");
           // ItemsDictionary.Add("R018", "Assigned Visited/Novisited With Grade Client List Summary");
            ItemsDictionary.Add("R020", "Assigned Client List Details");
            ItemsDictionary.Add("R023", "Expected Payment Report(Summary)");
            //ItemsDictionary.Add("R027", "Expected Payment Report ");
        ...
        private void LoadInitialData()
        {
            ...
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<MultipleContextMISReports>(MC, Request, "MIS_CRMSalesReports", "CRM", "LoadAll", 0, "MIS_CRM_Sales2");
        ...
        private void DisplayReport()
        {
            ...
            try
            {
                ...
                if (ReportParameters.ReportCode != null)
                {
                    ...
                    MCTemp = repository_MC.GetDataWithReturnDomainObject<MultipleContextMISReports>(MC, RequestParameter, "MIS_CRMSalesReports", "CRM", "", 0, "MIS_CRM_Sales2");
        ...
        private string GetReportFile(string ReportCode)
        {
            ...
            if (ReportCode == "R004")
            { returnReportName = "Activity.rdlc"; }
            else if (ReportCode == "R005")
            { returnReportName = "ActivityvsLog.rdlc"; }
            else if (ReportCode == "R006")
            { returnReportName = "VisitingCard.rdlc"; }
            else if (ReportCode == "R009")
            { returnReportName = "ClientListDetail.rdlc"; }
            else if (ReportCode == "R010")
            { returnReportName = "ClientListSummary.rdlc"; }
            else if (ReportCode == "R012")
            { returnReportName = "NonVisitedClientList.rdlc"; }
            else if (ReportCode == "R014") //----For Assigned Party List
            { returnReportName = "ClientListDetail.rdlc"; }
            else if (ReportCode == "R016")
            { returnReportName = "AssignedClientListSummary.rdlc"; }
            else if (ReportCode == "R018")
            { returnReportName = "GradeAssignedClientListSummary.rdlc"; }
            else if (ReportCode == "R020")
            { returnReportName = "SalesPersonAssignedClientList.rdlc"; }
            else if (ReportCode == "R023")
            { returnReportName = "ExpectedPaymentReport.rdlc"; }
