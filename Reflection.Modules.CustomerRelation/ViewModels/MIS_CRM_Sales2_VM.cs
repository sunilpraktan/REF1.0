...
{
    public class MIS_CRM_Sales2_VM : WorkspaceViewModel<MIS_SalesReports>
    {
        bool blNew = true;
       ...
       public RelayCommand<object> cmdPartyChange { get; private set; }
            ...
            : base()
        {
            ...
            ItemsDictionary.Add("R001", "Activity");
            ItemsDictionary.Add("R002", "Activity v/s Log");
            ItemsDictionary.Add("R003", "Client List");
            ItemsDictionary.Add("R007", "Visited Client List Details");
            ItemsDictionary.Add("R008", "Visited Client List Summary");
            ItemsDictionary.Add("R011", "Non Visited Client List");
            ItemsDictionary.Add("R013", "Assigned Visited Client List");
            ItemsDictionary.Add("R015", "Assigned Visited/Novisited Client List Summary");
            //ItemsDictionary.Add("R017", "Assigned Visited/Novisited With Grade Client List Summary");
            ItemsDictionary.Add("R019", "Assigned Client List Details");
        ...
        private void DisplayReport()
        {
            ...
            try
            {
                ...
                if (ReportParameters.ReportCode != null)
                {
                    ...
                    dsReport2 = repository.GetDataWithReturnDomainObject<List<MIS_CRM_SalesEntity2>>(dsReport2, RequestParameter, "MIS_CRMSalesReports", "CRM", "", 0, "MIS_CRM_Sales2");
        ...
        private string GetReportFile(string ReportCode)
        {
            ...
            else if (ReportCode == "R013")//----For Assigned Party List
            { returnReportName = "ClientListDetail.rdlc"; }
