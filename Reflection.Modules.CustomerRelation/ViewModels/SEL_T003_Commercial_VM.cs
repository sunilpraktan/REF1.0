...
{
    public class SEL_T003_Commercial_VM : WorkspaceViewModel<SEL_T003>
    {
        #region AutoSuggest TextBox Region
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(SEL_T003_Commercial_VM));
        ...
        #endregion
        public SEL_T003_Commercial_VM(string doc_cat, string ts_code, string doc_no) : base()
        {
        ...
        public SEL_T003_Commercial_VM(string doc_cat, string ts_code) : base()
        {
            CursorControl.SetBusyState();
            this.ts_code_vm = ts_code;
            this.doc_cat_vm = doc_cat;
        ...
        private void LoadInitialData()
        {
            ...
            try
            {
                ...
                refdoctempa = (from o in MC.Sales_Invoice_Reference where o.doc_cat == "CI" select o).ToList();
                ReferenceDocCICollection = CollectionViewSource.GetDefaultView(refdoctempa);
        ...
        private void RemoveRefDoc()
        {
            try
            {
                ...
                //{
                    ...
                    refdoctempa = (from o in MC.Sales_Invoice_Reference where o.doc_cat == "CI" select o).ToList();
                    foreach (var item in refdoctempa)
                    {
                        item.Select = false;
                    }
                    ReferenceDocCICollection = CollectionViewSource.GetDefaultView(refdoctempa);
