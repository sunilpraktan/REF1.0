...
{
    public class SEL_T003_Performa_VM : WorkspaceViewModel<SEL_T003>
    {
        #region AutoSuggest TextBox Region
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(SEL_T003_Performa_VM));
        ...
        #region Constructor 
        public SEL_T003_Performa_VM(string doc_cat, string ts_code) : base()
        {
            try
            {
        ...
        public SEL_T003_Performa_VM(string doc_cat, string ts_code, string doc_no) : base()
        {
            try
            {
                this.ts_code_vm = ts_code;
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                var refdoctype1 = (from o in MC.doc_typeList where o.doc_type == "PI" select o).ToList();
                ...
                if (POPUPEntityObject != null)
                {
                    if (POPUPEntityObject.t_status != "009")
                    {
                        ...
                        else if (MasterEntity.ref_doc_cat == "SN")
                        {
                            ...
                            ReferenceDocSNCollection = CollectionViewSource.GetDefaultView(refdoctempa);
                            // Clear Other reference
                            var refdoctempSO = (from o in MC.Sales_Invoice_Reference where o.doc_cat == "SO" select o);
                            if (refdoctempSO != null)
                            {
                                try
                                {
                            ...
                            ReferenceDocSOCollection = CollectionViewSource.GetDefaultView((from o in MC.Sales_Invoice_Reference where o.doc_cat == "SO" select o).ToList());
                            ReferenceDocSOCollection.Filter = new Predicate<object>(Filter_ReferenceDoc);
                            ReferenceDocQNCollection = CollectionViewSource.GetDefaultView((from o in MC.Sales_Invoice_Reference where o.doc_cat == "QN" select o).ToList());
                            ReferenceDocQNCollection.Filter = new Predicate<object>(Filter_ReferenceDoc);
                        }
        ...
        protected override void OnPrintAction(InquiryActionResult<SEL_T003> result)
        {
            ...
            try
            {
                ...
                //{
                //    Request = "SI_Report" + "!@" + MasterEntity.bill_doc + "!@" + MasterEntity.doc_cat + "!@" + MasterEntity.doc_cat;
                //}
                //else
                //{
                    Request = "SI_Report" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + MasterEntity.doc_cat + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.bill_doc;
                //}
                ...
                var ReportStringList = (from o in MC.doc_typeList where o.doc_cat == MasterEntity.doc_cat select o).ToList();
