...
{
    public class MIS_CRM_Purchase1_VM : WorkspaceViewModel<MIS_PurchaseReport>
    {
            ...
            : base()
        {
            ...
            ItemsDictionary.Add("R001", "Purchase Order(Details)");
            ItemsDictionary.Add("R002", "Purchase Order(Summary)");
            ItemsDictionary.Add("R003", "Purchase Quotation(Details)");
            ItemsDictionary.Add("R004", "Purchase Quotation(Summary)");
            ItemsDictionary.Add("R005", "Pending PO(Details)");
            ItemsDictionary.Add("R006", "Pending PO(Summary)");
            ItemsDictionary.Add("R007", "ItemWise PO Detail");
            ItemsDictionary.Add("R008", "GRN Without PO");
            ItemsDictionary.Add("R009", "Suppliers List");
            ItemsDictionary.Add("R010", "Pending PO (Invoice)");
        ...
        private void LoadInitialData()
        {
            ...
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<MultipleContextMIS_CRM_Purchase>(MC, Request, "MIS_CRMPurchaseReport1", "CRM", "LoadAll", 0, "");
        ...
        private void DisplayReport()
        {
            ...
            try
            {
                ...
                if (ReportParameters.ReportCode != null)
                {
                    ...
                    dsReport = repository.GetDataWithReturnDomainObject<List<MIS_CRM_PurchaseEntity>>(dsReport, RequestParameter, "MIS_CRMPurchaseReport1", "CRM", "", 0, RequestParameter);
        ...
        private string GetReportFile(string ReportCode)
        {
            ...
            if (ReportCode == "R001")
            {
                returnReportName = "PurchaseOrderDetails.rdlc";
            }
            if (ReportCode == "R002")
            {
                returnReportName = "PurchaseOrderSummary.rdlc";
            }
            if (ReportCode == "R003")
            {
                returnReportName = "PurchaseOrderDetails.rdlc";
            ...
            if (ReportCode == "R005")
            {
                returnReportName = "PendingPODetails.rdlc";
            }
            if (ReportCode == "R006")
            {
                returnReportName = "PendingPOSummary.rdlc";
            }
            if (ReportCode == "R007")
            {
                returnReportName = "ItemWisePODetail.rdlc";
            }
            if (ReportCode == "R008")
            {
                returnReportName = "GRNWithoutPO.rdlc";
            }
            if (ReportCode == "R009")
            {
                returnReportName = "SuppliersList.rdlc";
            }
            if (ReportCode == "R010")
            {
                returnReportName = "PendingPOInvoice.rdlc";
            }
