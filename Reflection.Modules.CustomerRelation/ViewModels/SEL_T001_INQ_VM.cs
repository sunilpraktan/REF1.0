...
{
    public class SEL_T001_INQ_VM : WorkspaceViewModel<SEL_T001>
    {
        ...
        /// </summary>
        /// <param name="NA"></param>
        public SEL_T001_INQ_VM(string doc_cat, string ts_code) : base()
        {
        ...
        public SEL_T001_INQ_VM(string doc_cat, string ts_code, string doc_no) : base()
        {
            this.ts_code_vm = ts_code;
                ...
                if (POPUPEntityObject != null) //&& MasterEntity.PartyId != POPUPEntityObject.PartyId) //Application:New Record Only.Condition: Only enter in the code block if EntityObject is Not null and not assigning same value again if event fire twice.
                {
                    ...
                    else if (isNewRecord == true && ItemsEntity.Count > 0 && MasterEntity.PartyId != POPUPEntityObject.PartyId)
                    {
                        ...
                        if (showMessageService.ShowMessage() == DialogResult.Ok)
                        {
                            ...
                            MCTemp = repository_MCTemp.GetDataWithReturnDomainObject<MultipleContext_SEL_T001>(MCTemp, RequestParameterData, "SalesInquiry", "CRM", "", 0, "");
        ...
        private void InsertShipToParty(object InputValue, bool OverrideValue)
        {
            ...
            {//ADM_M028_PopUp
                ...
                if (POPUPEntityObject != null) //&& MasterEntity.PartyId != POPUPEntityObject.PartyId) //Application:New Record Only.Condition: Only enter in the code block if EntityObject is Not null and not assigning same value again if event fire twice.
                {
                    ...
                    //RequestParameterData = "LoadShipToPartyDetails" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat + "!@" + MasterEntity.PartyId + "!@" + AppSessionState.client + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + MasterEntity.ts_code;
                    MCTemp = repository_MCTemp.GetDataWithReturnDomainObject<MultipleContext_SEL_T001>(MCTemp, RequestParameterData, "SalesInquiry", "CRM", "", 0, "");
        ...
        private void InsertServiceProvider(object InputValue, bool OverrideValue)
        {
            try
            {
                ...
                if (POPUPEntityObject != null) //Application:New Record Only.Condition: Only enter in the code block if EntityObject is Not null and not assigning same value again if event fire twice.
                {
                    ...
                    //RequestParameterData = "LoadRefferingPartyDetails" + "!@" + MasterEntity.referring_party + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat  + "!@" + AppSessionState.client + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + MasterEntity.ts_code;
                    MCTemp = repository_MCTemp.GetDataWithReturnDomainObject<MultipleContext_SEL_T001>(MCTemp, RequestParameterData, "SalesInquiry", "CRM", "", 0, "");
            ...
            try
            {
                ...
                if (ParameterObject.GetType() == typeof(string) && ParameterObject != null) // This Block of code read parameter . First for string and Entity Object in else part.
                {
                    ...
                    if (ParametersStringValue.Length > 0)
                    {
                        try
                        {
                            ...
                            Request = "LoadDocumentWithDocumentNumber" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@!@!@!@" + ParametersStringValue;
                        }
                        catch (Exception ex) { }
                    }
                }
                else if (ParameterObject != null)
                {
                    if (((IEnumerable)ParameterObject).Cast<SEL_T001_Flip>().ToList().Count > 0)
                    {
                        ...
                        //Request = "LoadDocumentWithReferenceDocumentNumber" + "!@" + ParameterEntityObject.sono + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat + "!@" + MasterEntity.PartyId + "!@" + AppSessionState.client + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + MasterEntity.ts_code; 
                        isNewRecord = false;
                        SelectedTabControlIndex = 0;
                        //MasterEntity = new SEL_T001();
                        //MasterEntity = repository.GetDataWithReturnDomainObject<SEL_T001>(MasterEntity, Request, "SalesInquiry", "CRM", "LoadDocumentWithReferenceDocumentNumber", 0, "");
                        ...
                        //string RequestParameterData = "LoadSoldToPartyDetails" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat + "!@" + MasterEntity.PartyId + "!@" + AppSessionState.client + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + MasterEntity.ts_code;
                        MCTemp = repository_MCTemp.GetDataWithReturnDomainObject<MultipleContext_SEL_T001>(MCTemp, RequestParameterData, "SalesInquiry", "CRM", "", 0, "");
                        MC.PartysContactInfo = MCTemp.PartysContactInfo;
                        MC.PartysSoldToAddresses = MCTemp.PartysSoldToAddresses;
                        MC.ItemListPopup = MCTemp.ItemListPopup;
                ...
                MCTemp = repository_MCTemp.GetDataWithReturnDomainObject<MultipleContext_SEL_T001>(MCTemp, Request, "SalesInquiry", "CRM", "LoadDocumentWithDocumentNumber", 0, "");
                MC.PartysContactInfo = MCTemp.PartysContactInfo;
                MC.PartysSoldToAddresses = MCTemp.PartysSoldToAddresses;
                MC.PartysShipToAddresses = MCTemp.PartysShipToAddresses;
        ...
        protected override void OnSaveAction(InquiryActionResult<SEL_T001> result)
        {
            ...
            try
            {
                if (Validation() == true)
                {
                    ...
                    if (isNewRecord == true)
                    {
                        MasterEntity = repository.SaveWithReturnDomainObject<SEL_T001>(MasterEntity, "SalesInquiry", "CRM");
                    ...
                    {
                        MasterEntity = repository.UpdateWithReturnDomainObject<SEL_T001>(MasterEntity, "SalesInquiry", "CRM");
        ...
        protected override void OnPrintAction(InquiryActionResult<SEL_T001> result)
        {
            ...
            try
            {
                ...
                //string Request = "LoadDocumentWithReferenceDocumentNumber" + "!@" + MasterEntity.sono + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat + "!@" + MasterEntity.PartyId + "!@" + AppSessionState.client + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + MasterEntity.ts_code;

                MCTemp = repository_MC.GetDataWithReturnDomainObject<MultipleContext_SEL_T001>(MCTemp, Request, "SalesInquiry", "CRM", "LoadAll", 0, "");
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                //string Request = "LoadInitialData" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id.ToString() + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat + "!@" + AppSessionState.so_code + "!@" + AppSessionState.sg_code + "!@" + AppSessionState.EmpId + "!@" + AppSessionState.client + "!@" + MasterEntity.ts_code;
                MC = repository_MC.GetDataWithReturnDomainObject<MultipleContext_SEL_T001>(MC, Request, "SalesInquiry", "CRM", "LoadAll", 0, "");
                ...
                ASFltr_DocType = new AutoSuggestTextViewModel<dynamic>(MC.DocumentTypes, TheFilter, SuggestedValue, "Fltr_doc_type", true);
        ...
        private void LoadHistory()
        {
            try
            {
                ...
                MCTemp1 = repository_MCTemp1.GetDataWithReturnDomainObject<MultipleContext_SEL_T003>(MCTemp1, Request, "SalesInquiry", "CRM", "LoadHistory", 0, "");
        ...
        private void OpenDocumentViewer(object InputValue)
        {
            try
            {
                ...
                //string Request = "GetAllFiles" + "!@" + EntityObjectParameter.ItemCode + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat + "!@" + MasterEntity.PartyId + "!@" + AppSessionState.client + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + MasterEntity.ts_code;
        ...
        private void Computation_1(bool Compute)
        {
            if (Compute == true)
            {
                ...
                if (ItemsEntity != null && ItemsEntity.Count > 0 && dgSelectedIndexItem >= 0 && dgSelectedIndexItem < ItemsEntity.Count) //Condition satisfy only if Items collection is not empty.
                {
                    ...
                    {
                        ItemsEntity[dgSelectedIndexItem].sub_total = ItemsEntity[dgSelectedIndexItem].quantity * ItemsEntity[dgSelectedIndexItem].unit_price;
                    }
                    ...
                    if (ItemsEntity[dgSelectedIndexItem].tax_id != null) // Remove previously assign Taxes to apply new for perticuler item row.//Condition satisfy only if Selected Item not null.
                    {
                                ...
                                foreach (ACC_M013_P SingleTax in TaxListTemp) // Foreach Loop for Computation of Induvidual Tax as per the proerties in Tax Master.
                                {
                                    ...
                                    if (SingleTax.t_type == "Percentage" && SingleTax.amount > 0)
                                    {
                                        ...
                                        else if (SingleTax.Price_include == false)
                                        {
                                            ...
                                            {
                                                PreviousTaxValueForBasePrice = TotalDocumentTaxes.Where(tax => tax.sequence < SingleTax.sequence && tax.ItemCode == ItemsEntity[dgSelectedIndexItem].ItemCode && tax.sku == ItemsEntity[dgSelectedIndexItem].sku && tax.item_row_id == ItemsEntity[dgSelectedIndexItem].id && tax.tax_code_id.In(TaxListForBaseInclude)).Sum(tax => tax.amount); // Get Base amount for Calculation.
                                            }
                                            if (SingleTax.parent_id != null) // Collect Base price for This single child Tax.
                                            {
                                                BasePrice = TotalDocumentTaxes.Where(tax => tax.tax_code_id == SingleTax.parent_id && tax.ItemCode == ItemsEntity[dgSelectedIndexItem].ItemCode && tax.sku == ItemsEntity[dgSelectedIndexItem].sku && tax.item_row_id == ItemsEntity[dgSelectedIndexItem].id).Single().tax_amount;
                                            }
                                    ...
                                    TotalDocumentTaxes.Add(new ACC_T006_B() { id = 0, tax_amount = TaxAmount, account_id = 0, sequence = SingleTax.sequence, doc_no = MasterEntity.po_no, manual = "Auto", base_amount = BasePrice, amount = TaxAmount, tax_code_id = SingleTax.id, account_analytic_id = 0, base_code_id = SingleTax.id, tax_name = SingleTax.description, gl_code = "", ItemCode = ItemsEntity[dgSelectedIndexItem].ItemCode, sku = ItemsEntity[dgSelectedIndexItem].sku, item_row_id = ItemsEntity[dgSelectedIndexItem].id, fin_year = "2015", active = true, location_Id = AppSessionState.location_Id, comp_code = AppSessionState.comp_code });
                                }
