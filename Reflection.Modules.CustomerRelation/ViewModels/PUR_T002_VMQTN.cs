...
{
    public class PUR_T002_VMQTN : WorkspaceViewModel<PUR_T002_A>
    {
        #region AutoSuggest TextBox Region
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(PUR_T002_VMQTN));
        ...
        public PUR_T002_VMQTN(string ts_code)
            : base()
        {
        ...
        public PUR_T002_VMQTN(string ts_code, string doc_no)
            : base()
        {
            CursorControl.SetBusyState();
            this.ts_code_vm = ts_code;
                ...
                if (POPUPEntityObject != null) //&& MasterEntity.PartyId != POPUPEntityObject.PartyId) //Application:New Record Only.Condition: Only enter in the code block if EntityObject is Not null and not assigning same value again if event fire twice.
                {
                    ...
                    else if (NewRecord == true && dgItemsEntity.Count > 0 && MasterEntity.PartyId != POPUPEntityObject.PartyId)
                    {
                        ...
                        if (showMessageService.ShowMessage() == DialogResult.Ok)
                        {
                            ...
                            RequestParameterData = "LoadPartyDetails" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + MasterEntity.doc_type+ "!@" + MasterEntity.doc_cat + "!@" + AppSessionState.po_code + "!@" + MasterEntity.PartyId + "!@" + AppSessionState.EmpId + "!@" + AppSessionState.pg_code;
                            MCTemp = repository_MC.GetDataWithReturnDomainObject<MultipleContext_PUR_T002_A>(MCTemp, RequestParameterData, "PurchaseOrder", "Procurement", "", 0, "");
            ...
            try
            {
                ...
                else if (ParameterObject != null)
                {
                    if (((IEnumerable)ParameterObject).Cast<PUR_T002_AFlip>().ToList().Count > 0)
                    {
                        ...
                        NewRecord = false;
                        string RequestParameterData = "LoadPartyDetails" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + "PO" + "!@" + "PO" + "!@" + AppSessionState.po_code;
                        MCTemp = repository_MC.GetDataWithReturnDomainObject<MultipleContext_PUR_T002_A>(MCTemp, RequestParameterData, "PurchaseOrder", "Procurement","",0,"");
                        ItemListForPopup = MCTemp.ItemListForPopup;
