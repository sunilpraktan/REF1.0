...
{
    /// <summary>
    /// Interaction logic for PerformaInvoice.xaml
    /// </summary>
    public partial class PerformaInvoice : WindowElement
    {
        private bool isManualEditCommit;
        private string ts_code_local;
        public PerformaInvoice(string ts_code)
        {
            ts_code_local = ts_code;
            InitializeComponent();
            this.DataContext = new SEL_T003_Performa_VM("PI",ts_code);
        ...
        public PerformaInvoice(string ts_code, string doc_no)
        {
            ts_code_local = ts_code;
            InitializeComponent();
            this.DataContext = new SEL_T003_Performa_VM("PI", ts_code, doc_no);
            tbcMaster.SelectionChanged += TabControl_SelectionChanged;
            tbcDetail.SelectionChanged += TabControl_SelectionChanged;
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
