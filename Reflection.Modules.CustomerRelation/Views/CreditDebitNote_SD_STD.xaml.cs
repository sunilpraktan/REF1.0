...
{
    /// <summary>
    /// Interaction logic for CreditDebitNote_SD_STD.xaml
    /// </summary>
    public partial class CreditDebitNote_SD_STD : WindowElement
    {
        private bool isManualEditCommit;
        private string ts_code_local;
        public CreditDebitNote_SD_STD(string ts_code)
        {
            InitializeComponent();
            ts_code_local = ts_code;
            InitializeComponent();
            this.DataContext = new SEL_T003_CD_STD_VM(ts_code, "CR");
        ...
        public CreditDebitNote_SD_STD(string ts_code, string doc_no)
        {
            ts_code_local = ts_code;
            InitializeComponent();
            this.DataContext = new SEL_T003_CD_STD_VM(ts_code, "CR", doc_no);
            tbcMaster.SelectionChanged += TabControl_SelectionChanged;
            tbcDetail.SelectionChanged += TabControl_SelectionChanged;
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
