...
namespace Reflection.Modules.CustomerRelation.Views
{
    ...
    /// </summary>
    public partial class PurchaseEntry : WindowElement
    {
        public PurchaseEntry(string ts_code)
        {
            InitializeComponent();
            this.DataContext = new PUR_T005_VM(ts_code);
        ...
        public PurchaseEntry(string ts_code, string doc_no)
        {
            InitializeComponent();
            this.DataContext = new PUR_T005_VM(ts_code, doc_no);
            tbcMaster.SelectionChanged += TabControl_SelectionChanged;
            tbcDetail.SelectionChanged += TabControl_SelectionChanged;
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        ...
        {
            if (msg.Notification == "PUR_T005_VM")
            {
