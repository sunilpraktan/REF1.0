...
{
    public class PMM_M0002_VM : WorkspaceViewModel<STD_BE_A>
    {
        ...
        #region Constructor
        public PMM_M0002_VM(string ts_code) : base()
        {
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<MC_GEN_BE>(MC, Request, "PMM_M0002_BL", "PMM", "LOAD_INI", 0, "");
        ...
        protected override void OnSaveAction(InquiryActionResult<STD_BE_A> result)
        {
            ...
            //    if (Validation() == true)
            //    {
            //        string strReturn = repository.Save<List<STD_BE_A>>(RequestList, "PMM_M0002_BL", "PMM");
