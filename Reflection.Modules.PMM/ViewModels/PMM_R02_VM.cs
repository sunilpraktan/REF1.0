...
{
    public class PMM_R02_VM : WorkspaceViewModel<STD_LIST_BE>
    {
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(PMM_R02_VM));
        ...
        #endregion
        public PMM_R02_VM(string ts_code) : base()
        {
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<STD_MIS_MC_BE>(MC, Request, "PMM_R02_BL", "PMM", " ", 0, "");
                ...
                AS_INPUT_TYPE.AutoSuggestVM.IsEmptyValueAllowed = true; AS_INPUT_TYPE.AutoSuggestVM.IsFreeTextAllowed = false;
                ...
                AS_RECORD_TYPE.AutoSuggestVM.IsEmptyValueAllowed = true; AS_RECORD_TYPE.AutoSuggestVM.IsFreeTextAllowed = false;
                ...
                AS_SHIFT.AutoSuggestVM.IsEmptyValueAllowed = true; AS_SHIFT.AutoSuggestVM.IsFreeTextAllowed = false;
                ...
                TheFilter = (o, prefix) => (((STD_LIST_BE)o).t_status ?? "").ToString().ToLower().Contains(prefix.ToLower()) || (((STD_LIST_BE)o).value_name ?? "").ToString().ToLower().Contains(prefix.ToLower());
