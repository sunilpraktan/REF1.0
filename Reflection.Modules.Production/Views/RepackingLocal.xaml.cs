...
{
    /// <summary>
    /// Interaction logic for RepackingLocal.xaml
    /// </summary>
    public partial class RepackingLocal : WindowElement
    {
        public RepackingLocal(string ts_code)
        {
            InitializeComponent();
            this.DataContext = new EPR_T003_RepackingLocal(ts_code);
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        public RepackingLocal(string ts_code,string doc_no)
        {
            InitializeComponent();
            this.DataContext = new EPR_T003_RepackingLocal(ts_code,doc_no);
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
