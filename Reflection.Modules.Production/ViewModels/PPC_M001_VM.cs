...
{
    public class PPC_M001_VM : WorkspaceViewModel<PPC_M001>
    {
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(PPC_M001_VM));
        ...
        #region Constructor
        public PPC_M001_VM(string ts_code) : base()
        {
        ...
        public PPC_M001_VM(string ts_code,string doc_no) : base()
        {
            this.ts_code_vm = ts_code;
        ...
        private void LoadDocumentByDocumentNumber(object ParameterObject, string ParameterReference)
        {
            ...
            try
            {
                if (((IEnumerable)ParameterObject).Cast<PPC_M001_BackFlip>().ToList().Count > 0)
                {
                    ...
                    Request = "LoadDocumentByDocumentNumber" + "!@" + AppSessionState.location_Id + "!@" + AppSessionState.comp_code + "!@" + ParameterEntityObject.wc_code;
