...
{
    class EPR_T003_RepackingLocal : WorkspaceViewModel<EPR_T003_A>
    {
        ...
        public EPR_T003_RepackingLocal(string ts_code) : base()
        {
        ...
        public EPR_T003_RepackingLocal(string ts_code, string doc_no) : base()
        {
            this.ts_code_vm = ts_code;
        ...
        protected override void OnCreateAction(InquiryActionResult<EPR_T003_A> result)
        {
            try
            {
                ...
                MasterEntity.gross_wt = MC.SettingsList[0].gross_wt;
                var msg = new NotificationMessage("EPR_T003_RepackingLocal");
