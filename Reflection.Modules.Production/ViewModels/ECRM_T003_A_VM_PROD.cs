...
namespace Reflection.Modules.Production.ViewModels
{
    ...
    public class ECRM_T003_A_VM_PROD : WorkspaceViewModel<ECRM_T003_A>
    {
        ...
        private Visibility _GridColumnVisibility;
        public Visibility GridColumnVisibility
        {
            get { return _GridColumnVisibility; }
            set
            {
                if (_GridColumnVisibility != value)
                {
                    _GridColumnVisibility = value;
                    RaisePropertyChanged("GridColumnVisibility");
                }
            }
        }
        void Model_ItemUpdated(object sender, EventArgs e)
        {
            this.ErrorExist = SelectedECRM_T003_A.HasErrors;
        }
        ...
        public RelayCommand<IList> TextBox_GotKeyboardFocus
        {
            get;
            private set;
        }
        ...
        //#region ECRM_T003_B_P
        //private ECRM_T003_B_P _SelectedRefil;
        //public ECRM_T003_B_P SelectedRefil
        //{
        //    get { return _SelectedRefil; }
        //    set
        //    {
        //        if (_SelectedRefil != value)
        //        {
        //            _SelectedRefil = value;
        //            RaisePropertychanged("SelectedRefil");

        //        }
        //    }
        //}
        //private List<ECRM_T003_B_P> _SelectedListOfRefilList;
        //public List<ECRM_T003_B_P> SelectedListOfRefilList
        //{
        //    get { return _SelectedListOfRefilList; }
        //    set
        //    {
        //        if (_SelectedListOfRefilList != value)
        //        {
        //            _SelectedListOfRefilList = value;
        //            RaisePropertychanged("SelectedListOfRefilList");
        //        }
        //    }
        //}
        ...
        public ECRM_T003_A_VM_PROD(string ts_code)
            : base()
        {
            this.ts_code_vm = ts_code;
            blNew = true;
            GridColumnVisibility = Visibility.Visible;
        ...
        public ECRM_T003_A_VM_PROD(string ts_code,string doc_no)
            : base()
        {
            this.ts_code_vm = ts_code;
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                SelectedECRM_T003_A.doc_type = "PR";
                SelectedECRM_T003_A.location_Id = Convert.ToString(AppSessionState.location_Id);
                SelectedECRM_T003_A.prdct_codeBack = "All";
                request = (SelectedECRM_T003_A.prdct_codeBack) + "!@" + Convert.ToDateTime(System.DateTime.Now.Date).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(System.DateTime.Now.Date).ToString("MM/dd/yyyy") + "!@" + SelectedECRM_T003_A.doc_type + "!@" + Convert.ToString(SelectedECRM_T003_A.location_Id);
                MC = repositoryM.GetDataWithReturnDomainObject<MultipleContext_ECRM_T003_A>(MC, "ECRM_T003_A_Data", "WritingTestForProduction", "Production", "LoadAll", 0, request);
               ...
               items =>
               {
                ...
                TextBox_GotKeyboardFocus = new RelayCommand<IList>(
                items =>
                {
                    if (items == null)
                    {
        ...
        private void GetSelectedWTDetails(IList WTDetailsList)
        {
            try
            {
                ...
                if (GetSelectedWTDetails.Count > 0)
                {
                    MCTemp = repositoryM.GetDataWithReturnDomainObject<MultipleContext_ECRM_T003_A>(MCTemp, GetSelectedWTDetails[0].wtno, "WritingTestForProduction", "Production", "WT_Details", GetSelectedWTDetails[0].id, GetSelectedWTDetails[0].doc_type);
                    if (SelectedECRM_T003_A != null)
                    {
                        blNew = false;
                        GridColumnVisibility = Visibility.Collapsed;
                        ...
                        SelectedECRM_T003_A.active = MCTemp.WritingTest.ToList()[0].active;
                        SelectedECRM_T003_A.EmpId = MCTemp.WritingTest.ToList()[0].EmpId;
                        SelectedECRM_T003_A.EmpNm = MCTemp.WritingTest.ToList()[0].EmpNm;
                        SelectedECRM_T003_A.test_code = MCTemp.WritingTest.ToList()[0].test_code;
                        SelectedECRM_T003_A.check_qty = MCTemp.WritingTest.ToList()[0].check_qty;
                        SelectedECRM_T003_A.counter_qty = MCTemp.WritingTest.ToList()[0].counter_qty;
                        SelectedECRM_T003_A.remusr = MCTemp.WritingTest.ToList()[0].remusr;
                        ...
                        {
                            SelectedECRM_T003_A.ToDate = MCTemp.WritingTest.ToList()[0].ToDate;
                        }
                        ...
                        try
                        {
                            ...
                            //SelectedECRM_T003_A.active = GetSelectedWTDetails[0].active;
                            //SelectedECRM_T003_A.readonlly = "Visible";
                            ...
                            //else
                            //{
                            //    SelectedECRM_T003_A.ToDate = GetSelectedWTDetails[0].ToDate;
                            //}
                            ...
                            //}
                            string Tempprdct_codeBack;
                            Tempprdct_codeBack = "";
                            //pending change : Hardcoded check for location
                            if (AppSessionState.location_Id == "3")
                            {
                                if (SelectedECRM_T003_A.machinecode.Contains("LX") == true)
                                {
                                    Tempprdct_codeBack = "LX";
                                }
                                else
                                {
                                    Tempprdct_codeBack = "PM";
                                }
                            }
                            if (AppSessionState.location_Id != "3")
                            {
                            ...
                            {
                                SelectedECRM_T003_A.prdct_codeBack = Tempprdct_codeBack;
                            }
            ...
            else
            {
                ...
                if (ILDChartList.Count > 0)
                {
                    ...
                    if (SelectedILDChartDetailsTemp.Count > 0)
                    {
                        ...
                        WTDetails = new ObservableCollection<ECRM_T003_B>();
                        MCMchin = repositoryM.GetDataWithReturnDomainObject<MultipleContext_ECRM_T003_A>(MCMchin, "ECRM_T003_A_Data", "WritingTestForProduction", "Production", "Machine_Details", SelectedILDChartDetailsTemp[0].machine_id, request);
                        ...
                        for (int i = 0; i < MCMchin.Refil.Count(); i++)
                        {
                            ...
                            SelectedECRM_T003_A.tm = MCMchin.Refil[i].tm;
                        };
                        string Tempprdct_codeBack;
                        Tempprdct_codeBack = "";
                        //pending change : Hardcoded check for location
        ...
        private void TextBox_GotKeyboardFocus1()
        {
            WTDetails.Add(new ECRM_T003_B());
        }
                    ...
                    if (SelectedILDDetailsTemp.Count > 0 && WTDetails[dgSelectedIndex].refilno != null)
                    {
                        if (WTDetails.Count > 0)
                        {
                            ...
                            if (distinctrefilno.Count() <= 1)
                            {
                                ...
                                Decimal maxILD = WTDetails.Max(em => em.ild);
                                Decimal minILD = WTDetails.Min(em => em.ild);
                                Decimal sumILD = WTDetails.Sum(em => em.ild);
                            }
                            else
                            {
                                IShowMessageViewService showMessageService = this.GetViewService<IShowMessageViewService>();
        ...
        private void GetSelectedProdctDetails(IList ProdctList)
        {
            ...
            {
                SelectedECRM_T003_A.prdct_code = SelectedProdctDetailsTemp[0].prdct_code;
                SelectedECRM_T003_A.itemname = SelectedProdctDetailsTemp[0].ItemName;
            }

            List<ADM_M022_P_ESSEM> result1 = MC.Products;
            IEnumerable<ADM_M022_P_ESSEM> barEnumerable1 =
                    from data in result1
                    where data.prdct_code == SelectedECRM_T003_A.prdct_code
                    select data;
        ...
        private void GetSelectedModelDetails(IList ModelList)
        {
            ...
            {
                SelectedECRM_T003_A.modlno = SelectedModelDetailsTemp[0].modelno;

            }
            if (SelectedModelDetailsTemp.Count > 0)
            {
                var ProductList = (from o in MC.Products
                                   where o.ModelCode == SelectedECRM_T003_A.modlno
                                   select o).ToList();
                ProdctCollection = CollectionViewSource.GetDefaultView(ProductList);
                ProdctCollection.Filter = new Predicate<object>(ProdctFilter);
            }
            //SelectedECRM_T003_A.prdct_code = "";
            //SelectedECRM_T003_A.tiptp = "";
        ...
        private void GetSelectedINKDetails(IList INKList)
        {
            ...
            {
                SelectedECRM_T003_A.ink = SelectedINKDetailsTemp[0].ink;
            }
        }
        ...
        private bool ValidateControls()
        {
            try
            {
                ...
                try
                {
                    ...
                    if (SelectedECRM_T003_A.lotno == "" || SelectedECRM_T003_A.shift == "")
                    {
                        IShowMessageViewService showMessageService = this.GetViewService<IShowMessageViewService>();
                        showMessageService.ButtonSetup = DialogButton.Ok;
                        showMessageService.Caption = "Weight";
                        showMessageService.Text =
                            String.Format("Lot No and Shift Required", this.Title);
                        showMessageService.ShowMessage();
                        i = 1;
                    }
        ...
        private void Load()
        {
            ...
            MC = repositoryM.GetDataWithReturnDomainObject<MultipleContext_ECRM_T003_A>(MC, "ECRM_T003_A_Data", "WritingTestForProduction", "Production", "LoadAll", 0, request);//request
            SelectedList = MC.WritingTest;
        ...
        protected override void OnSaveAction(InquiryActionResult<ECRM_T003_A> result)
        {
            try
            {
                if (WTDetails.Count > 0)
                {
                    if (SelectedECRM_T003_A.lotno != null && SelectedECRM_T003_A.shift != null)
                    {
                        ...
                        if (WtCompare() == true)
                        {
                            if (ValidateControls() == true)
                            {
                                if (blNew == true)
                                {
                                    SelectedECRM_T003_A = repository.SaveWithReturnDomainObject<ECRM_T003_A>(SelectedECRM_T003_A, "WritingTestForProduction", "Production");
                                ...
                                else if (blNew == false)
                                {
                                    ...
                                    SelectedECRM_T003_A = repository.UpdateWithReturnDomainObject<ECRM_T003_A>(SelectedECRM_T003_A, "WritingTestForProduction", "Production");
                                    this.SelectedECRM_T003_A.EndEdit();
                                    var tempSelectRemove = SelectedList.Where(x => x.id == SelectedECRM_T003_A.id).FirstOrDefault();
                                    SelectedList.Remove(tempSelectRemove);
        ...
        protected override void OnCreateAction(InquiryActionResult<ECRM_T003_A> result)
        {
            ...
            string tempPrdDate; string tempTM; string Tempprdct_codeBack;
            tempPrdDate = ""; tempTM = ""; Tempprdct_codeBack = "";
            tempPrdDate = Convert.ToString(SelectedECRM_T003_A.prddt);
            tempTM = Convert.ToString(SelectedECRM_T003_A.tm);
            if (AppSessionState.location_Id == "3")
            {
                if (SelectedECRM_T003_A.machinecode.Contains("LX") == true)
                {
            ...
            _dataGridCollection.Refresh();
            SelectedECRM_T003_A.wtdt = DateTime.Now;
            SelectedECRM_T003_A.prddt = Convert.ToDateTime(tempPrdDate); //DateTime.Now;
            ...
            SelectedECRM_T003_A.timeto = DateTime.Now.ToString(" HH:mm");
            SelectedECRM_T003_A.tm = Convert.ToInt32(tempTM);//25;
            SelectedECRM_T003_A.tmp = "25";
            SelectedECRM_T003_A.humdt = "55%";
            SelectedECRM_T003_A.amnild = 0;
            SelectedECRM_T003_A.amxild = 0;
        ...
        protected override void OnRemoveAction(InquiryActionResult<ECRM_T003_A> result)
        {
            ...
            showMessageService.Text =
                String.Format(
                    "This record Can Not Be delete'{0}'",
                        this.Title);
            ...
            if (data != null)
            {
                if (!string.IsNullOrEmpty(_filterStringProdct))
                {
                    return (
                        ...
                        (data.prdct_code != null && data.prdct_code.ToString().ToLower().Contains(_filterStringProdct.ToLower()))
            ...
            if (data != null)
            {
                if (!string.IsNullOrEmpty(_filterStringProdct))
                {
                    return (
                        ...
                        (data.test_code != null && data.test_code.ToString().ToLower().Contains(_filterStringProdct.ToLower()) ||
                        data.test_desc != null && data.test_desc.ToString().ToLower().Contains(_filterStringProdct.ToLower()))
