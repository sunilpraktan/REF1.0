...
{
    public class EPR_T003VM : WorkspaceViewModel<EPR_T003_A>
    {
        ...
        #endregion
        #region Constructor
        public EPR_T003VM(string ts_code) : base()
        {
        ...
        public EPR_T003VM(string ts_code, string doc_no) : base()
        {
            this.ts_code_vm = ts_code;
            ...
            try
            {
                if (Validation() == true && isNewRecord == true)
                {
                    ...
                    if (isNewRecord == true)
                    {
                        ...
                        EPR_T003_A_Flip BF_OBJ = new EPR_T003_A_Flip();
                        BF_OBJ = BackFlipEntity;
                        OnCreateAction(result);
                        BackFlipEntity = BF_OBJ;
                    }
        ...
        protected override void OnCreateAction(InquiryActionResult<EPR_T003_A> result)
        {
            ...
            var msg = new NotificationMessage("EPR_T003VM");
        ...
        private void LoadInitialData()
        {
            try
            {
                string Request = "LoadInitialData" + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id + "!@" + "SC" + "!@" + MasterEntity.doc_cat + "!@" + "True";
        ...
        private void InsertAllDataFromScannedBarcode(object InputValue)
        {
            try
            {
                ...
                if (MasterEntity.tot_no_bags > 0 && MasterEntity.tot_no_bags > LabelGeneratedEntity.Count && MC.LabelGeneratedList != null) // Last condition added by Sunil
                {
                            ...
                            if (POPUPEntityObject != null)
                            {
                                if (POPUPEntityObject.carton_cons_stat != true)
                                {
                                    if (LabelGeneratedEntity.Count == 0)
                                    {
                                        ...
                                        machine_id = POPUPEntityObject.machine_id.ToString();
                                        ...
                                        barcode = "";
                                           ...
                                           MasterEntity.grade == POPUPEntityObject.grade && MasterEntity.cust_prod_code == POPUPEntityObject.CustomerProductName) ||
                                           (LabelGeneratedEntity.Count > 0 && MasterEntity.ItemCode == POPUPEntityObject.ItemCode && MasterEntity.grade == POPUPEntityObject.grade && MasterEntity.ink_id == POPUPEntityObject.ink_id && MasterEntity.cust_prod_code == POPUPEntityObject.CustomerProductName && MasterEntity.grade != "A"))
                                    {
