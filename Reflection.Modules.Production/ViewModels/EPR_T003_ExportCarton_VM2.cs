...
{
    public class EPR_T003_ExportCarton_VM2 : WorkspaceViewModel<EPR_T003_A>
    {
        ...
        public EPR_T003_ExportCarton_VM2(string ts_code) : base()
        {
            ...
            var msg = new NotificationMessage("EPR_T003_ExportCarton_VM2");
        ...
        public EPR_T003_ExportCarton_VM2(string ts_code,string doc_no) : base()
        {
            this.ts_code_vm = ts_code;
...

        {
            try
            {
                ...
                if (MasterEntity.tot_no_bags > 0 && MasterEntity.tot_no_bags > LabelGeneratedEntity.Count)
                {
