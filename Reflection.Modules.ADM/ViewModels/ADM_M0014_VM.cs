...
{
    public class ADM_M0014_VM : WorkspaceViewModel<ADM_M043>
    {
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(ADM_M0014_VM));
        ...
        public ADM_M0014_VM(string ts_code,string doc_cat) : base()
        {
        ...
        {
            SelectedADM_M043.ts_code = this.ts_code_vm;
            SelectedADM_M043.userid = AppSessionState.UserID;
            SelectedADM_M043.session_id = AppSessionState.session_id;
            SelectedADM_M043.client = AppSessionState.client;
            SelectedADM_M043.user_source1 = AppSessionState.UserSource1;
            SelectedADM_M043.user_source2 = AppSessionState.UserSource2;
        }
        private void LoadInitialData()
        {
            try
            {
                string Request = "LOAD_INI" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + doc_cat_vm + "!@" + doc_cat_vm;
                MC_ADM_M043 = repository_MC_ADM_M043.GetDataWithReturnDomainObject<MultipleContext_ADM_M043>(MC_ADM_M043, Request, "WorkFlowMaster", "Administration", Request, 0, "");
        ...
        private void GetSelectedList(IList WorkFlowList)
        {
            ...
            if (GetSelectedWorkFlowListTemp.Count > 0)
            {
                ...
                //string Request = "LOAD_DOC" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + doc_cat_vm + "!@" + doc_cat_vm + "!@" + SelectedADM_M043.workflow_id;
                string Request = "LOAD_DOC" + "!@" + AppSessionState.client + "!@" + SelectedADM_M043.comp_code + "!@" + SelectedADM_M043.location_Id + "!@" + doc_cat_vm + "!@" + doc_cat_vm + "!@" + SelectedADM_M043.workflow_id;
                MCtemp = repository_MC_ADM_M043.GetDataWithReturnDomainObject<MultipleContext_ADM_M043>(MCtemp, Request, "WorkFlowMaster", "Administration", Request, 0, "");
        ...
        private bool Validation()
        {
            ...
            foreach (var item in dgdetail)
            {
                ...
                //    return false;
                //}
                if (item.level_no == 0 || item.approvernm == null || item.authority == null)
                {
                    return false;
                }
            }
        ...
        public void DefaultValue()
        {
            ...
            SelectedADM_M043.location_Id = AppSessionState.OBJ_LOCATION.location_id;
            SelectedADM_M043.comp_code = AppSessionState.OBJ_COMPANY.comp_code;
