...
{
    public class ADM_M0003_VM : WorkspaceViewModel<ADM_M003>
    {
        bool blNew = true;
        ...
        public ADM_M0003_VM(string ts_code)
            : base()
        {
     ...
     items =>
     {
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                // LOC = repositoryM.GetDataWithReturnDomainObject<MultipleContextADM_M003>(LOC, "ADM_M003_Data", "ADM_M0003_BL", "ADM", "", 0, "");
                LOC = repositoryM.GetDataWithReturnDomainObject<MultipleContext2>(LOC, Request, "ADM_M0003_BL", "ADM", "LoadInitialData", 0, "");
        ...
        private void LoadDocumentByDocumentNumber(object ParameterObject, string ParameterReference)
        {
            ...
            try
            {
                if (((IEnumerable)ParameterObject).Cast<ADM_M003>().ToList().Count > 0)
                {
                    ...
                    Request = "LoadDocumentByDocumentNumber" + "!@" + AppSessionState.client + "!@" + ParameterEntityObject.comp_code + "!@" + ParameterEntityObject.location_Id;
                    LOC = repositoryM.GetDataWithReturnDomainObject<MultipleContext2>(LOC, Request, "ADM_M0003_BL", "ADM", "LoadDocumentByDocumentNumber", 0, "");
        ...
        protected override void OnSaveAction(InquiryActionResult<ADM_M003> result)
        {
            try
            {
                ...
                if (Validation() == true)
                {
                    if (blNew == true)
                    {
                        SelectedADM_M003 = repository.SaveWithReturnDomainObject<ADM_M003>(SelectedADM_M003, "ADM_M0003_BL", "ADM");
                    ...
                    {
                        string response = repository.Update<ADM_M003>(SelectedADM_M003, "ADM_M0003_BL", "ADM");
                    }
                }
            }
            catch (Exception ex)
        ...
        protected override void OnRemoveAction(InquiryActionResult<ADM_M003> result)
        {
            if (SelectedADM_M003.location_Id != null)
            {
                ...
                {
                    string response = repository.Delete(SelectedADM_M003.location_Id, "ADM_M0003_BL", "ADM");
        ...
        private bool Validation()
        {
            ...
            if (string.IsNullOrWhiteSpace(SelectedADM_M003.doc_no_key))
            {
                IShowMessageViewService showMessageService = this.GetViewService<IShowMessageViewService>();
                showMessageService.ButtonSetup = DialogButton.Ok;
                showMessageService.Caption = "Message";
                showMessageService.Text = String.Format("Please Select Document Key Code...");
                showMessageService.ShowMessage();
                return false;
            }
