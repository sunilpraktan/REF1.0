...
{
    public class ADM_M0002_VM : WorkspaceViewModel<ADM_M002>
    {
        bool blNew = true;
        ...
        public ADM_M0002_VM(string ts_code)
            : base()
        {
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                CM2 = repositoryCM.GetDataWithReturnDomainObject<MultipleContext2>(CM2, Request, "ADM_M0002_BL", "ADM", "LoadInitialData", 0, "");
        ...
        private void LoadDocumentByDocumentNumber(object ParameterObject, string ParameterReference)
        {
            ...
            try
            {
                if (((IEnumerable)ParameterObject).Cast<ADM_M002>().ToList().Count > 0)
                {
                    ...
                    CM2 = repositoryCM.GetDataWithReturnDomainObject<MultipleContext2>(CM2, Request, "ADM_M0002_BL", "ADM", "LoadDocumentByDocumentNumber", 0, "");
        ...
        protected override void OnSaveAction(InquiryActionResult<ADM_M002> result)
        {
            try
            {
                ...
                if (blNew == true)
                {
                    SelectedADM_M002 = repository.SaveWithReturnDomainObject<ADM_M002>(SelectedADM_M002, "ADM_M0002_BL", "ADM");
                ...
                {
                    string response = repository.Update<ADM_M002>(SelectedADM_M002, "ADM_M0002_BL", "ADM");
                }
            }
            catch (Exception ex)
            {
        ...
        protected override void OnRemoveAction(InquiryActionResult<ADM_M002> result)
        {
            if (SelectedADM_M002.comp_code != null)
            {
                ...
                if (showMessageService.ShowMessage() == DialogResult.Ok)
                {
                    ...
                    string response = repository.Delete(SelectedADM_M002.comp_code, "ADM_M0002_BL", "ADM");
