...
namespace Reflection.Modules.ADM.Views
{
    ...
    /// </summary>
    public partial class ADM_M0017 : WindowElement
    {
        public string ts_code_vm { get; set; }
        public ADM_M0017(string ts_code)
        {
            ts_code_vm = ts_code;
            this.DataContext = new ADM_M0017_VM(ts_code);
            InitializeComponent();
        }
        public ADM_M0017(string ts_code, string doc_no)
        {
            InitializeComponent();
            this.DataContext = new ADM_M0017_VM(ts_code);
        }
