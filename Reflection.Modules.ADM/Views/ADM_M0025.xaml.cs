...
{
    /// <summary>
    /// Interaction logic for ADM_M025.xaml
    /// </summary>
    public partial class ADM_M0025 :WindowElement
    {
        public string ts_code_vm { get; set; }
        public ADM_M0025(string ts_code)
        {
            ts_code_vm = ts_code;
            this.DataContext = new ADM_M0025_VM(ts_code);
            InitializeComponent();
        }
