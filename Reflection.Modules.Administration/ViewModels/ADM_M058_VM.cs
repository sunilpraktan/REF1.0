...
{
    public class ADM_M058_VM : WorkspaceViewModel<ADM_M058>
    {
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(ADM_M058_VM));
        ...
        private void LoadDocumentByDocumentNumber(object ParameterObject, string ParameterReference)
        {
            ...
            try
            {
                if (((IEnumerable)ParameterObject).Cast<ADM_M058_BackFlip>().ToList().Count > 0)
                {
                    ...
                    Request = "LoadDocumentByDocumentNumber" + "!@" + AppSessionState.location_Id + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.client  + "!@" + ParameterEntityObject.group_code;
