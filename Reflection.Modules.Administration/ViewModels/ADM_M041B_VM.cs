...
{
    class ADM_M041B_VM : WorkspaceViewModel<ADM_M041_B>
    {
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(ADM_M041B_VM));
        ...
        private void LoadDocumentByDocumentNumber(object ParameterObject, string ParameterReference)
        {
            ...
            try
            {
                   if (((IEnumerable)ParameterObject).Cast<ADM_M041_B_Flip>().ToList().Count > 0)
                {
                    ...
                    Request = "LoadDocumentByDocumentNumber" + "!@" + AppSessionState.location_Id + "!@" + AppSessionState.comp_code + "!@" + ParameterEntityObject.id;
