...
{
    public class ADM_M001_VM : WorkspaceViewModel<ADM_M001>
    {
        bool blNew = true;
        ...
        private void LoadInitialData()
        {
            try
            {
                MC = repositoryM.GetDataWithReturnDomainObject<MultipleContext>(MC, "ADM_M001_Data", "GroupCompany", "Administration", "", 0, "");
        ...
        protected override void OnSaveAction(InquiryActionResult<ADM_M001> result)
        {
            try
            {
                ...
                if (blNew == true)
                {
                    SelectedADM_M001 = repository.SaveWithReturnDomainObject<ADM_M001>(SelectedADM_M001, "GroupCompany", "Administration");
                ...
                {
                    string response = repository.Update<ADM_M001>(SelectedADM_M001, "GroupCompany", "Administration");
                }
            }
            catch (Exception ex)
            {
        ...
        protected override void OnRemoveAction(InquiryActionResult<ADM_M001> result)
        {
            if (SelectedADM_M001.group_code != null)
            {
                ...
                {
                    string response = repository.Delete(SelectedADM_M001.group_code, "GroupCompany", "Administration");
