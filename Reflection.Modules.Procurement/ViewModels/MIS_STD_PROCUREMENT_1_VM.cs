...
{
    public class MIS_STD_PROCUREMENT_1_VM : WorkspaceViewModel<MM_T001>
    {
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(MIS_STD_PROCUREMENT_1_VM));
        ...
        #endregion
        public MIS_STD_PROCUREMENT_1_VM(string ts_code) : base()
        {
            MC = new STD_MC_BE();
