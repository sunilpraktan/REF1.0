...
{
    public class COM_T011_VM : WorkspaceViewModel<Approval>
    {
        ...
        WebServiceRepository<MC_COM_T011_BE> repository_MC = new WebServiceRepository<MC_COM_T011_BE>();
        ObjectSerializationService obj = new ObjectSerializationService();

        MC_COM_T011_BE _MC = new MC_COM_T011_BE();
        public MC_COM_T011_BE MC
        {
            get { return _MC; }
            set
            {
        ...
        MC_COM_T011_BE _MCTemp = new MC_COM_T011_BE();
        public MC_COM_T011_BE MCTemp
        {
            get { return _MCTemp; }
            set
            {
        ...
        #region Constructor
        public COM_T011_VM(string ts_code) : base()
        {
        ...
        private void LoadInitialData()
        {
            try
            {
                string Request = "LOAD_INI" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + AppSessionState.UserID;
                MC = repository_MC.GetDataWithReturnDomainObject<MC_COM_T011_BE>(MC, Request, "ADM_T001_BL", "ADM", "", 0, "");
        ...
        private void FilterApproval(object InputValue)
        {
            try
            {
                string Request = "REFRESH_FILTER" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + AppSessionState.UserID + "!@" + MasterEntity.doc_cat + "!@" + Convert.ToDateTime(MasterEntity.FrmDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(MasterEntity.ToDate).ToString("MM/dd/yyyy") + "!@" + MasterEntity.appro_status;
                MCTemp = repository_MC.GetDataWithReturnDomainObject<MC_COM_T011_BE>(MCTemp, Request, "ADM_T001_BL", "ADM", "", 0, "");
