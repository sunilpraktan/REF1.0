...
namespace Reflection.Modules.MM.Views
{
    ...
    /// </summary>
    public partial class MM_T102 : WindowElement
    {
        public string ts_code_vm { get; set; }
        public string dgKey { get; set; } = null;
        public MM_T102(string ts_code)
        {
            ts_code_vm = ts_code;
            InitializeComponent();
        ...
        public MM_T102(string ts_code, string doc_no)
        {
            ts_code_vm = ts_code;
            InitializeComponent();
        ...
        public MM_T102(string ts_code, STD_LIST_BE STD_OBJ)
        {
            ts_code_vm = ts_code;
            InitializeComponent();
