...
namespace Reflection.Modules.MM.Views
{
    ...
    /// </summary>
    public partial class MM_T005 : WindowElement
    {
        public string ts_code_vm { get; set; }
        public string dgKey { get; set; } = null;
        public MM_T005(string ts_code)
        {
            ts_code_vm = ts_code;
            InitializeComponent();
            this.DataContext = new MM_T005_VM("MI", ts_code);
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        public MM_T005(string ts_code, string doc_no)
        {
            ts_code_vm = ts_code;
            InitializeComponent();
            this.DataContext = new MM_T005_VM("MI", ts_code, doc_no);
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        public MM_T005(string ts_code, STD_LIST_BE STD_OBJ)
        {
            ts_code_vm = ts_code;
            InitializeComponent();
            this.DataContext = new MM_T005_VM(ts_code, STD_OBJ);
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
