...
namespace Reflection.Modules.MM.Views
{
    ...
    /// </summary>
    public partial class MM_T013 : WindowElement
    {
        public string ts_code_vm { get; set; }
        public string dgKey { get; set; } = null;

        public MM_T013(string ts_code)
        {
            
            ts_code_vm = ts_code;
            this.DataContext = new MM_T013_VM(ts_code,"RR");
            InitializeComponent();

        }
        public MM_T013(string ts_code, string doc_no)
        {
            
            ts_code_vm = ts_code;
            this.DataContext = new MM_T013_VM(ts_code, "RR", doc_no);
            InitializeComponent();

        }
        public MM_T013(string ts_code, string doc_no,STD_LIST_BE REF_DOC)
        {
            
            ts_code_vm = ts_code;
            this.DataContext = new MM_T013_VM(ts_code, "RR", REF_DOC);
            InitializeComponent();
