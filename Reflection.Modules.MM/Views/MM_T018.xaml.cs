...
{
    /// <summary>
    /// Interaction logic for MM_T018.xaml
    /// </summary>
    public partial class MM_T018 : WindowElement
    {
        public string ts_code_vm { get; set; }
        private bool isManualEditCommit;
        public string dgKey { get; set; } = null;

        public MM_T018(string ts_code)
        {
            ts_code_vm = ts_code;
            InitializeComponent();
            this.DataContext = new MM_T018_VM(ts_code, "GR", "GR");
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        public MM_T018(string ts_code, string doc_no)
        {
            ts_code_vm = ts_code;
            InitializeComponent();
            this.DataContext = new MM_T018_VM(ts_code, "GR", "GR", doc_no);
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
