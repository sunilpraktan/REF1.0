...
namespace Reflection.Modules.MM.Views
{
    ...
    /// </summary>
    public partial class MM_T014 : WindowElement
    {
        public string ts_code_vm { get; set; }
        public string dgKey { get; set; } = null;
        public MM_T014(string ts_code)
        {
            ts_code_vm = ts_code;
        ...
        public MM_T014(string ts_code, string doc_no)
        {
            ts_code_vm = ts_code;
        ...
        public MM_T014(string ts_code, string doc_no, STD_LIST_BE REF_OBJECT)
        {
            ts_code_vm = ts_code;
