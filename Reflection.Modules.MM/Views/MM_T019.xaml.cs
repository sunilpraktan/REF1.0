...
namespace Reflection.Modules.MM.Views
{
    ...
    /// </summary>
    public partial class MM_T019 : WindowElement
    {
        public string ts_code_vm { get; set; }
        public string dgKey { get; set; } = null;
        private bool isManualEditCommit;
        public MM_T019(string ts_code)
        {
            ts_code_vm = ts_code;
            this.DataContext = new MM_T003_VM("GR", ts_code);
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
            InitializeComponent();
        }
        public MM_T019(string ts_code, string doc_no)
        {
            InitializeComponent();
            this.ts_code_vm = ts_code;
            this.DataContext = new MM_T003_VM("GR", ts_code, doc_no);
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
        public MM_T019(string ts_code, STD_LIST_BE STD_LIST_OBJ)
        {
            InitializeComponent();
            this.ts_code_vm = ts_code;
            this.DataContext = new MM_T003_VM("GR", ts_code, STD_LIST_OBJ);
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        }
