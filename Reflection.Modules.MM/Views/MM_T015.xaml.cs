...
{
    /// <summary>
    /// Interaction logic for MM_T013.xaml and Table MM_T005 for Material Reservation.
    /// </summary>
    public partial class MM_T015 : WindowElement
    {
        public string ts_code_vm { get; set; }
        public string dgKey { get; set; } = null;

        public MM_T015(string ts_code)
        {
            InitializeComponent();
            ts_code_vm = ts_code;
            this.DataContext = new MM_T015_VM(ts_code, "00");
        }
        public MM_T015(string ts_code, string doc_no)
        {
            InitializeComponent();
            ts_code_vm = ts_code;
            this.DataContext = new MM_T015_VM(ts_code, "00", doc_no);
        }
        public MM_T015(string ts_code, string doc_no, EPR_T001_A REF_ORDER)
        {
            InitializeComponent();
            ts_code_vm = ts_code;
            this.DataContext = new MM_T015_VM(ts_code, "00", REF_ORDER);
        }
