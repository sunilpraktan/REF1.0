...
{
    public class MM_T007_VM : WorkspaceViewModel<EPR_T003_A>
    {
        ...
        #endregion
        // Copy from Old screen end

        #endregion
        #region. AutoSuggest TextBox Region
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(MM_T007_VM));
        ...
        public RelayCommand<object> cmdLoadHUData { get; private set; } // Copy form Old Screen
        public RelayCommand<object> cmdLoadMaterialForPacking { get; private set; } // Copy form Old Screen, may be not required due to other way integration 
        public RelayCommand<object> cmdSelectionChangedView { get; private set; } // Copy form Old Screen // This is only for Counting HU in View Section
        ...
        private void Split_HU(object InputValue) // This will split selected HU in to two part as per split qty in parameter.
        {
            try
            {
                ...
                if (ITEMS_ENTITY_HU_LIST != null && ITEMS_ENTITY_HU != null && !string.IsNullOrWhiteSpace(strSplitQty))
                {
                    ...
                    {
                        string Request = "Split_HU" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + doc_cat_vm + "!@" + doc_cat_vm + "!@" + ITEMS_ENTITY_HU.doc_no + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + ts_code_vm + "!@" + strSplitQty;
        ...
        private void MakeEmptyHU(object InputValue) // can be remove this function, we hahe include this code in Function of OK Button below the popup window.
        {
            try
            {
                ...
                if (ITEMS_ENTITY_HU_LIST != null)
                {
                    string Request = "MakeEmptyHU" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + doc_cat_vm + "!@" + doc_cat_vm + "!@" + OBI_ITEM_HU.doc_no + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + ts_code_vm;
                    MCTemp = repository_MC.GetDataWithReturnDomainObject<MC_MM_T001>(MC, Request, "MM_T007_BL", "MM","LoadAll", 0, "");
                ...
                if (MASTER_ENTITY != null && ITEMS_ENTITY != null)
                {
                    ...
                    if (ITEMS_ENTITY_LIST.Count > 0 && MASTER_ENTITY_LIST.Count > 0 && !string.IsNullOrWhiteSpace(ITEMS_ENTITY.batch_no) && !string.IsNullOrWhiteSpace(MASTER_ENTITY.item_code_pack) && !string.IsNullOrWhiteSpace(MASTER_ENTITY.pack_type) && ITEMS_ENTITY.packing_qty.HasValue && ITEMS_ENTITY.partial_qty.HasValue)
                    {
                        ...
                        if (Validation(MASTER_ENTITY.ind_packing) == true)
                        {
                            ...
                            MC_OBJ = repository_MC.SaveWithReturnDomainObject<MC_EPR_T003>(MC_OBJ, "MM_T007_BL", "MM");
                            ...
                            //MasterEntityListObj = repositoryLst.SaveWithReturnDomainObject<ObservableCollection<EPR_T003_A>>(MasterEntityListObj, "MM_T007_BL", "MM");
        ...
        private void LoadMaterialForPacking(object InputValue)
        {
            try
            {
                ...
                //else
                //{
                string Request = "LoadMaterialForPacking" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + doc_cat_vm + "!@" + doc_cat_vm + "!@" + REQ_PARA_OBJ.wc_code + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + ts_code_vm + "!@!@!@!@" + REQ_PARA_OBJ.item_code + "!@!@!@" + (REQ_PARA_OBJ.from_date.HasValue ? Convert.ToDateTime(REQ_PARA_OBJ.from_date).ToString("MM/dd/yyyy") : "") + "!@" + (REQ_PARA_OBJ.to_date.HasValue ? Convert.ToDateTime(REQ_PARA_OBJ.to_date).ToString("MM/dd/yyyy") : "") + "!@" + REQ_PARA_OBJ.store_code;
                MCTemp = repository_MC.GetDataWithReturnDomainObject<MC_MM_T001>(MC, Request, "MM_T007_BL", "MM", "LoadAll", 0, "");
        ...
        private void LoadHUData(object InputValue)
        {
            try
            {
                ...
                //MASTER_ENTITY_HU_LIST = MCTemp.MASTER_ENTITY_HU_LIST;
        ...
        private void LOAD_HU_VIEW_DATA(object InputValue)
        {
            try
            {
                ...
                string Request = "LOAD_HU_VIEW_DATA" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + doc_cat_vm + "!@" + doc_cat_vm + "!@" + REQ_PARA_OBJ.wc_code + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + ts_code_vm + "!@" + REQ_PARA_OBJ.para1 + "!@!@!@" + REQ_PARA_OBJ.item_code + "!@!@!@" + (REQ_PARA_OBJ.from_date.HasValue ? Convert.ToDateTime(REQ_PARA_OBJ.from_date).ToString("MM/dd/yyyy") : "") + "!@" + (REQ_PARA_OBJ.to_date.HasValue ? Convert.ToDateTime(REQ_PARA_OBJ.to_date).ToString("MM/dd/yyyy") : "") + "!@" + REQ_PARA_OBJ.store_code;
                MCTemp = repository_MC.GetDataWithReturnDomainObject<MC_EPR_T003>(MC, Request, "MM_T007_BL", "MM", "LoadAll", 0, "");
        ...
        private void LOAD_TRACE_DATA(object InputValue)
        {
            try
            {
                ...
                string Request = "LOAD_TRACE_DATA" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + (REQ_PARA_OBJ.location_id ?? AppSessionState.OBJ_LOCATION.location_id) + "!@" + doc_cat_vm + "!@" + doc_cat_vm + "!@" + REQ_PARA_OBJ.barcode;
                MCTemp = repository_MC.GetDataWithReturnDomainObject<MC_EPR_T003>(MC, Request, "MM_T007_BL", "MM", "LoadAll", 0, "");
        ...
        private void InsertScannedBarcodeWIP(object InputValue)
        {
            try
            {
                ...
                {
                    string Request = "LoadMaterialForPackingOnBarcodeScanning" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + doc_cat_vm + "!@" + doc_cat_vm + "!@" + BarcodeValueWIP + "!@" + AppSessionState.UserID + "!@" + AppSessionState.EmpId + "!@" + ts_code_vm;
                    MCTemp = repository_MC.GetDataWithReturnDomainObject<MC_MM_T001>(MC, Request, "MM_T007_BL", "MM", "LoadAll", 0, "");
        ...
        #endregion
        #region . Constructor .
        public MM_T007_VM(string doc_cat, string ts_code) : base()
        {
                ...
                if (EntityChangeEnable == true)
                {
                    if ((sender.ToString() == "item_code_pack" || sender.ToString() == "unit_price") && MASTER_ENTITY != null)
                    {
                        if (!string.IsNullOrWhiteSpace(MASTER_ENTITY.item_code_pack))
                        {
                            ...
                            MASTER_ENTITY.packing_type = "C"; // copy from old
                        }
                        if (!string.IsNullOrWhiteSpace(MASTER_ENTITY_HU.item_code_pack)) // copy from old screen. not exists in new, may be this is to maintain unique item in packing but it should not be applicable for standard HU packing, std HU packing can be club multiple items.
                        {
                    ...
                    if (MASTER_ENTITY_HU != null && ITEMS_ENTITY_HU_LIST != null && sender.ToString() == "selected")
                    {
                        if (!string.IsNullOrWhiteSpace(MASTER_ENTITY_HU.item_code_pack) && ITEMS_ENTITY_HU_LIST.Count > 0)
                        {
                            if (ITEMS_ENTITY_HU_LIST.Where(x => x.selected == true).ToList().Count <= PackingLimit) // && ITEMS_ENTITY_HU.selected==true
                            {
                                ...
                                MASTER_ENTITY_HU.packing_type = "C"; // copy from old
                            }
                    ...
                    if ((sender.ToString() == "tare_wt" || sender.ToString() == "net_wt") && MASTER_ENTITY != null)
                    {
                        ...
                        if (!string.IsNullOrWhiteSpace(MASTER_ENTITY_HU.item_code_pack)) // copy from old, not exists in new, may be for unique code to avoide multiple item in one HU packing, but it should be not in standard process. remove this or make any logic.
                        {
        ...
        private void DefaultValues(string doc_cat_info)
        {
            ...
            MASTER_ENTITY.t_status = "01";
            MASTER_ENTITY.carton_pack_dt = DateTime.Now;
            MASTER_ENTITY.comp_code = AppSessionState.OBJ_COMPANY.comp_code;
            MASTER_ENTITY.location_Id = AppSessionState.OBJ_LOCATION.location_id;
            ...
            MASTER_ENTITY_HU.t_status = "01";
            MASTER_ENTITY_HU.carton_pack_dt = DateTime.Now;
            MASTER_ENTITY_HU.client = AppSessionState.client;
            MASTER_ENTITY_HU.comp_code = AppSessionState.OBJ_COMPANY.comp_code;
            MASTER_ENTITY_HU.location_Id = AppSessionState.OBJ_LOCATION.location_id;
        ...
        private void Logging()
        {
            ...
            MASTER_ENTITY.add_by = AppSessionState.UserID;
            MASTER_ENTITY.editby = AppSessionState.UserID;
            MASTER_ENTITY.add_date = System.DateTime.Now;
            MASTER_ENTITY.edit_date = System.DateTime.Now;
        ...
        private void LoadInitialData(string doc_cat_info, string ReferenceDoc)
        {
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<MC_MM_T001>(MC, Request, "MM_T007_BL", "MM", "LoadAll", 0, "");
        ...
        protected override void OnPrintAction(InquiryActionResult<EPR_T003_A> result)
        {
            try
            {
                ...
                string Request = "Update_Print_Indicator" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + this.doc_cat_vm + "!@" + this.doc_cat_vm + "!@" + row_id + "!@" + AppSessionState.EmpId;
                MCTemp = repository_MC.GetDataWithReturnDomainObject<MC_MM_T001>(MCTemp, Request, "MM_T007_BL", "MM", "LoadAll", 0, "");
                ...
                objDataSourceName[0] = "dsRptLabelGen";
                ReportManager ReportManager = new ReportManager();
                ReportManager.DisplayReport(objDataSource, objDataSourceName, "\\Label\\" + MC.DOC_TYPE_SETTINGS_LIST[0].report_name, MC.DOC_TYPE_SETTINGS_LIST[0].report_name);
