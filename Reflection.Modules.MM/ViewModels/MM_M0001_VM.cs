...
{
    public class MM_M0001_VM : WorkspaceViewModel<MM_M001>
    {
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(MM_M0001_VM));
        ...
        public ObservableCollection<MM_M001> StorageCollection
        {
            ...
            set
            {
                if (_StorageCollection != value)
                {
                    ...
                    StorageCollection.CollectionChanged += new System.Collections.Specialized.NotifyCollectionChangedEventHandler(CollectionChangedNotifyForItem);
        ...
        public MM_M0001_VM(string ts_code) : base()
        {
        ...
        public MM_M0001_VM(string ts_code, string doc_no) : base()
        {
            this.ts_code_vm = ts_code;
        ...
        private void SelectionChanged_ITEM(object InputValue)
        {
            try
            {
                MasterEntity = (MM_M001)InputValue;
            }
            catch (Exception ex) { }
        }
        private void CollectionChangedNotifyForItem(object sender, NotifyCollectionChangedEventArgs e)
        {
            try
            {
                ...
                {
                    foreach (MM_M001 item in e.NewItems)
                    {
