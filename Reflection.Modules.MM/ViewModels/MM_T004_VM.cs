...
{
    public class MM_T004_VM : WorkspaceViewModel<MM_T001>
    {
        #region AutoSuggest Textbox Declaration Region
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(MM_T004_VM));
...
#pragma warning disable CS0108 // Member hides inherited member; missing new keyword
        ...
        #region . Constructor .
        public MM_T004_VM(string ts_code)
            : base()
        {
            parameter = false;
        ...
        public MM_T004_VM(string ts_code, string doc_no)
            : base()
        {
            parameter = false;
            this.ts_code_vm = ts_code;
            ...
            try
            {
                ...
                if (ParameterObject.GetType() == typeof(string) && ParameterObject != null) // This Block of code read parameter . First for string and Entity Object in else part.
                {
                    ...
                    if (ParametersStringValue.Length > 0)
                    {
                        ...
                        {
                            MasterEntity = repository.GetDataWithReturnDomainObject<MM_T001>(MasterEntity, Request, "MM_T001_BL_GM", "MM", "LoadDocumentWithReferenceDocumentNumber", 0, "");
                ...
                var msg = new NotificationMessage("MM_T004_VM");
        ...
        private void LoadIssueDetails(object items)
        {
            try
            {
                ...
                MasterEntity = repository.GetDataWithReturnDomainObject<MM_T001>(MasterEntity, Request, "MM_T001_BL_GM", "MM", "LoadIssueNodetails", 0, "");
        ...
        private void LoadIndentOrder()
        {
            try
            {
                ...
                {
                    Request = "LoadProductionOrder" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id.ToString() + "!@" + MasterEntity.ref_doc;
                }
                else
                {
                    Request = "LoadReturnIndent" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id.ToString() + "!@" + MasterEntity.ref_doc;
                }

                MCTemp1 = repository_MCTemp1.GetDataWithReturnDomainObject<MC_MM_T001>(MCTemp1, Request, "MM_T001_BL_GM", "MM", Request, 0, "LoadInitialData");
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                MasterEntity.doc_cat = "MR";
                MasterEntity.doc_type = "MR";
                string Request = "LoadInitialData" + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id.ToString() + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.doc_cat + "!@" + AppSessionState.EmpId + "!@" + AppSessionState.UserID + "!@" + AppSessionState.client;
                MC = repositoryM.GetDataWithReturnDomainObject<MC_MM_T001>(MC, Request, "MM_T001_BL_GM", "MM", Request, 0, "LoadInitialData");
                ...
                if (POPUPEntityObject != null) // Only enter in the code block if ENtity Not null.
                {
                    ...
                    else if (dgSelectedIndex >= 0 && GoodsIssueDetails.Count > dgSelectedIndex) //Update Row: If Old or Blank row get added, then Edit Rule will applicable in this Loop.
                    {
                        if (GoodsIssueDetails[dgSelectedIndex].id == 0 && ((IndexOfExistValue == -1) || (IndexOfExistValue != -1 && AllowDuplicate == true))) // It will allowe to add unique value or Duplicate value if AllowDuplicate Status == True
                        {
                            ...
                            GoodsIssueDetails[dgSelectedIndex].location_Id = AppSessionState.OBJ_LOCATION.location_id;
                            GoodsIssueDetails[dgSelectedIndex].comp_code = AppSessionState.OBJ_COMPANY.comp_code;
                ...
                if (BatchDetails != null)
                {
                    ...
                    else if (dgSelectedBatchindex >= 0 && BatchDetails.Select == true && dgBatchEntity.Count > dgSelectedBatchindex) //Update Row: If Old or Blank row get added, then Edit Rule will applicable in this Loop.
                    {
                        if (dgBatchEntity[dgSelectedBatchindex].ItemCode == null && ((IndexOfExistValue == -1) || (IndexOfExistValue != -1 && AllowDuplicate == true))) // It will allowe to add unique value or Duplicate value if AllowDuplicate Status == True
                        {
                            ...
                            dgBatchEntity[dgSelectedBatchindex].comp_code = AppSessionState.OBJ_COMPANY.comp_code;
                            dgBatchEntity[dgSelectedBatchindex].location_Id = AppSessionState.OBJ_LOCATION.location_id;
                        ...
                        if (GoodsIssueDetails[dgSelectedIndex].id == 0 && ((IndexOfExistValue == -1) || (IndexOfExistValue != -1 && AllowDuplicate == true))) // It will allow to add unique value or Duplicate value if AllowDuplicate Status == True, id=0 indicates it will add or edit for New record only.
                        {
                            ...
                            if (POPUPEntityObject.stock_total >= GoodsIssueDetails[dgSelectedIndex].qty)
                            {
                                ...
                                else if (Batchtemp.Count == 1)
                                {
                                    ...
                                    dgBatchEntity[IndexOfrecord].comp_code = AppSessionState.OBJ_COMPANY.comp_code;
                                    dgBatchEntity[IndexOfrecord].location_Id = AppSessionState.OBJ_LOCATION.location_id;
        ...
        private void LoadRecords()
        {
            ...
            {
                string Request = "LoadRecordsofSelectedDate" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id.ToString() + "!@" + "MR" + "!@" + "MR" + "!@" + Convert.ToDateTime(FromDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(ToDate).ToString("MM/dd/yyyy") + "!@" + AppSessionState.UserID;
                MCTemp = repositoryM.GetDataWithReturnDomainObject<MM_T001>(MCTemp, Request, "MM_T001_BL_GM", "MM", "LoadRecordsofSelectedDate", 0, "");
        ...
        protected override void OnSaveAction(InquiryActionResult<MM_T001> result)
        {
            ...
            if (Validation() == true)
            {
                if (NewRecord == true)
                {
                    MasterEntity = repository.SaveWithReturnDomainObject<MM_T001>(MasterEntity, "MM_T001_BL_GM", "MM");
                ...
                else if (NewRecord == false)
                {
                    ...
                    MasterEntity = repository.UpdateWithReturnDomainObject<MM_T001>(MasterEntity, "MM_T001_BL_GM", "MM");
        ...
        protected override void OnRemoveAction(InquiryActionResult<MM_T001> result)
        {
            ...
            if (showMessageService.ShowMessage() == DialogResult.Ok)
            {
                ...
                string response = repository.Delete(MasterEntity.doc_no, "MM_T001_BL_GM", "MM");
        ...
        protected override void OnPrintAction(InquiryActionResult<MM_T001> result)
        {
            try
            {
                ...
                MCTemp = repositoryM.GetDataWithReturnDomainObject<MC_MM_T001>(MCTemp, Request, "MM_T001_BL_GM", "MM", Request, 0, "");
