...
{
    public class PMS_T004_VM : WorkspaceViewModel<PMS_T004>, ITS_VIEW_MODEL
    {
        ...
        private void DefaultValues()
        {
            ...
            //MasterEntity.parent_id = CTR_PARA_OBJ.doc_no;
        ...
        #region Constructor
        public PMS_T004_VM(string ts_code, string doc_cat) : base()
        {
        ...
        public PMS_T004_VM(string ts_code, string doc_cat, STD_LIST_BE para_obj) : base()
        {
            this.doc_cat_vm = doc_cat;
            this.ts_code_vm = ts_code;
            MasterEntity = new PMS_T004();
