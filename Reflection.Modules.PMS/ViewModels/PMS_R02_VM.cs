...
{
    public class PMS_R02_VM : WorkspaceViewModel<STD_LIST_BE>
    {
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(PMS_R02_VM));
        ...
        #endregion
        public PMS_R02_VM(string ts_code) : base()
        {
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<STD_MIS_MC_BE>(MC, Request, "PMS_R02_BL", "PMS", " ", 0, "");
                ...
                TheFilter = (o, prefix) => (((STD_LIST_BE)o).so_code ?? "").ToLower().Contains(prefix.ToString().ToLower()) || (((STD_LIST_BE)o).so_name ?? "").ToLower().Contains(prefix.ToString().ToLower());
                AS_ORGANISATION = new AutoSuggestTextViewModel<dynamic>(MC.ORG_LIST, TheFilter, SuggestedValue, "so_code", true);
                ...
                TheFilter = (o, prefix) => (((STD_LIST_BE)o).sg_code ?? "").ToLower().Contains(prefix.ToString().ToLower()) || (((STD_LIST_BE)o).sg_name ?? "").ToLower().Contains(prefix.ToString().ToLower());
                AS_ORG_GROUP = new AutoSuggestTextViewModel<dynamic>(MC.ORG_GROUP_LIST, TheFilter, SuggestedValue, "sg_code", true);
                ...
                TheFilter = (o, prefix) => (((STD_LIST_BE)o).project_id ?? "").ToString().ToLower().Contains(prefix.ToLower()) || (((STD_LIST_BE)o).project_name ?? "").ToString().ToLower().Contains(prefix.ToLower());
                AS_PROJECT = new AutoSuggestTextViewModel<dynamic>(MC.STANDARD_LIST, TheFilter, SuggestedValue, "project_id", true);
                AS_PROJECT.AutoSuggestVM.IsEmptyValueAllowed = true; AS_PROJECT.AutoSuggestVM.IsFreeTextAllowed = false;
            ...
            try
            {
                ...
                else
                {
                    if (REQ_PARA_OBJ != null)
                    {
                        ...
                        string REQUEST_OPTION = "REPORT";
                        if(MIS_OBJ.view_code=="R0002")
                        {
                            REQUEST_OPTION = "REPORT_R0002";
                        }
                        string RequestParameter = REQUEST_OPTION + "!@" + AppSessionState.client + "!@" + REQ_PARA_OBJ.comp_code + "!@" + REQ_PARA_OBJ.location_id + "!@" + REQ_PARA_OBJ.doc_cat + "!@" + REQ_PARA_OBJ.doc_type + "!@" + REQ_PARA_OBJ.doc_no + "!@" + MIS_OBJ.view_code + "!@" + MIS_OBJ.sql_code + "!@" + REQ_PARA_OBJ.party_code + "!@" + REQ_PARA_OBJ.para1 + "!@" + REQ_PARA_OBJ.so_code + "!@" + REQ_PARA_OBJ.sg_code + "!@" + REQ_PARA_OBJ.emp_id + "!@" + REQ_PARA_OBJ.ind_code + "!@" + REQ_PARA_OBJ.item_code + "!@" + REQ_PARA_OBJ.item_cat + "!@" + REQ_PARA_OBJ.item_subcat + "!@" + REQ_PARA_OBJ.item_type + "!@" + REQ_PARA_OBJ.item_subtype + "!@" + REQ_PARA_OBJ.country_key + "!@" + MIS_OBJ.ts_code + "!@" + REQ_PARA_OBJ.para1 + "!@" + REQ_PARA_OBJ.incoterm + "!@" + REQ_PARA_OBJ.curr_code + "!@" + REQ_PARA_OBJ.curr_unit + "!@" + REQ_PARA_OBJ.unit_code + "!@" + REQ_PARA_OBJ.t_status + "!@" + Convert.ToDateTime(REQ_PARA_OBJ.from_date).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(REQ_PARA_OBJ.to_date).ToString("MM/dd/yyyy") + "!@" + REQ_PARA_OBJ.para4 + "!@" + REQ_PARA_OBJ.field_code + "!@" + REQ_PARA_OBJ.field_direction + "!@" + REQ_PARA_OBJ.fin_year + "!@" + REQ_PARA_OBJ.posting_period;
                        MC_TEMP = repository_MC.GetDataWithReturnDomainObject<STD_MC_BE>(MC_TEMP, RequestParameter, "PMS_R02_BL", "PMS", " ", 0, "");
                        ...
                        objDataSource[1] = MC_TEMP.STD_MIS_LIST;
                        objDataSource[2] = MC_TEMP.STD_MIS_LIST2;
                        objDataSource[3] = MC_TEMP.STD_MIS_LIST3;
                        objDataSource[4] = MC_TEMP.STD_MIS_LIST4;
                        objDataSource[5] = MC_TEMP.STD_MIS_LIST5;
                        objDataSourceName[0] = "dsMIS_1";
                        objDataSourceName[1] = "dsMaster";
                        objDataSourceName[2] = "dsSalesOrders";
                        objDataSourceName[3] = "dsPurchaseOrders";
                        objDataSourceName[4] = "dsConsumptions";
                        objDataSourceName[5] = "dsExpenses";
