...
{
    /// <summary>
    /// Interaction logic for Attendence_Request.xaml
    /// </summary>
    public partial class Attendence_Request : WindowElement
    {
        public Attendence_Request()
        {
            InitializeComponent();
        ...
        public Attendence_Request(string ts_code)
        {
            InitializeComponent();
            this.DataContext = new HRM_T001_VM();
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
        ...
        public Attendence_Request(string ts_code, string doc_no)
        {
            InitializeComponent();
            this.DataContext = new HRM_T001_VM();
            Messenger.Default.Register<NotificationMessage>(this, NotificationMessageReceived);
