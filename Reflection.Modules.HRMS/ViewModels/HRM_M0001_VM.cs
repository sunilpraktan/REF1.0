...
{
    public class HRMS_M0001_VM : WorkspaceViewModel<ADM_M024>
    {
        bool blNew = true;
        ...
        public HRMS_M0001_VM(string ts_code)
            : base()
        {
        ...
        private void LoadDocumentById(object ParameterObject, string ParameterReference)
        {
            try
            {
                ...
                if (((IEnumerable)ParameterObject).Cast<ADM_M024_P>().ToList().Count > 0)
                {
                    ...
                    Request = "LoadDocumentById" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@!@!@" + ParameterEntityObject.EmpId;
                    //Request = "LoadDocumentById" + "!@" + ParameterEntityObject.EmpId + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.client;
        ...
        private bool Validation()
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(MasterEntity.dept_code))
                {
                    ...
                    showMessageService.ButtonSetup = DialogButton.Ok;
                    showMessageService.Caption = "Required";
                    showMessageService.Text = String.Format("Employee department Is Required", this.Title);
                    showMessageService.ShowMessage();
                    return false;
                }
        ...
        protected override void OnPrintAction(InquiryActionResult<ADM_M024> result)
        {
            try
            {
                ...
                string Request = "Employee_Report" + "!@" + AppSessionState.client + "!@" + AppSessionState.OBJ_COMPANY.comp_code + "!@" + AppSessionState.OBJ_LOCATION.location_id + "!@" + MasterEntity.EmpId;
        ...
        private void ExportCommandPrint()
        {
            try
            {
                ...
                objDataSource[0] = MC.DocumentDataFlipGrid;
