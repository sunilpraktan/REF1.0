...
{
    public class HRM_M0002_VM : WorkspaceViewModel<ADM_M025>
    {
        ...
        public HRM_M0002_VM(string ts_code) : base()
        {
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                MC = repository_MC.GetDataWithReturnDomainObject<MC_ADM_M0025>(MC, Request, "HRM_M0002_BL", "HRM", "LOAD_INI", 0, "");
        ...
        protected override void OnSaveAction(InquiryActionResult<ADM_M025> result)
        {
            try
            {
                ...
                if (Validation() == true)
                {
                    strReturn = repository.Save<List<ADM_M025>>(RequestList, "HRM_M0002_BL", "HRM");
