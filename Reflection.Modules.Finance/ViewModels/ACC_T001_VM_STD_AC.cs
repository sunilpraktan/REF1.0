...
{
    public class ACC_T001_VM_STD_AC : WorkspaceViewModel<ACC_T001>
    {
        #region AutoSuggest TextBox Region
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(ACC_T001_VM_STD_AC));
        ...
        /// </summary>
        /// <param name="NA"></param>
        public ACC_T001_VM_STD_AC(string doc_cat, string ts_code) : base()
        {
        ...
        public ACC_T001_VM_STD_AC(string doc_cat, string ts_code, string doc_no) : base()
        {
            this.doc_cat_vm = doc_cat;
            this.ts_code_vm = ts_code;
        ...
        private void InsertPartyLedger(object InputValue)
        {
            ...
            try
            {
                ...
                if (POPUPEntityObject != null && MasterEntity.PartyId != POPUPEntityObject.PartyId) //&& MasterEntity.PartyId != POPUPEntityObject.PartyId) //Application:New Record Only.Condition: Only enter in the code block if EntityObject is Not null and not assigning same value again if event fire twice.
                {
                    ...
                    string Request = "LoadOpenDocumentsOnPartySelection" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + AppSessionState.location_Id.ToString() + "!@" + MasterEntity.doc_cat + "!@" + MasterEntity.doc_type + "!@" + MasterEntity.PartyId + "!@" + Convert.ToDateTime(MasterEntity.doc_date).ToString("MM/dd/yyyy");
                    MCTemp = repository_MC.GetDataWithReturnDomainObject<MultipleContext_ACC_T001>(MCTemp, Request, "ACC_T001_STD_IN", "Finance", "LoadAll", 0, "ACC_T001_STD_IN");
        ...
        private void LoadDocumentByDocumentNumber(object ParameterObject, string ParameterReference)
        {
            ...
            try
            {
                ...
                if (ParameterEntityObject != null)
                {
                    ...
                    MasterEntity = new ACC_T001();
                    MasterEntity = repository.GetDataWithReturnDomainObject<ACC_T001>(MasterEntity, Request, "ACC_T001_STD_IN", "Finance", "LoadDocumentWithReferenceDocumentNumber", 0, "ACC_T001_STD_IN");
                }
        ...
        protected override void OnSaveAction(InquiryActionResult<ACC_T001> result)
        {
            try
            {
                if (Validation() == true)
                {
                    ...
                    if (isNewRecord == true)
                    {
                        MasterEntity = repository.SaveWithReturnDomainObject<ACC_T001>(MasterEntity, "ACC_T001_STD_IN", "Finance");
                    }
                    else if (isNewRecord == false)
                    {
                        MasterEntity = repository.UpdateWithReturnDomainObject<ACC_T001>(MasterEntity, "ACC_T001_STD_IN", "Finance");
                    }
        ...
        protected override void OnPrintAction(InquiryActionResult<ACC_T001> result)
        {
            ...
            try
            {
                MC = repository_MC.GetDataWithReturnDomainObject<MultipleContextACC_T001_A>(MC, Request, "ACC_T001_STD_IN", "Finance", "LoadAll", 0, "ACC_T001_STD_IN");
                ...
                ReportManager.DisplayReport(objDataSource, objDataSourceName, "\\Finance\\PaymentEntry.rdlc", getParametersList(), "ACC_T001_STD_IN");
            }
            catch (Exception ex)
            {
                IShowMessageViewService showMessageService = this.GetViewService<IShowMessageViewService>();
        ...
        private void DefaultValues()
        {
            try
            {
                ...
                MasterEntity.add_date = DateTime.UtcNow;
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                #endregion
                string Request = "LoadInitialData" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code.ToString() + "!@" + AppSessionState.location_Id.ToString() + "!@" + doc_cat_vm + "!@" + doc_cat_vm + "!@" + AppSessionState.EmpId + "!@" + AppSessionState.UserID;
                MC = repository_MC.GetDataWithReturnDomainObject<MultipleContext_ACC_T001>(MC, Request, "ACC_T001_STD_IN", "Finance", "LoadAll", 0, "ACC_T001_STD_IN");
        ...
        private void LoadBackFlipData(object doc_cat, string ReferenceValue)
        {
            try
            {
                ...
                string Request = "LoadBackFlipData" + "!@" + AppSessionState.client + "!@" + AppSessionState.comp_code + "!@" + RequestPara.location_id + "!@" + doc_cat_vm + "!@" + MasterEntity.doc_type ?? doc_cat_vm ?? RequestPara.doc_type + "!@" + RequestPara.emp_id + "!@" + RequestPara.userid + "!@" + RequestPara.active + "!@" + RequestPara.t_status + "!@" + RequestPara.PartyId + "!@" + Convert.ToDateTime(RequestPara.FromDate).ToString("MM/dd/yyyy") + "!@" + Convert.ToDateTime(RequestPara.ToDate).ToString("MM/dd/yyyy");
                MCTemp = repository_MCTemp3.GetDataWithReturnDomainObject<MultipleContext_ACC_T001>(MCTemp, Request, "ACC_T001_STD_IN", "Finance", "LoadAll", 0, "ACC_T001_STD_IN");
