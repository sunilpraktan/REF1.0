...
{
    public class ACC_M003_B_VM : WorkspaceViewModel<ACC_M003_B>
    {
        bool NewRecord = true;
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(ACC_M003_B_VM));
        ...
        protected override void OnSaveAction(InquiryActionResult<ACC_M003_B> result)
        {
            ...
            try
            {
                if (Validation() == true)
                {
                    ...
                    NewRecord = false;
                    var msg = new NotificationMessage("ACC_M003_B_VM");
