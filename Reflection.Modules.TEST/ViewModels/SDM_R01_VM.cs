...
{
    public class SDM_R01_VM : WorkspaceViewModel<STD_LIST_BE>
    {
        ...
        private MIS_T001 _MIS_T001_OBJ = new MIS_T001();
        public MIS_T001 MIS_T001_OBJ
        {
        ...
        public static readonly DependencyProperty AutoSuggestTextViewModelProperty = DependencyProperty.Register("AutoSuggestTextViewModel", typeof(AutoSuggestTextViewModel<dynamic>), typeof(SDM_R01_VM));
        ...
        private void LoadInitialData()
        {
            try
            {
                ...
                SuggestedValue = new ValueConverter(x => x == null ? "" : ((MIS_T001)x).rpt_code);
                TheFilter = (o, prefix) => (((MIS_T001)o).rpt_code ?? "").ToString().ToLower().Contains(prefix.ToLower()) || (((MIS_T001)o).rpt_name ?? "").ToString().ToLower().Contains(prefix.ToLower());
            ...
            try
            {
                ...
                else
                {
                    if (REQ_PARA_OBJ != null)
                    {
                        ...
                        ReportManager.DisplayReport(objDataSource, objDataSourceName, MIS_T001_OBJ.rpt_path + MIS_T001_OBJ.rpt_file, getParametersList(), "");
                    }
                    else
                    {
